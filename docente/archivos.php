...
//Conteo de alumnos
$sql = "SELECT COUNT(*) id_archivo FROM archivos_primaria a 
        ...
        <div class="board p-2">
            <table id="alumnos" width="100%" class="table border-top" style="z-index: 1;">
                ...
                <tbody>
                    ...
                    $query_alumnos = mysqli_query($conexion, "SELECT ar.id_archivo, ar.id_alumno, ap.nombre, ap.grado_escolar, ar.id_capsula, cp.curso, ar.id_curso, ar.calificacion, ar.comentario, DATE_FORMAT(ar.created_at,'%r %d-%m-%Y') as fecha FROM archivos_primaria ar 
                    JOIN alumnos_primaria ap
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--<button class="btn btn-success" id="addCourseButton" type="submit" ><i class='fas fa-clipboard-check' id="i-group"></i> </button>-->
                                    <!--</form>-->
