        ...
        <div class="board p-2">
            <table id="alumnos" width="100%" class="table border-top" style="z-index: 1;">
                ...
                <tbody>
                    ...
                    $query_alumnos = mysqli_query($conexion, "SELECT ar.id_archivo, ar.id_alumno, ap.nombre, ap.grado_escolar, ar.id_capsula, cp.curso, DATE_FORMAT(ar.created_at,'%r %d-%m-%Y') as fecha FROM archivos_primaria ar 
                    JOIN alumnos_primaria ap
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="" method="post" id="f-c" class="enviar d-inline">
