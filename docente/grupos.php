            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="acciones/mostrar_grupo.php?id=<?php echo $data['id_grupo']; ?>" class="btn btn-info" style="margin-right: 5px; padding:1px; "><i class='fas fa-clipboard-list' style="color: white; padding:1px"></i></a>
                                <a href="acciones/mostrar_estadisticas_grupo.php?id=<?php echo $data['id_grupo']; ?>" class="btn btn-info" style="margin-right: 5px; padding:1px; "><i class='fas fa-clipboard-list' style="color: red; padding:1px"></i></a>
                                <a href="acciones/editar_grupo.php?id=<?php echo $data['id_grupo']; ?>" class="btn btn-success" style="margin-right: 5px; padding:1px;"><i style="padding:1px" class='fas fa-edit'></i></a>
                                <a href="acciones/agregar_curso.php?id=<?php echo $data['id_grupo']; ?>" class="btn btn-success" style="margin-right: 5px; padding:1px;"><i style="padding:1px" class='fas fa-plus'></i></a>
                                <form style="padding: 0px 0px;" action="acciones/eliminar_grupo.php?id=<?php echo $data['id_grupo']; ?>" method="post" class="confirmar d-inline">
                                    <button class="btn btn-danger" type="submit"  style="padding: 1px;"><i style="padding:6px" class='fas fa-trash-alt'></i> </button>
                                </form>
                            </td>
                        </tr>
                <?php }
