...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T5/88.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T5/89.gif');"></li>
                        <li style="background-image: url('../../img/css/T5/90.gif');"></li>
                        <li>
                            <!-- Acoplado -->
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/css/T5/91.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        var words = ['SELECTOR', 'ETIQUETA', 'CSS', 'BODY'];
