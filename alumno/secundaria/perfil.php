...
function actualizarEstrellas($id_user, $conexion)
{
    ...
    $sql = "SELECT conexiones FROM alumnos_secundaria WHERE id_alumno = $id_user";
    $result = $conexion->query($sql);

    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $total_conexiones = $row['conexiones'];
        //Verificar estrellas en total_estrellas_secundaria
        $sql = mysqli_query($conexion, "SELECT * FROM total_estrellas_secundaria WHERE id_alumno = '$id_user'");
        $result_sql = mysqli_num_rows($sql);

        if ($result_sql == 0) {
            $sql =  mysqli_query($conexion, "INSERT INTO total_estrellas_secundaria (id_alumno, estrellas) VALUES ($id_user, 1)");
        }

        // Si es múltiplo de 20 o es la primera conexión, insertar una estrella en la tabla total_estrellas_secundaria
        if ($total_conexiones % 20 == 0) {
            // Si no es múltiplo de 20, actualizar el campo estrellas en la tabla total_estrellas_secundaria
            $sql =  mysqli_query($conexion, "UPDATE total_estrellas_secundaria SET estrellas = estrellas + 1 WHERE id_alumno = $id_user");
        } else {
            // Si no es múltiplo de 20, actualizar el campo estrellas en la tabla total_estrellas_secundaria
            $sql =  mysqli_query($conexion, "UPDATE total_estrellas_secundaria SET estrellas = estrellas + 0 WHERE id_alumno = $id_user");
        }
    }
}
...
$permiso_ruta_r3 = "3";
$sql_verificar_r3 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r3'");
$existe_verificar_r3 = mysqli_num_rows($sql_verificar_r3);

//Verificar si ya se tiene permiso en ruta 4
$permiso_ruta_r4 = "4";
$sql_verificar_r4 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r4'");
$existe_verificar_r4 = mysqli_num_rows($sql_verificar_r4);

//Verificar si ya se tiene permiso en ruta 5
$permiso_ruta_r5 = "5";
$sql_verificar_r5 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r5'");
$existe_verificar_r5 = mysqli_num_rows($sql_verificar_r5);

//Verificar si ya se tiene permiso en ruta 6
$permiso_ruta_r6 = "6";
$sql_verificar_r6 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r6'");
$existe_verificar_r6 = mysqli_num_rows($sql_verificar_r6);

//Verificar si ya se tiene permiso en ruta 7
$permiso_ruta_r7 = "7";
$sql_verificar_r7 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r7'");
$existe_verificar_r7 = mysqli_num_rows($sql_verificar_r7);

//Verificar si ya se tiene permiso en ruta 8
$permiso_ruta_r8 = "8";
$sql_verificar_r8 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r8'");
$existe_verificar_r8 = mysqli_num_rows($sql_verificar_r8);

//Verificar si ya se tiene permiso en ruta 9
$permiso_ruta_r9 = "9";
$sql_verificar_r9 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r9'");
$existe_verificar_r9 = mysqli_num_rows($sql_verificar_r9);

//Verificar si ya se tiene permiso en ruta 10
$permiso_ruta_r10 = "10";
$sql_verificar_r10 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r10'");
$existe_verificar_r10 = mysqli_num_rows($sql_verificar_r10);

//Verificar si ya se tiene permiso en ruta 11
$permiso_ruta_r11 = "11";
$sql_verificar_r11 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r11'");
$existe_verificar_r11 = mysqli_num_rows($sql_verificar_r11);

//Verificar si ya se tiene permiso en ruta 12
$permiso_ruta_r12 = "12";
$sql_verificar_r12 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r12'");
$existe_verificar_r12 = mysqli_num_rows($sql_verificar_r12);

//Verificar si ya se tiene permiso en ruta 13
$permiso_ruta_r13 = "13";
$sql_verificar_r13 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r13'");
$existe_verificar_r13 = mysqli_num_rows($sql_verificar_r13);

//Verificar si ya se tiene permiso en ruta 14
$permiso_ruta_r14 = "14";
$sql_verificar_r14 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r14'");
$existe_verificar_r14 = mysqli_num_rows($sql_verificar_r14);

//Verificar si ya se tiene permiso en ruta 15
$permiso_ruta_r15 = "15";
$sql_verificar_r15 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r15'");
...
$query_informatica_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 7");
$data_informatica_basico = mysqli_fetch_assoc($query_informatica_basico);

//Estadisticas informatica intermedio
$query_informatica_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 8");
$data_informatica_intermedio = mysqli_fetch_assoc($query_informatica_intermedio);

//Estadisticas informatica avanzado
$query_informatica_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 9");
$data_informatica_avanzado = mysqli_fetch_assoc($query_informatica_avanzado);

//Estadisticas videojuegosunity basico
$query_videojuegosunity_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 10");
$data_videojuegosunity_basico = mysqli_fetch_assoc($query_videojuegosunity_basico);

//Estadisticas videojuegosunity intermedio
$query_videojuegosunity_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 11");
...
$query_videojuegosunity_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 12");
$data_videojuegosunity_avanzado = mysqli_fetch_assoc($query_videojuegosunity_avanzado);

//Estadisticas appsmoviles basico
$query_appsmoviles_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 13");
$data_appsmoviles_basico = mysqli_fetch_assoc($query_appsmoviles_basico);

//Estadisticas appsmoviles intermedio
$query_appsmoviles_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 14");
$data_appsmoviles_intermedio = mysqli_fetch_assoc($query_appsmoviles_intermedio);

//Estadisticas appsmoviles avanzado
$query_appsmoviles_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 15");
...
$sql_verificar_rutas = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_secundaria a WHERE a.id_alumno = $id_user");
...
$sql_estrellas = "SELECT estrellas FROM total_estrellas_secundaria WHERE id_alumno = $id_user";
        ...
        <section class="seccion-perfil-usuario">
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    ...
                    <div class="Logo2">
                        <img src="../secundaria/img/Bienvenida.png" style="height: 110px; width:170px;">
                    </div>
                    ...
                    <div class="desplegable">
                        ...
                        <button type="button" class="boton-opciones" id="" placeholder="Opciones">
                            <div class="sing"> <img src="../secundaria/img/ajustes.png" alt="" height="20px" width="20px" class="svg">
                            </div>
