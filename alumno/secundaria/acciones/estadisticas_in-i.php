...
$consultaEstadistica = mysqli_query($conexion, "SELECT trofeos, SUM(trofeos) AS total_trofeos, progreso, SUM(progreso) AS total_progreso, puntos, SUM(puntos) AS total_puntos, practico, SUM(practico) AS total_practico, teorico, SUM(teorico) AS total_teorico FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 8"); // Modificando consulta por cada curso
...
$datos_por_capsula = array(
    ...
    "2" => array(
        "area" => "Teórica",
        "tema" => "Primeros pasos en internet",
        "tipoPuntos" => "Conocimientos"
    ),
    "3" => array(
        "area" => "Práctica",
    ...
    "5" => array(
        "area" => "Teórica",
        "tema" => "Configuración de los parámetros básicos",
        "tipoPuntos" => "Conocimientos"
    ),
    "6" => array(
        "area" => "Práctica",
    ...
    "8" => array(
        "area" => "Teórica",
        "tema" => "Acceso a una dirección en la web",
        "tipoPuntos" => "Conocimientos"
    ),
    "9" => array(
        "area" => "Práctica",
    ...
    "11" => array(
        "area" => "Teórica",
        "tema" => "Utilización de un motor de búsqueda",
        "tipoPuntos" => "Conocimientos"
    ),
    "12" => array(
        "area" => "Práctica",
    ...
    "17" => array(
        "area" => "Teórica",
        "tema" => "Primeros pasos con el correo electrónico",
        "tipoPuntos" => "Conocimientos"
    ),
    "18" => array(
        "area" => "Práctica",
