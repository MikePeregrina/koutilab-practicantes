...
$consultaEstadistica = mysqli_query($conexion, "SELECT trofeos, SUM(trofeos) AS total_trofeos, progreso, SUM(progreso) AS total_progreso, puntos, SUM(puntos) AS total_puntos, practico, SUM(practico) AS total_practico, teorico, SUM(teorico) AS total_teorico FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 10"); // Modificando consulta por cada curso
...
$datos_por_capsula = array(
    ...
    "8" => array(
        "area" => "Teórica",
        "tema" => "Estructura y configuración de un proyecto",
        "tipoPuntos" => "Conocimientos"
    ),
    "9" => array(
        "area" => "Práctica",
    ...
    "20" => array(
        "area" => "Teórica",
        "tema" => "Packages y su instalación",
        "tipoPuntos" => "Conocimientos"
    ),
    "21" => array(
        "area" => "Práctica",
    ...
    "27" => array(
        "area" => "Teórica",
        "tema" => "Fundamentos de programación C#",
        "tipoPuntos" => "Conocimientos"
    ),
    "28" => array(
        "area" => "Práctica",
    ...
    "36" => array(
        "area" => "Teórica",
        "tema" => "Físicas (colliders y rigidbody)",
        "tipoPuntos" => "Conocimientos"
    ),
    "37" => array(
        "area" => "Práctica",
...
<body>
    ...
    <div class="containers">
        <a href="../rutas/ruta-vj-b.php"><button class="btn-b"><i class="fas fa-reply fa-lg"></i></button></a>
