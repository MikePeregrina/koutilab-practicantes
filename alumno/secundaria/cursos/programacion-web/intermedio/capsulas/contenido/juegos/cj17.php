...
<body onload="iniciarTiempo();">
	...
	<div class="contenido" style="height: 600px;">
				...
				<tr>
					...
					<td>
						<div class="horizontal">
							1. Es el tipo de loop que se utiliza cuando sabemos cuántas veces se va a repetir un bloque de código.
							<br><br>
							2. Es lo que recibe la computadora para recibir ordenes y saber que hacer, es lo que escribimos nosotoros los programadores.
						</div>
					</td>
					<b style="margin-left: 160px;">Verticales:</b>
					<td>
						<div class="vertical">
							1. Es la etiqueta de HTML con la que podemos incrustar código de JavaScript en nuestro código de HTML.
							<br><br>
							2. Es el tipo de loop que se utiliza cuando no sabemos cuantas veces se va a repetir un fragmento de código.
							<br><br>
							3. Es la estructura de programación que nos permite repetir un fragmento de código sin tener que escribirlo una y otra vez.
						</div>
					</td>
				</tr>
			</table>
		...
		<div class="linea" style="height: 410px;"></div>

		<!-- Apartado del crucigrama junto con sus casillas -->
		<div class="crucigrama" style="padding: 3% 0 0 7%;">
			<div class="numero1" style="margin: 170px 0 0 -20px;">1.</div>
			<div class="numero2" style="margin: 120px 0 0 85px;">2.</div>
			<div class="numero3-3" style="margin: 30px 0 0 125px;">1.</div>
			<div class="numero1-1" style="margin: 30px 0 0 385px;">3.</div>
			<div class="numero2-2" style="margin: -20px 0 0 280px;">2.</div>
		...
		<button class="verificar" style="margin-top: 570px;" onClick="verificar()">Comprobar respuestas</button>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 47 + "&id_curso=" + 2; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		//Palabra loop
		var palabra1_letra1 = document.getElementById("fila2C8");
		var palabra1_letra2 = document.getElementById("fila3C8");
		var palabra1_letra3 = document.getElementById("fila4C8");
		var palabra1_letra4 = document.getElementById("fila5C8");
		...
		//Palabra while
		var palabra3_letra1 = document.getElementById("fila1C6");
		var palabra3_letra2 = document.getElementById("fila2C6");
		var palabra3_letra3 = document.getElementById("fila3C6");
		var palabra3_letra4 = document.getElementById("fila4C6");
		var palabra3_letra5 = document.getElementById("fila5C6");

		//Palabra script
		var palabra4_letra1 = document.getElementById("fila2C3");
		var palabra4_letra2 = document.getElementById("fila3C3");
		var palabra4_letra3 = document.getElementById("fila4C3");
		var palabra4_letra4 = document.getElementById("fila5C3");
		var palabra4_letra5 = document.getElementById("fila6C3");
		var palabra4_letra6 = document.getElementById("fila7C3");

		//Palabra codigo
		var palabra5_letra1 = document.getElementById("fila3C3");
		var palabra5_letra2 = document.getElementById("fila3C4");
		var palabra5_letra3 = document.getElementById("fila3C5");
		...
		function verificar() {
			...
			palabra4 = palabra4_letra1.value + palabra4_letra2.value + palabra4_letra3.value + palabra4_letra4.value + palabra4_letra5.value + palabra4_letra6.value;
			...
			if (palabra1.toLowerCase() == "loop" && palabra2.toLowerCase() == "for" && palabra3.toLowerCase() == "while" && palabra4.toLowerCase() == "script" && palabra5.toLowerCase() == "codigo") {
				var xmlhttp = new XMLHttpRequest();

				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 47 + "&id_curso=" + 2; //cancatenation
				...
				if (palabra4.toLowerCase() != "script") {
				...
				if (palabra5.toLowerCase() != "codigo") {
				...
				if (palabra2.toLowerCase() == "for") {
					palabra4_letra3.value = "r";
				}

				if (palabra3.toLowerCase() == "while") {
					palabra5_letra4.value = "i";
				}
