...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica N</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
            ...
            <div class="">
                ...
                <div class="editor1">
                    <div class="titulo-edit1" style="margin-left: 290px;">
                        <h6>HTML</h6>
                    </div>
                    <div class="titulo-edit2" style="margin-left: 870px;">
                        <h6>CSS</h6>
                    </div>
                    <div class="titulo-edit4">
                        <h6>SALIDA</h6>
                    </div>
                    <textarea onkeyup="run()" id="html-code" class="cd" placeholder="Escribe el código HTML aquí" style="width: 540px;"></textarea>
                    <textarea onkeyup="run()" id="css-code" class="cd1" placeholder="Escribe el código CSS aquí" style="width: 540px;"></textarea>
