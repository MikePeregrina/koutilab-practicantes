    ...
    <script>
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd22.php?validar=' + 'correcto' + '&permiso=' + 22 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
        ...
        function fail() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '../../acciones/insertar_pd22.php?validar=' + 'incorrecto' + '&permiso=' + 22 + '&id_curso=' + 7 + '&practico=' + 10;
                }
            });
        }
    </script>
