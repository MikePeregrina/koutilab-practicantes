        ...
        <div class="container">
            ...
            <div class="">
                ...
                <div class="editor1">
                    ...
                    <textarea onkeyup="run()" id="html-code" class="cd" placeholder="Escribe el código HTML aquí"></textarea>
                    <textarea onkeyup="run()" id="css-code" class="cd1" placeholder="Escribe el código CSS aquí"></textarea>
                    <textarea onkeyup="run()" id="js-code" class="cd2" placeholder="Escribe el código JavaScript aquí"></textarea> <br>
