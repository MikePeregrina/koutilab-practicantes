        ...
        function miFunc() {
            ...
            if (htmlcode == 'validar') {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'correcto' + '&permiso=' + 20 + '&id_curso=' + 3 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'incorrecto' + '&permiso=' + 20 + '&id_curso=' + 3 + '&practico=' + 10;
                    }
                });
            }
        }
