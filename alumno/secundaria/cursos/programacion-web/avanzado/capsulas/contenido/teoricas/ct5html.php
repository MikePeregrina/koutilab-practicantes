        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T4.5/36.gif'); z-index:0; opacity: 1;"></li>
                        ...
                        <li style="background-image: url('../../img/html/T4.5/40.gif');"></li>
                        <li style="background-image: url('../../img/html/T4.5/41.gif');"></li>
                        <li>
                            <div>
