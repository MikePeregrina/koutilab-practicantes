            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a disminuir la velocidad del motor a la mitad cuando
                                    se detecte un objeto a 40cm y para el motor cuando detecte
                                    un objeto a 20cm o menos.
                                </p>
                            </td>
                            <td class="ne">
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'correcto' + '&permiso=' + 13 + '&id_curso=' + 9 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'incorrecto' + '&permiso=' + 13 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }
