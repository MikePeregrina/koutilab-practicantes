            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora vamos a darle una secuencia al motor que hicimos con anterioridad.
                                </p>
                            </td>
                            <td class="ne">
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 9 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }
