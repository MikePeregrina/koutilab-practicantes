            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora que ya sabes como controlar un motor, llego la hora de usar
                                    todo el conocimiento previo, y empezar a mezclar las interacciones
                                    que estos sensores y actuadores pueden tener, y para eso empezaremos
                                    agregando un sensor ultra sónico al control del motor.
                                </p>
                            </td>
                            <td class="ne">
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd10.php?validar=' + 'correcto' + '&permiso=' + 10 + '&id_curso=' + 9 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd10.php?validar=' + 'incorrecto' + '&permiso=' + 10 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }
