            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        ...
                        <li style="background-image: url('../../img/CT222.gif');"></li>
                        <li style="background-image: url('../../img/CT2222.gif');"></li>
                        <li style="background-image: url('../../img/CT22222.gif');"></li>
                        <li style="background-image: url('../../img/CT222222.gif');"></li>
                        <li style="background-image: url('../../img/CT2222222.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd5.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>como se inicia una variable "x" con valor de 10</h1>
