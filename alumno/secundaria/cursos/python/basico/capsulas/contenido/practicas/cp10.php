...
<body>
    ...
    <script>
        ...
        function miFunc() {
            ...
            //alert(val[2]+" "+val[4]);
            let esCorrecto = ta == '1\n2\n3\n4\nnumero1 = ' + val[2] + ' = ' + val[4] + ' valor de numero1 es:", numero1)\nprint("El valor de numero2 es:", numero2)';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'incorrecto' + '&permiso=' + 21 + '&id_curso=' + 4 + '&practico=' + 10 + '&pythoncode=' + encodeV;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'correcto' + '&permiso=' + 21 + '&id_curso=' + 4 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
