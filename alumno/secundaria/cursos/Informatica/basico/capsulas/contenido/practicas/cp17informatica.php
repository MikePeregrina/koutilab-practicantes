...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/informatica/basico/capsulas/contenido/teoricas/ct19informatica.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 17 Informatica</div><br>
            <div class="board">
                <table width="100%">
