        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/1/84.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/1/85.gif');"></li>
                        <li style="background-image: url('../../img/2/1/86.gif');"></li>
                        <li style="background-image: url('../../img/2/1/87.gif');"></li>
                        <li>
                            <div>
