  ...
  <div class="body">
    <div class="container">
      <section id="container-slider">
        ...
        <ul id="slider">
          <li style="background-image: url('../img/PA1.gif'); z-index:0; opacity: 1;">
            <a href="../../../../../perfil.php" style="text-decoration: none;"><button type="submit" class="btn-grd1" style="margin-left: 61.5%;">Regresar</button></a>
          </li>
        </ul>
      </section>
    </div>
