  ...
  <div class="contenido">
    ...
    <div class="container">
      <section>
        ...
        <h3>
          1- Sistema de diseño flexible 
          <select class="select" id="respuesta0">
            <!--Generando lista de opciones de respuesta de la pregunta 1-->
            <option value="----">...</option>
            <option value="correcto">FLEXBOX</option>
            <option value="incorrecto">FLEXIBLE</option>
            <option value="incorrecto">ESTILO</option>
          </select>
        </h3>
        <!--Generando pregunta 2-->
        <h3>
          2-Permite que los usuarios personalicen la apariencia de la aplicación ajustando colores, temas y estilos
          <select class="select" id="respuesta1">
            ...
            <option value="correcto">PERSONALIZACION</option>
            <option value="incorrecto">ESTILO</option>
          </select>
        </h3>
        <!--Generando pregunta 3-->
        <h3>
          3- Establece las propiedades de estilo, como colores, fuentes y tamaños, para dar formato y apariencia visual a los elementos
        ...
        <h3>
          4-¿Las propiedades de estilo se refieren a las características y atributos que se pueden aplicar a elementos visuales?
