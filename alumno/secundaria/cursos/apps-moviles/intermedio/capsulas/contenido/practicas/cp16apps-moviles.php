...
$id_user = $_SESSION['id_alumno_secundaria'];
$permiso = "capsula40";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_secundaria c INNER JOIN detalle_capsulas_secundaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 14");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct16apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 6 Word</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Utilizando la función de agregar imágenes en Word crea un collage visual sobre un tema específico. Puedes buscar imágenes relacionadas en línea y luego insertarlas en el documento de Word. Luego, pueden utilizar las herramientas de edición de imagen para ajustar el tamaño, aplicar efectos visuales y organizar las imágenes de manera creativa.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/intermedioinf/prac16.PNG" style="height: auto; width: 70%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script>
        ...
        function miFunc() {
            ...
            let span = frame.querySelectorAll("span").length;
            ...
            if (span > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'correcto' + '&permiso=' + 40 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'incorrecto' + '&permiso=' + 40 + '&id_curso=' + 8 + '&practico=' + 10;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['archivo'])) {
        ...
        $consulta = $conexion->prepare('INSERT INTO archivos_secundaria (nombre_archivo,archivo_data,id_alumno,id_curso,id_capsula) VALUES (?,?,?,?,?)');
