...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct7apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 7 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Practica el envío de correos electrónicos formales e informales, como enviar un correo a un profesor para solicitar información adicional sobre un tema o enviar un correo a un compañero de clase para colaborar en un proyecto. Deben redactar los mensajes adecuados, incluir un asunto claro y conciso, y asegurarse de que el contenido sea apropiado para el destinatario.
                                    <br> <br>
                                </p>
                            </td>
                ...
                if (frames > 0) {
                    ...
                    `,
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'correcto' + '&permiso=' + 21 + '&id_curso=' + 8 + '&practico=' + 10;
                            }
                        });
                    } else if (puntos == 6) {
                        Swal.fire({
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'incorrecto' + '&permiso=' + 21 + '&id_curso=' + 8 + '&practico=' + 10;
