...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct8apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 8 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Investiga sobre los diferentes métodos de eliminación de mensajes de correo electrónico y recopila información sobre los diferentes métodos de eliminación de mensajes de correo electrónico, como el envío a la carpeta de elementos eliminados, la recuperación de mensajes y la eliminación definitiva.
                                    <br> <br>
                                </p>
                            </td>
