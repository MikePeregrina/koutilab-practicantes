...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct12apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 2 Word</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Utiliza Microsoft Word para crear una tarjeta de agradecimiento para un amigo, un profesor o un miembro de tu familia. Utiliza diferentes estilos de fuente para escribir un mensaje de agradecimiento y aplicar efectos de negrita o subrayado para enfatizar palabras importantes.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <center><img src="../../../../../../img/intermedioinf/prac12.PNG" style="height: auto; width: 60%;"></center>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (h1 > 0 && p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd31.php?validar=' + 'correcto' + '&permiso=' + 31 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd31.php?validar=' + 'incorrecto' + '&permiso=' + 31 + '&id_curso=' + 8 + '&practico=' + 10;
