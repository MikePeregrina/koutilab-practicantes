...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct6apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 6 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realizar una investigación sobre el surgimiento del correo electrónico, quién lo inventó y cómo ha evolucionado a lo largo del tiempo. Pueden presentar sus hallazgos en forma de informe, presentación o línea de tiempo.
                                    <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (videos > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'correcto' + '&permiso=' + 18 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'incorrecto' + '&permiso=' + 18 + '&id_curso=' + 8 + '&practico=' + 10;
