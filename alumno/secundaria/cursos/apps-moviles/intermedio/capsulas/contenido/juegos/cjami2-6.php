...
<body onload="iniciarTiempo()">
    ...
    <div class="timer" id="timer">
     ...
     <div class="titulo-gen">
        <h2 class="titulo"><b>CARACTERES ESPECIALES</b></h2>
    </div>
    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1.Los caracteres especiales son símbolos que no se muestran de manera literal en la salida, sino que tienen un significado especial en la programación
                ...
                <h3>2.Estos caracteres a menudo se utilizan para representar espacios en blanco, caracteres de escape y otros elementos no imprimibles.?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">unicos</option>
                        <option value="correcto">especiales</option>
                        <option value="incorrecto">principales</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3. Kotlin admite la representación de caracteres utilizando la sintaxis \uXXXX,?
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="correcto">unicode</option>
                        <option value="incorrecto">code</option>
                        <option value="incorrecto">codeuni</option>
                    </select>
                </h3><!--Generando primer pregunta-->

                <h3>4.Que cadenas permiten incluir caracteres especiales sin la necesidad de secuencias de escape. ?
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="correcto">raw</option>
                        <option value="incorrecto">row</option>
                        <option value="incorrecto">war</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
