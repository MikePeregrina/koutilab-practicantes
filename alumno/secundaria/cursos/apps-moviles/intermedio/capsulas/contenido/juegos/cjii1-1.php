...
<body>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i class="fa-solid fa-globe"></i>', //icono de internet
				'<i class="fa-solid fa-wifi"></i>', //icono del wifi
				'<i class="fa-solid fa-computer"></i>', //computadoras
				'<i class="fa-brands fa-chrome"></i>', //chrome
				'<i class="fa-brands fa-internet-explorer"></i>', //explorer
				'<i class="fa-solid fa-magnifying-glass"></i>', //buscador
				'<i class="fa-sharp fa-solid fa-link"></i>', //icono del link
				'<i class="fa-solid fa-laptop"></i>', //icono de la laptop
				'<i class="fa-solid fa-mobile"></i>', //icono de un celular
				'<i class="fa-solid fa-tower-cell"></i>', //icono de torre de señal
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 4 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii1-1.php)'; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 4 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii1-1.php)'; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_pd4.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
