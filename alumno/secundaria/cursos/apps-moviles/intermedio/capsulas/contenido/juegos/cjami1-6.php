...
<body onload="iniciarTiempo()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>COMO BUSCAR ARCHIVOS DEL PROYECTO</b></h2>
	</div>
	...
	<script>
		...
		var preguntas = [{
				num: 1,
				pregunta: "Para una busqueda sencilla podemos ocupar",
				opA: "Barra de busqueda",
				opB: "Busqueda avanzada",
				opC: "Busqueda en la aplicación",
				correcta: "A",
				tiempo: "30",
			},
			{
				num: 2,
				pregunta: "Para una busqueda mas específica con letras mayúsculas o minúsculas ocupamos",
				opA: "Barra de busqueda",
				opB: "Busqueda avanzada",
				opC: "Busqueda en la aplicación",
				correcta: "B",
			...
			{
				num: 3,
				pregunta: "Busqueda que va más allá de una busqueda avanzada",
				opA: "Barra de busqueda",
				opB: "Busqueda de expresiones regulares",
				opC: "Busqueda en la aplicación",
				correcta: "B",
				tiempo: "20",
			},
			{
				num: 4,
				pregunta: "Para buscar clases, métodos o recursos específicos ocupamos",
				opA: "Barra de busqueda",
				opB: "Busqueda avanzada",
				opC: "Busqueda de referencias",
				correcta: "C",
				tiempo: "20",
			},
			{
				num: 5,
				pregunta: "Para buscar en todos los archivos existentes de la aplicación ocupamos",
				opA: "Barra de busqueda",
				opB: "Busqueda avanzada",
				opC: "Busqueda en la aplicación",
				correcta: "C",
