...
<body onload="iniciarTiempo();">
	...
	<script>
		...
		var words = ['CORREO', 'REDACTAR', 'ENVIAR', 'DESTINATARIO', 'ASUNTO', 'DESCRIPCION', 'CAMPO', 'MOTIVO'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 22 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii1-7.php)'; //cancatenation
