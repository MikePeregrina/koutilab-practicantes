...
<body>
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 33 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii2-2.php)'; //cancatenation
					xmlhttp.open("POST", "../../acciones/insertar_pd33.php", true);
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 33 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii2-2.php)'; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_pd33 .php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
