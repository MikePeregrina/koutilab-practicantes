...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>CONDICIONALES</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<img src="../../img/img-juegos/S (1).png" width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (2).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (3).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (4).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (5).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (6).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (7).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (8).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (9).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (10).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (11).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/S (12).png" " width="60px" height = "50px" >'
			]
		}
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				alerta2.play(); //agregando sonido del juego no completado
			} else {
				segundos--;
