    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 30 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii2-1.php)'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 30 + "&id_curso=" + 8 + "&redireccion=" + '../contenido/juegos/cjii2-1.php)'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_pd30.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
