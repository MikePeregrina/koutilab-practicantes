...
function selectWord() {
    ...
    if (
        palabraseleccionada.id !== 'supr' &&
        palabraseleccionada.id !== 'izq' &&
        palabraseleccionada.id !== 'fun' &&
        palabraseleccionada.id !== 'num'&&
        palabraseleccionada.id !== 'alf' 
...
function checkAnswer(respuesta) {
    ...
    if (palabraseleccionada) {
        ...
        if (respuesta === 'supr' && idPalabraSeleccionada === 'especiales') {
            ...
            contexto.lineTo(610, 22);
            contexto.stroke(); // "Guardar" cambios
            //sumamos al contador
            respuestasCorrectas++;
        } else if (respuesta === 'num' && idPalabraSeleccionada === 'numerico') {
            palabraseleccionada.classList.add('correcto');
            contexto.beginPath();
            contexto.lineWidth = 3;
            contexto.strokeStyle = "#84c42c";
            contexto.moveTo(0, 87);
            contexto.lineTo(557, 223);
            contexto.stroke();
            respuestasCorrectas++;
        }
        else if (
            respuesta === 'fun' && idPalabraSeleccionada === 'funcion'
        ) {
            palabraseleccionada.classList.add('correcto');
            contexto.beginPath();
            contexto.lineWidth = 3;
            contexto.strokeStyle = "#84c42c";
            contexto.moveTo(0, 153);
            contexto.lineTo(560, 155);
            contexto.stroke();
            respuestasCorrectas++;
        } else if (
            respuesta === 'alf' && idPalabraSeleccionada === 'alfanumerico'
        ) {
            palabraseleccionada.classList.add('correcto');
            contexto.beginPath();
            contexto.lineWidth = 3;
            ...
            respuesta === 'izq' && idPalabraSeleccionada === 'direccionales'
        ) {
            palabraseleccionada.classList.add('correcto');
            contexto.beginPath();
            contexto.lineWidth = 3;
            contexto.strokeStyle = "#84c42c";
            contexto.moveTo(0, 275);
            contexto.lineTo(560, 80);
            contexto.stroke();
            respuestasCorrectas++;
        } else {
