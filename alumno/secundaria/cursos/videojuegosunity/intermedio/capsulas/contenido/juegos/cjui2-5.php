...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <script>
        ...
        function iniciar() {
            base_preguntas = readText("../../js/base-preguntas-3.json");
    ...
    <script>
        ...
        function tiempoAgotado() {
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 41 + "&id_curso=" + 11; //cancatenation
        ...
        function alertExcelent() {
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 41 + "&id_curso=" + 11; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_pd41.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
