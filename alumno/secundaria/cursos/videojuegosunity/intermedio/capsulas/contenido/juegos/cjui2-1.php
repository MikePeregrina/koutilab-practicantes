...
<body>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i class="fa-brands fa-unity"></i>', //icono de unity
				'<i><img src = "https://pavcreations.com/wp-content/uploads/2020/05/Tilemaps_forest01.png" width="85px" height="55px"></i>', //cuadriculas de tilemaps
				'<i><img src = "https://i.pinimg.com/600x315/c3/80/91/c38091eb0600f78c47de390d339ae8c3.jpg" width="82px" height="65px"></i>', //icono 2D
				'<i><img src = "https://i.ytimg.com/vi/oSxG1uUgLx4/maxresdefault.jpg" width="82px" height="55px"></i>', //img de tilemaps
				'<i><img src = "https://unity.com/sites/default/files/styles/social_media_sharing/public/2020-04/optimize-performance-2d-games-unity-tilemap%23fewer-batch-calls-teaser.jpg?itok=ZnFbRdM6" width="80px" height="55px"></i>',
				'<i><img src = "https://europe1.discourse-cdn.com/unity/original/3X/b/f/bf9716f30d8badd965517eaf35532722e482af0e.png" width="80px" height="60px"></i>',
				'<i><img src = "https://img.freepik.com/vector-premium/plataformas-gui-interfaz-mapa-nivel-juego-arcade-2d_8071-26639.jpg" width="80px" height="55px"></i>',
				'<i><img src = "https://img.freepik.com/vector-premium/diseno-interfaz-juego-plataforma_1308-113465.jpg" width="80px" height="55px"></i>',
				'<i><img src = "https://i.ytimg.com/vi/jvtFUfJ6CP8/maxresdefault.jpg" width="80px" height="55px"></i>',
				'<i><img src = "https://rpg.hamsterrepublic.com/wiki-images/thumb/2/2d/Fantasy_tileset0FINISHED.bmp/320px-Fantasy_tileset0FINISHED.bmp.png" width="80px" height="55px"></i>',
				'<i><img src = "https://cdn1.epicgames.com/ue/product/Screenshot/TiledParser1-1920x1080-33805825c765e02cd6773ebfe0e18dbb.png" width="80px" height="55px"></i>',
				'<i><img src = "https://i.ytimg.com/vi/7QmgaO2YqG4/maxresdefault.jpg" width="80px" height="55px"></i>'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 29 + "&id_curso=" + 11; //cancatenation
