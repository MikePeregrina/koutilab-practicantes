...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>VISTA ELEVADA</b></h2>
	</div>
	...
	<script>
		...
		var words = ['VISTA', 'CAMARA', 'PLANO', 'POSICION', 'CONTROL', 'MOVIMIENTO', 'TRASLATE', 'ROTATE'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 25 + "&id_curso=" + 11; //cancatenation
