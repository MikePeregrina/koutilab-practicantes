...
<body onload="iniciarTiempo();">
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="horizontal">
                                ...
                                <br>
                                1.Representa cualquier item que puede ser utilizado en su juego o proyecto
                                <br /><br />
                                2.Asegúrate de que los personajes y enemigos tengan colisionadores ____________ apropiados para detectar colisiones..
                                <br /><br />
                                <b class="tituloV">Verticales:</b>
                                <div class="vertical">
                                    1.Motor de videojuego multiplataforma creado por Unity Technologies..
                                    <br /><br />
                                    2.Configura los enemigos con colisionadores (Colliders) y _________ apropiadas, como "Enemy".
                                    <br /><br />
                                    3. Saltos sobre __________.
                                </div>
                            </div>
                        </td>
            ...
            <div class="crucigrama">
                ...
                <table id="crucigrama">
                    ...
                    <tr>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C1" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C2" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C3" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C4" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td> <!--palabra unity letra U-->
                            <input class="casilla" type="text" maxlength="1" id="fila2C5" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C6" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra ENEMY letra E-->
                            <input class="casilla" type="text" maxlength="1" id="fila2C7" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila2C8" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra Tags letra A-->
                    ...
                    <tr>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C1" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C2" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C3" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C4" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra unity letra N-->
                            <input class="casilla" type="text" maxlength="1" id="fila3C5" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C6" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra ENEMY letra N-->
                            <input class="casilla" type="text" maxlength="1" id="fila3C7" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila3C8" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra Tags letra A -->
                    ...
                    <tr>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C1" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C2" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C3" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C4" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra unity letra T-->
                            <input class="casilla" type="text" maxlength="1" id="fila5C5" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C6" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra ENEMY letra M-->
                            <input class="casilla" type="text" maxlength="1" id="fila5C7" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C8" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila5C9" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                    ...
                    <tr>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C1" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C2" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C3" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C4" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra unity letra Y-->
                            <input class="casilla" type="text" maxlength="1" id="fila6C5" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C6" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td><!--palabra unienemyty letra Y-->
                            <input class="casilla" type="text" maxlength="1" id="fila6C7" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C8" style="border-style: none;
                                background-color: rgba(255,255,255,0);" />
                        </td>
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila6C9" style="border-style: none;
                              background-color: rgba(255,255,255,0);" />
                        </td>
    ...
    <script>
        ...
        //Palabra UNITY
        var palabra2_letra1 = document.getElementById("fila2C5");
        var palabra2_letra2 = document.getElementById("fila3C5");
        var palabra2_letra3 = document.getElementById("fila4C5");
        var palabra2_letra4 = document.getElementById("fila5C5");
        var palabra2_letra5 = document.getElementById("fila6C5");


        //Palabra COLLIDERS
        var palabra3_letra1 = document.getElementById("fila4C1");
        var palabra3_letra2 = document.getElementById("fila4C2");
        var palabra3_letra3 = document.getElementById("fila4C3");
        var palabra3_letra4 = document.getElementById("fila4C4");
        var palabra3_letra5 = document.getElementById("fila4C5");
        var palabra3_letra6 = document.getElementById("fila4C6");
        var palabra3_letra7 = document.getElementById("fila4C7");
        var palabra3_letra8 = document.getElementById("fila4C8");
        var palabra3_letra9 = document.getElementById("fila4C9");

        //Palabra TAGS
        var palabra4_letra1 = document.getElementById("fila1C9");
        var palabra4_letra2 = document.getElementById("fila2C9");
        var palabra4_letra3 = document.getElementById("fila3C9");
        var palabra4_letra4 = document.getElementById("fila4C9");


        //Palabra ENEMY
        var palabra5_letra1 = document.getElementById("fila2C7");
        var palabra5_letra2 = document.getElementById("fila3C7");
        var palabra5_letra3 = document.getElementById("fila4C7");
        var palabra5_letra4 = document.getElementById("fila5C7");
        var palabra5_letra5 = document.getElementById("fila6C7");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "assets" &&
                palabra2.toLowerCase() == "unity" &&
                palabra3.toLowerCase() == "colliders" &&
                palabra4.toLowerCase() == "tags" &&
                palabra5.toLowerCase() == "enemy"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra1.toLowerCase() != "assets") {
                    palabra1_letra1.value = "";
                    palabra1_letra2.value = "";
                    palabra1_letra3.value = "";
                    palabra1_letra4.value = "";
                ...
                if (palabra3.toLowerCase() != "colliders") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra3.toLowerCase() == "colliders") {
                    ...
                    palabra2_letra3.value = "i";

                }

                if (palabra2.toLowerCase() == "unity") {
                    palabra3_letra5.value = "i";
                }

                if (palabra5.toLowerCase() == "enemy") {
                    palabra3_letra7.value = "e";
                }
