...
<body onload="iniciarTiempo()">
	...
	<script>
		...
		var preguntas = [{
				num: 1,
				pregunta: "¿Por qué se genera el sentido de progresión y desafío para el jugador?",
			...
			{
				num: 2,
				pregunta: "¿Qué tipo de archivo es el LevelManager?",
				opA: "SCRIPT",
				opB: "JSON",
				opC: "Clase",
				correcta: "A",
			...
			{
				num: 3,
				pregunta: "¿Cuál es el nombre del archivo que actuará como administrador de nivel?",
				opA: "UnityEngine",
				opB: "NextLevelName",
				opC: "LevelManager",
				correcta: "C",
			...
			{
				num: 4,
				pregunta: "¿Qué etiqueta se debe de asignar a los enmigos del juego?",
				opA: "Enemys",
				opB: "Enemy",
				opC: "Enemigo",
				correcta: "B",
			...
			{
				num: 5,
				pregunta: "¿Es una mecánica común en los juegos una vez que se han eliminado los enemigos?",
			...
			{
				num: 6,
				pregunta: "¿En que clase se encuentra el método LoadNextLevel?",
				opA: "CombateEnemigo",
				opB: "UnityEnginer",
				opC: "LevelManager",
				correcta: "C",
			...
			{
				num: 7,
				pregunta: "¿Qué tipo de dato es el NextLevelName?",
				opA: "Float",
				opB: "String",
				opC: "Boolean",
				correcta: "B",
			...
			{
				num: 8,
				pregunta: "¿Cuál de los siguientes elementos es una variable?",
				opA: "NextLevelName",
				opB: "LoadNextLevel",
				opC: "Start",
				correcta: "A",
			...
			{
				num: 9,
				pregunta: "¿Cuál de los siguientes elementos es un arreglo?",
				opA: "NextLevelName",
				opB: "LevelManager",
				opC: "GameObject",
				correcta: "C",
			...
			{
				num: 10,
				pregunta: "¿En dónde se almacenan las etiquetas 'enemy'?",
				opA: "Enemies",
				opB: "GameObjects",
				opC: "CombateEnemigo",
				correcta: "B",
