            ...
            <div class="container">
                ...
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/videojuegosunitya/T4/1.jpg'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/videojuegosunitya/T4/2.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunitya/T4/3.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunitya/T4/4.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunitya/T4/5.jpg');"></li>
                                ...
                                <div>
                                    <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd11.php">
                                        ...
                                        <div class="container-question">
                                            ...
                                            <label for="checkbox4">Condiciones</label>
                                        </div>
