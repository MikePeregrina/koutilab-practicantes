        ...
        $(document).ready(function() {
            (function($) {
                $('#FiltrarContenido').keyup(function() { //input que contiene la búsqueda deseada
                    ...
                    $('.photo-slider-img').filter(function() {
                        return ValorBusqueda.test($(this).text());
                    }).show();
                    $('.photo-slider-img').filter(function() {
                        return ValorBusqueda.test($(this).text());
                    }).addClass('carrusel-cursos');

                    /*$('.photo-slider-img').filter(function() {
                        return ValorBusqueda.test($(this).text());
                    }).removeClass('carrusel-cursos');*/

                    $('.photo-page').hide();
                    $('.photo-page').removeClass('transicion-cursos');
                    $('.photo-page').filter(function() {
                        return ValorBusqueda.test($(this).text());
                    }).show();
                    $('.photo-page').filter(function() {
                        return ValorBusqueda.test($(this).text());
                    }).addClass('transicion-cursos');
                })
            }(jQuery));
        });
    </script>
...
<body>
    ...
    <div class="container-principal">
        <section class="seccion-perfil-usuario">
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    ...
                    <div class="Logo2">
                        <img src="../personal/img/Bienvenida.png" style="height: 110px; width:170px;">
                    </div>
                    ...
                    <div class="desplegable">
                        ...
                        <button type="button" class="boton-opciones" id="" placeholder="Opciones">
                            <div class="sing"> <img src="../personal/img/ajustes.png" alt="" height="20px" width="20px" class="svg">
                            </div>
        ...
        <div class="body">
                ...
                <div class="dos1">
                    ...
                    <div class="search">
                        <div class="box-search">
                            <input id="FiltrarContenido" type="text" placeholder="Buscar curso">
                    ...
                    <div class="container-slider">
                        ...
                        <div class="row">
                            <div class="photo-slider">
                                ...
                                <img id="slider-img-3" src="img/pwA.jpg" alt="programación web avanzado" class="photo-slider-img">
                                <img id="slider-img-4" src="img/python.png" alt="python básico" class="photo-slider-img">
                                <img id="slider-img-5" src="img/python2.webp" alt="python intermedio" class="photo-slider-img">
                                <img id="slider-img-6" src="img/python3.jpg" alt="python avanzado" class="photo-slider-img">-->
                            </div>
                            <div class="photo-controls">
                                <div class="photo-pagination">
                                    ...
                                    while ($curso = mysqli_fetch_assoc($resultado)) { //Agregando cada curso de la BD
                                        $contador++; ?>
                                        <div class="photo-page transicion-cursos">
            ...
            <div class="latd">
                ...
                $sql = "SELECT * FROM acceso_cursos_personal
                    WHERE id_alumno = $id_user AND id_curso = 1";
                $result = mysqli_query($conexion, $sql);
                $fila = mysqli_fetch_assoc($result);
                ...
                <?php
                $sql = "SELECT * FROM acceso_cursos_personal
                    WHERE id_alumno = $id_user AND id_curso = 2";
                $result = mysqli_query($conexion, $sql);
                $fila = mysqli_fetch_assoc($result);
                ...
                <?php
                $sql = "SELECT * FROM acceso_cursos_personal
                    WHERE id_alumno = $id_user AND id_curso = 3";
                $result = mysqli_query($conexion, $sql);
                $fila = mysqli_fetch_assoc($result);
                ...
                <?php
                $sql = "SELECT * FROM acceso_cursos_personal
                    WHERE id_alumno = $id_user AND id_curso = 4";
                $result = mysqli_query($conexion, $sql);
                $fila = mysqli_fetch_assoc($result);
        ...
        <script>
            ...
            $(function() {
                ...
                function OK() {
                    ...
                    $('.transicion-cursos').removeClass('active').eq(N).addClass('active');
                    // Actualizar la clase 'NOW' en el slide correspondiente para marcarlo como el actual
                    $('.carrusel-cursos').removeClass('NOW').eq(N).addClass('NOW');
                }

                $('.transicion-cursos').on('click', function() {
        ...
        ";
                ...
                $query = "UPDATE alumnos_personal SET image = '$newImageName' WHERE id_alumno = $id";
      ...
      Swal.fire({
        ...
        <div class="pie-pagina">
            <div class="imagenLogoF">
                ...
                <img src="../personal/img/Bienvenida.png" width="270px" height="175px">
            </div>
        </div>
    </div>
</body>