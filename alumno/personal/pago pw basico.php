...
if (ProPayPal) {
    ...
    define("PayPalSecret", "*********************");
    define("PayPalBaseUrl", "http://localhost/Koutilab-practicantes/alumno/personal/pasarela/");
                ...
                <div class="form-box">
                    <div class="button-box">
                        <button type="button" class="toggle-btn">
                            <p>Pago Curso Programacion Web Basico</p>
                        </button>
                    </div>
                    <div class="logop">
                            ...
                            paypal.Button.render({
                                ...
                                onAuthorize: function(data, actions) {
                                    return actions.payment.execute()
                                        .then(function() {
                                            window.location = "<?php echo PayPalBaseUrl; ?>orderDetails.php?payment_id=" 
                                            + data.paymentID + "&item_number=<?php echo $productId; ?>
                                            " + "&item_name=<?php echo $productName; ?>" + "&payment_amount=<?php echo $productPrice; ?>" 
                                            + "&payment_currency=<?php echo $currency; 
                                            ?>" + "&id_alumno=<?php echo $id_user; ?>" + "&id_capsula=<?php echo $id_capsula; ?>" 
