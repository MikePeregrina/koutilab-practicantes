...
$sql_verificar_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_primaria c INNER JOIN detalle_capsulas_primaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_verificar_html2' AND d.id_curso = 3");
...
$sql_comprada_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_primaria c INNER JOIN detalle_capsulas_pago_primaria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_comprada_html2' AND d.id_curso = 3;");
...
$sql_verificar_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_primaria c INNER JOIN detalle_capsulas_primaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_verificar_css2' AND d.id_curso = 3");
...
$sql_comprada_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_primaria c INNER JOIN detalle_capsulas_pago_primaria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_comprada_css2' AND d.id_curso = 3;");
...
$sql_comprada_js2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_primaria c INNER JOIN detalle_capsulas_pago_primaria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_comprada_js2' AND d.id_curso = 3;");
$existe_comprada_js2 = mysqli_num_rows($sql_comprada_js2);

//Verificar si capsula esta completada para mostrar la opcion de compra de capsula 1 de js
$capsula_verificar_php1 = "capsula54";
$sql_verificar_php1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_primaria c INNER JOIN detalle_capsulas_primaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_verificar_js1' AND d.id_curso = 3");
$existe_verificar_cphp1 = mysqli_num_rows($sql_verificar_php1);

//Verificar si esta comprada la capsula 1 de js
$capsula_comprada_php1 = "capsulapago5";
$sql_comprada_php1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_primaria c INNER JOIN detalle_capsulas_pago_primaria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_comprada_js1' AND d.id_curso = 3;");
...
$sql_comprada_php2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_primaria c INNER JOIN detalle_capsulas_pago_primaria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$capsula_comprada_js2' AND d.id_curso = 3;");
        ...
        <section>
            <div class="main-content">
                ...
                <div class="container-premium1">
                    ...
                    <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/plataforma-pwa/lvl-1/lvl1-1.php"><button class="btn13" id="gamep" <?php echo 'style="' . (($existe_capsula12 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 4-->
                </div>
                <!-- TEMA 5 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjhtml4.php"><button class="btn16" id="game" <?php echo 'style="' . (($existe_capsula15 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 5-->
                <!-- EVALUATIVA HTML-->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjcss1.php"><button class="btn21" id="game" <?php echo 'style="' . (($existe_capsula21 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 1-->
                <!-- TEMA 2 -->
                <div class="container-premium2">
                    ...
                    <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/plataforma-pwa/lvl-2/lvl2-2.php"><button class="btn24" id="gamep" <?php echo 'style="' . (($existe_capsula24 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 2-->
                </div>
                <!-- TEMA 3 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjcss2.php"><button class="btn27" id="game" <?php echo 'style="' . (($existe_capsula27 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 3-->
                <!-- TEMA 4 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjcss3.php"><button class="btn30" id="game" <?php echo 'style="' . (($existe_capsula30 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 4-->
                <!-- TEMA 5 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjcss4.php"><button class="btn33" id="game" <?php echo 'style="' . (($existe_capsula33 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 5-->
                <!-- EVALUATIVA CSS-->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjjs1.php"><button class="btn38" id="game" <?php echo 'style="' . (($existe_capsula38 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 1-->
                <!-- TEMA 2 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjjs2.php"><button class="btn41" id="game" <?php echo 'style="' . (($existe_capsula41 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 2-->
                <!-- TEMA 3 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjjs3.php"><button class="btn44" id="game" <?php echo 'style="' . (($existe_capsula44 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 3-->
                <!-- TEMA 4 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjjs4.php"><button class="btn47" id="game" <?php echo 'style="' . (($existe_capsula47 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 4-->
                <!-- TEMA 5 -->
                <div class="container-premium3">
                    ...
                    <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/plataforma-pwa/lvl-3/lvl3-1.php"><button class="btn50" id="gamep" <?php echo 'style="' . (($existe_capsula50 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 5-->
                </div>
                    <!-- EVALUATIVA JS -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjphp1.php"><button class="btn55" id="game" <?php echo 'style="' . (($existe_capsula55 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 1-->
                <!-- TEMA 2 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjphp2.php"><button class="btn58" id="game" <?php echo 'style="' . (($existe_capsula58 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 2-->
                <!-- TEMA 3 -->
                <div class="container-premium4">
                    ...
                    <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/plataforma-pwa/lvl-4/lvl4-1.php"><button class="btn61" id="gamep" <?php echo 'style="' . (($existe_capsula61 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 3-->
                </div>
                <!-- TEMA 4 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjphp3.php"><button class="btn64" id="game" <?php echo 'style="' . (($existe_capsula64 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 4-->
                <!-- TEMA 5 -->
                ...
                <a href="../cursos/programacion-web/avanzado/capsulas/contenido/juegos/cjphp4.php"><button class="btn67" id="game" <?php echo 'style="' . (($existe_capsula67 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 5-->
                <!-- EVALUATIVA PHP -->
