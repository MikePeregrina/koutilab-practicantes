    ...
    <section>
        <div class="main-content">
            ...
            <div class="snake">
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-1.php"><button class="btn36" id="game" <?php echo 'style="' . (($existe_capsula28 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 1-->
                <!-- TEMA 2 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-2.php"><button class="btn39" id="game" <?php echo 'style="' . (($existe_capsula31 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 2-->
                <!-- TEMA 3 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-3.php"><button class="btn42" id="game" <?php echo 'style="' . (($existe_capsula34 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 3-->
                <!-- TEMA 4 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-4.php"><button class="btn45" id="game" <?php echo 'style="' . (($existe_capsula37 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 4-->
                <!-- TEMA 5 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-5.php"><button class="btn48" id="game" <?php echo 'style="' . (($existe_capsula40 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 5-->
                <!-- TEMA 6 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-6.php"><button class="btn51" id="game" <?php echo 'style="' . (($existe_capsula43 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 6-->
                <!-- TEMA 7 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-7.php"><button class="btn54" id="game" <?php echo 'style="' . (($existe_capsula46 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 7-->
                <!-- TEMA 8 -->
                ...
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/juegos/cjui2-8.php"><button class="btn60" id="game" <?php echo 'style="' . (($existe_capsula49 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 9-->
                <!-- TEMA 10 -->
