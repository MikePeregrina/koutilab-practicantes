...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Introducción 1 Arduino Intermedio</div><br>
            <section id="container-slider">
                ...
                <ul id="slider">
                    ...
                    <li style="background-image: url('../../img/CI4.gif');"></li>
                    <li style="background-image: url('../../img/CI44.gif');"></li>
