        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/informatica/T1/8.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/informatica/T1/9.gif');"></li>
                        <li style="background-image: url('../../img/informatica/T1/10.gif');"></li>
                        <li style="background-image: url('../../img/informatica/T1/11.gif');"></li>
                        <li style="background-image: url('../../img/informatica/T1/12.gif');"></li>
                        <li style="background-image: url('../../img/informatica/T1/13.gif');"></li>
                        <li>
                            <div>
