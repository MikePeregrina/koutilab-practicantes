...
<body onload="iniciarTiempo();">
    ...
    <div class="contenido">
        ...
        <div class="crucigrama" style="margin: 50px 90px 0 0">
            <div class="numero1" style="margin: -25px 0 0 25px">1.</div>
            <div class="numero2" style="margin: -25px 0 0 480px">2.</div>
            <div class="numero1-1" style="margin: 20px 0 0 -20px">1.</div>
            <div class="numero2-2" style="margin: 155px 0 0 170px">2.</div>
            <div class="numero3-3" style="margin: 350px 0 0 370px">3.</div>
            <table id="crucigrama">
                <tr>
                    <td>
