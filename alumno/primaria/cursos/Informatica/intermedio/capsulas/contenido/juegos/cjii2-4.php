...
<body onload="iniciarTiempo()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>TABULACIÓN Y LISTAS </b></h2>
	</div>
		...
		var preguntas = [
			{
				num: 1,
				pregunta:
					"¿A que se refieren las tabulaciones?",
			...
			},
			{
				num: 2,
				pregunta:
					"¿Cuántos tipos de tabulaciones existen o son los mas ocupados?",
				opA: "6",
				opB: "4",
				opC: "1",
				correcta: "B",
			...
			},
			{
				num: 3,
				pregunta:
					"¿Qué icono en el teclado tiene la tecla de tabulación?",
			...
			},
			{
				num: 5,
				pregunta:
					"Uno de los siguientes tipos de listas NO existe.",
