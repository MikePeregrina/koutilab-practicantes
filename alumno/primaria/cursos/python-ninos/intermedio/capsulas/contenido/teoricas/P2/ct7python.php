...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 7 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P2/T7/146.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P2/T7/147.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T7/148.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T7/149.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T7/150.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T7/151.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>¿Qué son las clases en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Son una forma de definir nuevos tipos de objetos.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son características específicas de los archivos y directorios en el sistema operativo.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Son funciones especializadas utilizadas para realizar operaciones matemáticas complejas.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Son una forma de agrupar datos en estructuras de datos complejas, como matrices multidimensionales.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="43">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct7python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        var words = ['PYTHON', 'CLASS', 'ATRIBUTO', 'KOUTILAB'];
