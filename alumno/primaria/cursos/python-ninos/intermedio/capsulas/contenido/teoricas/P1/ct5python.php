        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P1/T5/55.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P1/T5/56.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T5/57.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T5/58.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T5/59.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T5/60.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el alcance de una variable local en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Puede ser accedida y modificada desde cualquier parte del programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Puede ser accedida y modificada desde cualquier parte del programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Puede ser accedida y modificada desde cualquier parte del programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Puede ser accedida y modificada solo dentro de un bucle.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="14">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct5python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
