        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P1/T3/23.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P1/T3/24.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T3/25.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Definir una función</div>
                                        <div class="word-box" id="sql">Llamar una función</div>
                                        <div class="word-box" id="html">Argumentos de función</div>
                                        <div class="word-box" id="javascript">Valores de retorno</div>
                                        <div class="word-box" id="php">Función sin parametros</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">def saludar(nombre):
                                        </div>
                        ...
                        <li style="background-image: url('../../../../img/P1/T3/26.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T3/27.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué es una llamada de función en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Un bloque de código que se ejecuta cuando se llama a una función.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Una forma de definir una nueva función.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Una operación matemática que se realiza en Python.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4"> Una variable que almacena un valor específico.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="8">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct3python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
