...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P2/T2/97.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P2/T2/98.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T2/99.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T2/100.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T2/101.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T2/102.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>¿Qué son los cálculos combinados en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Se refieren a la capacidad de realizar operaciones matemáticas utilizando múltiples valores o variables en una sola expresión.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2"> se refieren a la combinación de texto y números en una cadena de caracteres.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Se refieren a la manipulación de archivos y directorios utilizando operaciones matemáticas.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Las tres opciones anteriores.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="28">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct2python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        var words = ['PYTHON', 'CALCULO', 'RESULTADO', 'KOUTILAB'];
