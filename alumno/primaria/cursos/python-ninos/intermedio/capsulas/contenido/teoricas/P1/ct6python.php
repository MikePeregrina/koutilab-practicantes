...
$id_user = $_SESSION['id_alumno_primaria'];
$permiso = "capsula16";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_primaria c INNER JOIN detalle_capsulas_primaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 17");
...
$permiso_intento = 17;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_primaria WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 17");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_primaria WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 17");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6 Python </div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P1/T6/62.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P1/T6/63.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T6/64.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T6/65.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T6/66.gif');"></li>
                        <li style="background-image: url('../../../../img/P1/T6/67.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Lista</div>
                                        <div class="word-box" id="sql">Tupla</div>
                                        <div class="word-box" id="html">Conjunto</div>
                                        <div class="word-box" id="javascript">Diccionario</div>
                                        <div class="word-box" id="php">Datos compuestos</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="interactividad" onclick="checkAnswer('interactividad')">
                                            Diccionario = {"Karla", "Jaime", "Rafa"}</div>
                                        <div class="word-box" id="funcionalidad" onclick="checkAnswer('funcionalidad')">
                                            Diccionario, tupla, lista, conjunto</div>
                                        <div class="word-box" id="estructura" onclick="checkAnswer('estructura')">
                                            conjunto = {4, 6, 7}
                                        </div>
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">lista = [1, 2, 3]
                                        </div>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>¿Qué es un dato compuesto en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Un tipo de dato que solo se utiliza en estructuras de control.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Un tipo de dato que almacena un solo valor.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Un tipo de dato que solo se utiliza en funciones.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Un tipo de dato que solo se utiliza en estructuras de control.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="17">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct6python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
