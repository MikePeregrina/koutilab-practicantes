...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 3 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P2/T3/104.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P2/T3/105.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T3/106.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T3/107.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T3/108.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T3/109.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Tema que estamos viendo</div>
                                        <div class="word-box" id="sql">¿Dónde se almacena un conjunto?</div>
                                        <div class="word-box" id="html">Forma en que se define un set</div>
                                        <div class="word-box" id="javascript">Mandar a imprimir un set</div>
                                        <div class="word-box" id="php">Python</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="funcionalidad" onclick="checkAnswer('funcionalidad')">
                                            Lenguaje de programación aprendido</div>
                                        <div class="word-box" id="estructura" onclick="checkAnswer('estructura')">
                                            numeros = set([1, 2, 3])
                                        </div>
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">Conjuntos
                                        </div>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>Selecciona el ejemplo correcto de un conjunto</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">frutas = {"manzana", "banana", "naranja"}</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">frutas = ["manzana", "banana", "naranja"]</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">frutas = ("manzana", "banana", "naranja")</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">frutas = "manzana, banana, naranja"</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="31">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="17">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct3python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
