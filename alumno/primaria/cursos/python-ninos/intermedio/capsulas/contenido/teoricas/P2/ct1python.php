        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/P2/T1/90.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/P2/T1/91.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T1/92.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T1/93.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T1/94.gif');"></li>
                        <li style="background-image: url('../../../../img/P2/T1/95.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1> ¿Qué es un diccionario en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Es una estructura de datos mutable que permite almacenar pares de clave-valor de manera desordenada.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Es una estructura de datos inmutable que no puede modificarse una vez creado.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Es una función especializada para realizar operaciones matemáticas complejas.</label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct1python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
