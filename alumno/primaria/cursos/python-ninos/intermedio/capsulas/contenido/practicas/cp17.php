...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 17</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea un programa que le pida al usuario que ingrese un número entero. Si el usuario ingresa un número entero, el programa imprimirá el doble de ese número.
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../img/code17.png" ">
                                </img>
                            </td>
                        </tr>
                    </tbody>
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 17 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp17.php';
                    }
                });
            } else {
