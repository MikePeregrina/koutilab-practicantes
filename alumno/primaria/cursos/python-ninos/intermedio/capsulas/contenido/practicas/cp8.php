...
<body>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una lista llamada frutas que contenga las siguientes frutas: manzana, banana, pera, naranja, fresa. Accede al tercer elemento de la lista frutas y asígnalo a una variable llamada mi_fruta.
                                </p>
                            </td>
                            <td class="ne">
    ...
    <script>
        ...
        function miFunc() {
            ...
            // let esCorrecto = ta == '1\n2\nfrutas = ["manzana", "banana", "pera", "naranja", "fresa"]\nmi_fruta = frutas[2]';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 17 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp8.php';
                    }
                });
            } else {
