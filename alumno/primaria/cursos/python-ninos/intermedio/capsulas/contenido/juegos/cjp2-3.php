...
<body>
	...
	<div class="titulo-gen">
		<h4 class="titulo" style="margin-left: 520px;"><b>CONJUNTOS</b></h4>
	</div>
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 33 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-3.php'; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 33 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-3.php'; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
