...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "¿Sabes como se llama el tema del día de hoy?",
                respuesta: "paquetes",
                respondida: false
            },
            {
                pregunta: "Para crear un paquete, debemos guardar todos nuestros archivos en una... Pista: C__P___",
                respuesta: "carpeta",
                respondida: false
            },
            {
            ...
            {
                pregunta: "Una carpeta o paquete debe tener un archivo __¿?__.py para indicar que es un paquete, pero, ¿Qué va dentro de los signos de interrogación? Pista: I__T",
                respuesta: "init",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 39 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-5.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 39 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-5.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
