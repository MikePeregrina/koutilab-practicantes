...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 10 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp1-3.php'; //cancatenation
    ...
    <script>
        ...
        palabras_array.push("MATH");
        palabras_array.push("ABS");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "MATEMATICAS": // Se debera hacer un case por cada palabra
                    pista = "El tema de hoy se llama funciones...";
                    break; // Es importante el break en cada case
                case "MATH": // Se debera hacer un case por cada palabra
                    pista = "Es la librería que nos ayuda a realizar operaciones matemáticas";
                    break; // Es importante el break en cada case
                case "ABS": // Se debera hacer un case por cada palabra
                    pista = "Se trata de la función que toma un número como entrada y devuelve su valor absoluto";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 10 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp1-3.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
