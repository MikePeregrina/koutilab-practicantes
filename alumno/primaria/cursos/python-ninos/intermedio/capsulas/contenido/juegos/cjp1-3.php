...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="contenido">
        <div class="cont-st">
            <a href="../../../../../../rutas/ruta-py-i-ninos.php">
    ...
    <script>
        ...
        function tiempoAgotado() {
            ...
            var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 10 + "&id_curso=" + 5 + "&redireccion=" + '../contenido/juegos/cjp1-3.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 10 + "&id_curso=" + 5 + "&redireccion=" + '../contenido/juegos/cjp1-3.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
