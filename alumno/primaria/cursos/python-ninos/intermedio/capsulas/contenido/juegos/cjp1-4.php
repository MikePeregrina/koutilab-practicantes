...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "El tema de hoy se llama llamada de...",
                respuesta: "funciones",
                respondida: false
            },
            {
            ...
            {
                pregunta: "Es lo que retornamos o regresamos como resultado al final de una función. Pista: R__U__",
                respuesta: "return",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp1-4.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp1-4.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
