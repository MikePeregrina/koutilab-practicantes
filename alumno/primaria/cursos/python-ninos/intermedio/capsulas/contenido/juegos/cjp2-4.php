...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>MÓDULOS</b></h2>
    </div>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 36 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-4.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("MODULOS");
        palabras_array.push("IMPORT");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "MODULOS": // Se debera hacer un case por cada palabra
                    pista = "Se trata de un archivo que contiene un conjunto de funciones que se pueden utilizar en otros programas";
                    break; // Es importante el break en cada case
                case "IMPORT": // Se debera hacer un case por cada palabra
                    pista = "Es la función que nos ayuda a importar un módulo que hayamos desarrollado";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 36 + "&id_curso=" + 17 + "&redireccion=" + '../contenido/juegos/cjp2-4.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
