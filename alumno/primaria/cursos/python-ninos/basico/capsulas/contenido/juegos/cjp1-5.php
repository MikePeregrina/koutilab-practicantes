...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>TIPOS DE DATOS</b></h2>
    </div>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 16 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp1-5.php'; //cancatenation
