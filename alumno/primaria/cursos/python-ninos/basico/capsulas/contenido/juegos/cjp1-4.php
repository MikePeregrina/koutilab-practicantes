...
<body onload="iniciarTiempo();">
	...
	<script>
		...
		var words = ['STRING', 'INTEGER', 'BOOLEAN', 'PYTHON', 'FLOAT', 'CODING', 'PROGRAM', 'DATABASE'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp1-4.php'; //cancatenation
