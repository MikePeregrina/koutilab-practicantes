...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
            ...
            {
                pregunta: "Se trata de la función básica de Python que nos ayuda a mandar a imprimir un mensaje. Pista: P__N_",
                respuesta: "print",
                respondida: false
            },
            {
                pregunta: "El tema que actualmente estamos aprendiendo se llama Sintaxis... Pista: _Á__C_",
                respuesta: "básica",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 4 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp1-1.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 4 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp1-1.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
