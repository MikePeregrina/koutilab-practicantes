...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Se trata del lenguaje de programación que actualmente estamos aprendiendo",
                respuesta: "python",
                respondida: false
            },
            {
                pregunta: "Es el operador en el que devuelve TRUE si se hace referencia al mismo objeto",
                respuesta: "is",
                respondida: false
            },
            {
                pregunta: "Es el operador en el que devuelve TRUE si no se hace referencia al mismo objeto",
                respuesta: "isnot",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 30 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp2-2.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + +"&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp2-2.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
