...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 Python Básico</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T2/27.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P1/T2/28.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T2/29.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T2/30.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T2/31.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T2/32.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>¿Cuál de las siguientes opciones es un comentario válido en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1"># Esto es un comentario</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">// Esto es un comentario</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3"><-- Esto es un comentario -></label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">/* Esto es un comentario */</label>
                                    </div>
    ...
    <script>
        ...
        var words = ['PYTHON', 'COMENTARIOS', 'PROGRAMA', 'KOUTILAB'];
