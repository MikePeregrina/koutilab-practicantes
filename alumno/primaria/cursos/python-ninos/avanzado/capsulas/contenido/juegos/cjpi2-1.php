...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 27 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi1-6.php'; //cancatenation
    ...
    <script>
        ...
        palabras_array.push("BUCLE");
        palabras_array.push("PYTHON");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "VACIOS": // Se debera hacer un case por cada palabra
                    pista = "En Python podemos eliminar los strings que esten?";
                    break; // Es importante el break en cada case
                case "REMOVE":
                    pista =
                        "Este metodo elimina un elemento especifico de la lista";
                    break;
                case "ELEMENTO":
                    pista =
                        "Usando el metodo remove() eliminamos un ​";
                    break;
                case "BUCLE":
                    pista = "Lo utilizamos para iterar sobre la lista y eliminar cualquier string vacio";
                    break;
                case "PYTHON":
                    pista =
                        "Es el lenguaje de programacion con el que estamos trabajando";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 27 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi2-1.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 27 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi2-1 .php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
