    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- ¿Cuál es la forma correcta de asignar un mismo valor a distintas variables?
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="incorrecto">a, b, c = 12</option>
                        <option value="incorrecto">a-b-c = 12</option>
                        <option value="correcto">a = b = c = 12</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- ¿La sintáxis siguiente es la correcta? a, b, c = 12
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="correcto">¡Imposible!</option>
                        <option value="incorrecto">¡Verdadero!</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- ¿Puedo asignar valores distintos unas vez que le asigné los valores iniciales?
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 33 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp2-3.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 33 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp2-3.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
