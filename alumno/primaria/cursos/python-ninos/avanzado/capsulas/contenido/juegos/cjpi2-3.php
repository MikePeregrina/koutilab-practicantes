...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>ASIGNAR UN MISMO VALOR A MÚLTIPLES VARIABLES</b></h2>
    </div>
    ...
    <!-- fIN CAMBIOS -->
    <script>//arreglo que almacena las pistas y respuestas de la adivinanza
const adivinanzas = [
  { pregunta: "Es posible que se le asigne el mismo valor a diferentes de ellas en la misma linea", respuesta: "Variables", respondida: false },
  { pregunta: "Permite separar el nombre de diferentes variables en la misma linea.", respuesta: "Coma", respondida: false },
  { pregunta: "Es el lado en el que se tiene que colocar el valor de las variables.", respuesta: "Derecha", respondida: false },
  { pregunta: "Es el lado en el que se tiene que colocar el nombre de las variables.", respuesta: "Izquierda", respondida: false },
  { pregunta: "Lenguaje de programacion que no detecta puntos y coma.", respuesta: "Python", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 33 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi2-3.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 33 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi2-3.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
...
mostrarPreguntaAleatoria();
document.getElementById('contador').textContent = `${puntaje} / ${adivinanzas.length}`; </script>
</body>
