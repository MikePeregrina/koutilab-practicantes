...
<body onload="iniciarTiempo()">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      const adivinanzas = [{
          pregunta: "Es posible que se le asigne el mismo valor a diferentes de ellas en la misma linea",
          respuesta: "Variables",
          respondida: false
        },
        {
          pregunta: "Permite separar el nombre de diferentes variables en la misma linea.",
          respuesta: "Coma",
          respondida: false
        },
        {
          pregunta: "Es el lado en el que se tiene que colocar el valor de las variables.",
          respuesta: "Derecha",
          respondida: false
        },
        {
          pregunta: "Es el lado en el que se tiene que colocar el nombre de las variables.",
          respuesta: "Izquierda",
          respondida: false
        },
        {
          pregunta: "Lenguaje de programacion que no detecta puntos y coma.",
          respuesta: "Python",
          respondida: false
        }
      ];
