...
<body onload="iniciarTiempo(), iniciar() ">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      const adivinanzas = [{
          pregunta: "Las funciones en Python son como pequeñas.",
          respuesta: "Herramientas",
          respondida: false
        },
        {
          pregunta: "Funciona para crear una funcion.",
          respuesta: "Def",
          respondida: false
        },
        {
          pregunta: "Devuelve el control a la funcion de llamada.",
          respuesta: "Return",
          respondida: false
        },
        {
          pregunta: "Piensa en una funcion como una.",
          respuesta: "Caja",
          respondida: false
        },
        {
          pregunta: "Herramientas que pueden hacer cosas específicas.",
          respuesta: "Funcion",
          respondida: false
        }
      ];
