...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi1-6.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("BOTONES");
        palabras_array.push("VENTANAS");
        palabras_array.push("TURTLE");
        palabras_array.push("ETIQUETAS");
        palabras_array.push("UBICACION");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "BOTONES": // Se debera hacer un case por cada palabra
                    pista = "Comandos dispuestos en forma grafica que son ejecutados al seleccionarlo";
                    break; // Es importante el break en cada case
                case "VENTANAS":
                    pista =
                        "Se asocian a interfaces graficas, ​ donde pueden ser manipuladas con un puntero.";
                    break;
                case "TURTLE":
                    pista =
                        "Libreria que permite hacer que la tortuga dibuje un cuadrado​";
                    break;
                case "ETIQUETAS":
                    pista = "Nombre que se le dan a las ventanas o textos que se introducen en el espacio grafico.";
                    break;
                case "UBICACION":
                    pista =
                        "Requiere ser ubicado por ello es necesario que se localice con place, grid o pack.";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 18 + "&redireccion=" + '../contenido/juegos/cjpi1-6.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
