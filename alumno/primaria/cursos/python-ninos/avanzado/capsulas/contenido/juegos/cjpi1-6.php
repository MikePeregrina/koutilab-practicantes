...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>TRABAJANDO CON GRÁFICOS</b></h2>
    </div>
    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- ¿Cuál de las siguientes librerías pertenece a una que nos ayude con los gráficos de Python?
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="incorrecto">pandas</option>
                        <option value="correcto">matplotlib</option>
                        <option value="incorrecto">math</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- ¿Como podemos importar la librería matplotlib?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="correcto">import matplotlib.pyplot as plt</option>
                        <option value="incorrecto">importa matplotlib.pyplot as plt</option>
                        <option value="incorrecto">export matplotlib.pyplot as plt</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- ¿Con qué funciones podemos crear los gráficos de barras y mostrarlos?
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="correcto">bar() y show()</option>
                        <option value="incorrecto">math() y bar()</option>
                        <option value="incorrecto">show() y math()</option>
                    </select>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp1-6.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp1-6.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
