...
$permiso_intento = 4; //Poner el mismo permiso que corresponde a la lista
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 20</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>
                                    1.Crea una clase llamada MiClase y especifica MiMetaclase como su metaclase utilizando la sintaxis de class MiClase(metaclass=MiMetaclase):.<br>
                                    2.En la definición de la clase MiMetaclase, agrega un método llamado nuevo_metodo que imprime un mensaje diciendo "¡Hola, soy un nuevo método!".<br>
                                    3.Crea una instancia de la clase MiClase.<br>
                                    4.Intenta llamar al método nuevo_metodo en la instancia de MiClase.<br>
                                    5.Verifica que imprima el mensaje "¡Hola, soy un nuevo método!".
                                </p>
                            </td>
                            <td class="ne">
                                <img class="js-player" src="../../img/cpavanzado20.png">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp20.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp20.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
