...
$permiso_intento = 26; //Poner el mismo permiso que corresponde a la lista
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una lista llamada frutas que contiene algunos elementos vacíos (""). Luego utiliza la función filter() para eliminar todos los elementos vacíos. La función filter() toma dos argumentos: una función y una lista
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&redireccion=' + '../contenido/practicas/cp11.php';
                    }
                });
            } else {
