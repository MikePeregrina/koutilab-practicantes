...
$permiso_intento = 32; //Poner el mismo permiso que corresponde a la lista
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 1.Asignar un mismo valor a múltiples variables<br>
                                    2.Cambiar el valor de una variable<br>
                                    3.Mostrar los valores actualizados de todas las variables<br>
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp13.php';
                    }
                });
            } else {
