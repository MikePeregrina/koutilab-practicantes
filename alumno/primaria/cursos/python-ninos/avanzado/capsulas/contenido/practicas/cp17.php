...
$permiso_intento = 41; //Poner el mismo permiso que corresponde a la lista
...
<body>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una lista anidada que contenga tres listas, cada una con tres elementos:
                                </p>
                            </td>
                            <td class="ne">
    ...
    <script>
        ...
        function miFunc() {
            ...
            // let esCorrecto = ta == '1\n2\nlista_anidada = [[1, 2, 3], ["A", "B", "C"], [True, False, True]]\nprint(lista_anidada)';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp17.php';
                    }
                });
            } else {
