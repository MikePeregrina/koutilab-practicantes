...
$permiso_intento = 18; //Poner el mismo permiso que corresponde a la lista
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 1.Crea una lista de números llamada numeros con los valores [1, 2, 3, 4, 5].<br>
                                    2.Usa una función lambda para calcular el cuadrado de cada número en la lista numeros y almacénalos en una nueva lista llamada cuadrados.<br>
                                    3.Imprime la lista cuadrados.
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp6.php?validar=' + 'incorrecto' + '&permiso=' + 18 + '&id_curso=' + 18 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp6.php?validar=' + 'correcto' + '&permiso=' + 18 + '&id_curso=' + 18 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
