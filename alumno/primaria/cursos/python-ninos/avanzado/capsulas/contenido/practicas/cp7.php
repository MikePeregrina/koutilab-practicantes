...
$permiso_intento = 15; //Poner el mismo permiso que corresponde a la lista
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 7</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 1.Crea un archivo de texto llamado "mi_archivo.txt" y escribe en él algunas líneas de texto.<br>
                                    2.Abre el archivo y lee su contenido línea por línea, imprimiendo cada línea en la consola.
                                </p>
                            </td>
                            <td class="ne">
                                <img class="js-player" src="../../img/cpaanzado7.jpg">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp7.php';
                    }
                });
            } else {
