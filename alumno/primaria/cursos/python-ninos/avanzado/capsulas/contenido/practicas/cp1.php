...
$permiso_intento = 3; //Poner el mismo permiso que corresponde a la lista
...
<body>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una función que tome un número como argumento y devuelva
                                    True si el número es par o False si el número es impar.
                                </p>
                            </td>
                            <td class="ne">
    ...
    <script>
        ...
        function miFunc() {
            ...
            // //saltos de linea en cada linea de codigo que se va utilizar // identencacion de codigo tener mucho cuidado
            // let esCorrecto = ta == '1\n2\n3\n4\n5\ndef es_par(numero):\n    if numero % 2 == 0:\n        return True\n    else:\n        return False';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp1.php';
                    }
                });
            } else {
