...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 18</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Define una clase llamada "Persona" que tenga los siguientes atributos: nombre, edad y género. Define un método llamado "saludar" que imprima un mensaje de saludo personalizado con el nombre de la persona.
                                </p>
                            </td>
                            <td class="ne">
                                <img class="js-player" src="../../img/cpavanzado18.png">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp18.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp18.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
