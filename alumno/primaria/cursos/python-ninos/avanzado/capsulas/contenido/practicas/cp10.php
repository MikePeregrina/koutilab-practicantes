...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 10</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea un programa que lea una cadena de texto ingresada por el usuario y verifique si contiene un número de teléfono con el formato "(123) 456-7890".
                                </p>
                            </td>
                            <td class="ne">
                                <img class="js-player" src="../../img/cpavanzado10.png">
    ...
    <script>
        ...
        function miFunc() {
            ...
            // let esCorrecto = ta == '1\n2\n3\n4\n5\ntexto = input("Ingresa una cadena de texto: ")\nif "hola" in texto.lower():\n    print("La cadena de texto contiene la palabra hola.")\nelse:\n    print("La cadena de texto no contiene la palabra hola.")';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp10.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp10.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 18 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
