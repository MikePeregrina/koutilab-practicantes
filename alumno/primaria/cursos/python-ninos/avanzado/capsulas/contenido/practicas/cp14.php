...
$permiso_intento = 35; //Poner el mismo permiso que corresponde a la lista
...
<body>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 1.Crea dos listas vacías: una para nombres y otra para edades.<br>
                                    2.Crea dos tuplas con los mismos valores para los nombres y las edades que quieras agregar a las listas.<br>
                                    3.Asigna los valores de las tuplas a las listas con la función extend().<br>
                                    4.Imprime las listas para comprobar que los valores se han asignado correctamente.<br>
                                </p>
                            </td>
                            <td class="ne">
    ...
    <script>
        ...
        function miFunc() {
            ...
            // let esCorrecto = ta == '1\n2\n3\n4\n5\n6\n7\n8\nnombres = []\nedades = []\ntupla_nombres = ("Juan", "María", "Carlos")\ntupla_edades = (25, 30, 35)\nnombres.extend(tupla_nombres)\nedades.extend(tupla_edades)\nprint("Lista de nombres: ", nombres)\nprint("Lista de edades: ", edades)';
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 18 + '&practico=' + 10 + '&pythoncode=' + encodeV + '&redireccion=' + '../contenido/practicas/cp14.php';
                    }
                });
            } else {
