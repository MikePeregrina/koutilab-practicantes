            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'incorrecto' + '&permiso=' + 12 + '&id_curso=' + 18 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'correcto' + '&permiso=' + 3 + '&id_curso=' + 18 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
