        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T4/28.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P1/T4/29.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T4/30.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../../img/P1/T4/31.gif');"></li>
                        <li>
                            <div>
