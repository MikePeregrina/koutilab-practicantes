        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T7/50.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P1/T7/51.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T7/52.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../../img/P1/T7/53.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son las expresiones regulares en programación?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Son secuencias de caracteres que permiten buscar y manipular patrones de texto de manera eficiente. </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son un método para cifrar y descifrar datos</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Son una forma de representar estructuras de datos complejas.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Son un lenguaje de programación completo.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="20">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="18">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct7python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
