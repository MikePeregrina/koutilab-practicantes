...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 4 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P2/T4/85.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P2/T4/86.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/87.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../../img/P2/T4/88.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/89.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es la diferencia entre la asignación de valores múltiples en listas y tuplas?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Tanto las listas como las tuplas permiten la asignación de valores múltiples</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">La asignación de valores múltiples en listas y tuplas en Python funciona de la misma manera.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">La asignación de valores múltiples en listas y tuplas en Python solo se puede hacer con números enteros.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">La asignación de valores múltiples en listas y tuplas en Python solo se utiliza en operaciones matemáticas complejas.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="34">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="18">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct4python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
