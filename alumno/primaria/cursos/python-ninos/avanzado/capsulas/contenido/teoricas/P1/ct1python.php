...
$id_user = $_SESSION['id_alumno_primaria'];
$permiso = "capsula1";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_primaria c INNER JOIN detalle_capsulas_primaria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 18");
...
$permiso_intento = 2;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_primaria WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 18");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_primaria WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 18");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T1/13.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P1/T1/14.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T1/15.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T1/16.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T1/17.gif');"></li>
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Variable entera</div>
                                        <div class="word-box" id="sql">Variable decimal</div>
                                        <div class="word-box" id="html">Variable de cadena</div>
                                        <div class="word-box" id="javascript">Variable verdadero o falso</div>
                                        <div class="word-box" id="php">Variable de longitud fija</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">int
                                        </div>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1>¿Para que sirven las variables?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Guardar informaciòn para usarla mas tarde en un programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Sirven para representar objetos o entidades del mundo real en un programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Las variables en programación sirven para navegar por Internet.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Las tres anteriores.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="2">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="18">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct1python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
