...
<body>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <h1> Para que sirve el modulo matplotlib </h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Para crear graficos mas complejos, como graficos de barras, lineas o de dispersiòn.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Realizar cálculos matemáticos y algebraicos.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Manipular bases de datos y realizar consultas SQL.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Controlar el flujo de ejecución de un programa en tiempo real.</label>
                                    </div>
    ...
    <script>
        ...
        var words = ['MATPLOTLIB', 'PYTHON', 'IMPORT', 'KOUTILAB'];
