            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una lista vacía llamada "numeros". Pide al usuario que ingrese 5 números enteros, uno por uno. Para hacer esto, puedes utilizar un bucle "for" que se ejecute 5 veces y que pida al usuario que ingrese un número en cada iteración. Agrega cada número ingresado por el usuario a la lista "numeros" utilizando el método "append()". Imprime la lista completa de "numeros" en la consola.
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 6 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 6 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
