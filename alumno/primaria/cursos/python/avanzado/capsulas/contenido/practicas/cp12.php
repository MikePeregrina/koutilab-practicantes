...
$permiso_intento = 28; //Poner el mismo permiso que corresponde a la lista
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'incorrecto' + '&permiso=' + 28 + '&id_curso=' + 6 + '&practico=' + 10 + '&pythoncode=' + encodeV;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'correcto' + '&permiso=' + 28 + '&id_curso=' + 6 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
