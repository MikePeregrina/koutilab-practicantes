...
<!-- fIN CAMBIOS -->
	<script>
		...
		var preguntas = [
          ...
          num: 1,
          pregunta:
            "Los operadores de asignación permiten realizar una operación y almacenar su resultado en una <br>_____.",
          opA: "opción",
          opB: "variable",
          opC: "entero",
          correcta: "B",
        ...
        },
        {
          num: 2,
          pregunta:
            "¿Cuál es el operador que almacena el resultado en el objeto especificado por el primer operando?",
          opA: "+=",
          opB: "&&",
          opC: "%=",
          correcta: "A",
