    ...
    <body onload="iniciarTiempo();">
        ...
        <div class="contenido">
            ...
            <div class="crucigrama" style="margin: 0 40px 0 0">
                <div class="numero1" style="margin: 44px 0 0 410px">1.</div>
                <div class="numero2" style="margin: 110px 0 0 220px">2.</div>
                <div class="numero1-1" style="margin: 150px 0 0 110px">1.</div>
                <div class="numero2-2" style="margin: 430px 0 0 25px">2.</div>
                <div class="numero3-3" style="margin: 350px 0 0 110px">3.</div>
                <table id="crucigrama">
                    <tr>
