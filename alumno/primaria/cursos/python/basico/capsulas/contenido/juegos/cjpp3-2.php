	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container" style="width: 412px; height: 412px;">
				...
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/img6.png" class="contenedor-img" alt=""></div>				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/img7.png" class="contenedor-img" alt=""></div>
		...
		function alert1() {
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					imageUrl: "../../img/img-juegos/IS.PNG",
					imageHeight: 320,
