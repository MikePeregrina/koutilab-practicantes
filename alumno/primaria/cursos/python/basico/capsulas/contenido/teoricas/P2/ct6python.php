...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6 Python Básico</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P2/T6/139.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P2/T6/140.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T6/141.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T6/142.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T6/143.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T6/144.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_ct6python.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es la diferencia entre un bucle "for" y un bucle "while" en Python?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">"for" se utiliza para iterar sobre una secuencia predefinida, mientras que "while" se repite mientras se cumpla una condición.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">"for" se utiliza para iterar sobre una secuencia predefinida, mientras que "while" se repite un número específico de veces.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">"for" se utiliza para ejecutar una sección de código una vez, mientras que "while" se repite mientras se cumpla una condición.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">"for" se utiliza para ejecutar una sección de código una vez, mientras que "while" se repite un número específico de veces.</label>
                                    </div>
