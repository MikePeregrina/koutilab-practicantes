        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T3/36.gif'); z-index:0; opacity: 1;"></li>
                        ...
                        <li style="background-image: url('../../../img/P1/T3/40.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T3/41.gif');"></li>
                        <li>
                            <div>
