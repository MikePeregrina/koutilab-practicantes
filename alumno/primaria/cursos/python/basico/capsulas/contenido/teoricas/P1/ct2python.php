        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P1/T2/22.gif'); z-index:0; opacity: 1;"></li>
                        ...
                        <li style="background-image: url('../../../img/P1/T2/26.gif');"></li>
                        <li style="background-image: url('../../../img/P1/T2/27.gif');"></li>
                        <li>
                            <div>
