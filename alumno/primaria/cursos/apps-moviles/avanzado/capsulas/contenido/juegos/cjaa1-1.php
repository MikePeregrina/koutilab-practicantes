...
<body >
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i><img src="../../img/img-juegos/s (1).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (2).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (3).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (4).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (5).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (6).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (7).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (8).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (9).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (10).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (11).png" width= "55px"></i>',
				'<i><img src="../../img/img-juegos/s (12).png" width= "55px"></i>'
			]
		}
