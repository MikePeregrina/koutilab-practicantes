...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("IMAGEVIEW");
        palabras_array.push("DINAMICO");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "IMAGEWIEW": // Se debera hacer un case por cada palabra
                    pista = "En Android hacen referencia a un contenedor o recuadro en el que podemos ubicar una imagen. En otras palabras, nos sirve para renderizar imágenes.";
                    break; // Es importante el break en cada case
                case "DINAMICO":
                    pista =
                        "Crear este tipo de ImageView Implica crear y configurar un objeto ImageView programáticamente en lugar de definirlo en un archivo .";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "../../../../../../rutas/ruta-apps-b.php";
                    }
                });
