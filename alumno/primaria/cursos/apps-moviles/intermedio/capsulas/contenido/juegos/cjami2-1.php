...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("VAR");
        palabras_array.push("VAL");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "VAR": // Se debera hacer un case por cada palabra
                    pista = "Son aquellas que pueden cambiar de valor despues su inicializacion .";
                    break; // Es importante el break en cada case
                case "VAL":
                    pista =
                        "Son aquellas que no pueden cambiar de valor despues su inicializacion .";
                    break;
