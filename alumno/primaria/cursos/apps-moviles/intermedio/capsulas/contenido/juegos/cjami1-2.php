...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>WINDOWS: COMO VERIFICAR LOS REQUISITOS DEL SISTEMA </b></h2>
    </div>
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("PROCESADOR");
        palabras_array.push("ALMACENAMIENTO");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "PROCESADOR": // Se debera hacer un case por cada palabra
                    pista = "Nombre, velocidad y numero de núcleos.";
                    break; // Es importante el break en cada case
                case "ALMACENAMIENTO":
                    pista =
                        "Capacidad y tipo de disco duro o SSD.";
                    break;
