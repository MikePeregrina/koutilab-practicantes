...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>¿POR QUÉ COMENZARON A APARECER LAS APLICACIONES MÓVILES?</b></h2>
    </div>
    ...
    <script>
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "MOVILES": // Se debera hacer un case por cada palabra
                    pista = "Estas aplicaciones fueron impulsadas por una combinacion de avances tecnologicos.";
                    break; // Es importante el break en cada case
                case "RECURSOS":
                    pista =
                        "En el desarrollo de aplicaciones moviles son el Formato articulo, ejemplos de android, presentacion android, etc.";
                    break;
