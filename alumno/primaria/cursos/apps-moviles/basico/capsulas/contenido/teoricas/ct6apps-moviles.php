        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/1/T5/37.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T5/38.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T5/39.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/apps-moviles/1/T5/40.gif');"></li>
                        <li>
                            <div>
