        ...
        function miFunc() {
            ...
            if (htmlcode == 'validar') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd57.php?validar=' + 'incorrecto' + '&permiso=' + 13 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
