        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T1/172.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T1/173.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/174.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/175.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/176.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/177.gif');"></li>
                        <li>
                            <div>
