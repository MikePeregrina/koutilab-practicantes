...
<body onload="alert1()">
    ...
    <div class="titulo-gen1">
        <h2>Capitulo 4: Espacio exterior</h2>
    </div>
    ...
    <script>
        ...
        function alertQuestion() {
            Swal.fire({
                title: "¡Buen intento!",
                text: "Esa no es la respuesta, pero haz completado el capitulo 3 de las aventuras de Koubot, consigue la siguiente capsula premium para seguir con la aventura",
                imageUrl: "../img/loop.gif",
                imageHeight: 350,
                confirmButtonText: "¡Vamos!",
                confirmButtonColor: "#85c42c",
