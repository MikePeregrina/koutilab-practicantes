...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Podemos crear un evento cuando asignamos un _____ a un botón en HTML
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Podemos crear un evento cuando asignamos un _____ a un botón en HTML',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp5-3.png");
        ...
        function alertWin() {
            Swal.fire({
                title: "¡Perfecto!",
                text:
                    "Has completado el capitulo 3 de las aventuras de Koubot con 6 puntos y " +
                    score +
                    " estrellas de 5",
