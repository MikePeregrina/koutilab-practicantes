...
<body>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i class="fa-brands fa-square-js" style="color: gray"></i>',
				'<i class="fa-solid fa-chess-knight" style="black"></i>',
				'<i class="fab fa-php" style="color: gray"></i>',
				'<i class="fas fa-keyboard" style="black"></i>',
				'<i class="fab fa-html5" style="color: gray"></i>',
				'<i class="fab fa-css3-alt" style="black"></i>',
				'<i class="fa-solid fa-gamepad" style="color: gray"></i>',
				'<i class="fa-solid fa-computer-mouse" style="black"></i>',
				'<i class="fa-solid fa-computer" style="color: gray"></i>',
				'<i class="fa-solid fa-gears" style="black"></i>',
				'<i class="fas fa-code" style="color: gray"></i>',
				'<i class="far fa-file-code" style="black"></i>'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 50 + "&id_curso=" + 2; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 50 + "&id_curso=" + 2; //cancatenation
				Swal.fire({
					title: 'Oops...',
