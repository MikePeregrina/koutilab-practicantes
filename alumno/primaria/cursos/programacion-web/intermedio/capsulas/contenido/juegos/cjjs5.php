		...
		var preguntas = [
			{
				num: 1,
				pregunta:
					"¿Qué función de Javascript que permite al usuario ingresar información?",
				opA: "prompt()",
				opB: "alert()",
				opC: "setTimeOut()",
				correcta: "A",
			...
			},
			{
				num: 2,
				pregunta:
					"¿Qué función de Javascript que permite al usuario crear una alerta?",
				opA: "prompt()",
				opB: "alert()",
				opC: "setTimeOut()",
				correcta: "B",
			...
			},
			{
				num: 3,
				pregunta:
					"¿Podemos usar prompt() dentro de una variable?",
				opA: "¡Si! es posible",
				opB: "¡Imposible!",
				opC: "No funcionaría",
				correcta: "A",
			...
			},
			{
				num: 4,
				pregunta:
					"let nombre = _______('Por favor, ingrese su nombre: ');",
				opA: "prompt",
				opB: "alert",
				opC: "element",
				correcta: "A",
			...
			},
			{
				num: 5,
				pregunta:
					"¿Como se llama la mascota de Koutilab?",
				opA: "Robot",
				opB: "Koubot",
				opC: "Pequeño",
				correcta: "B",
