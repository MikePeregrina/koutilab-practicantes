...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h6 class="titulo">
            Se trata del metodo que nos ayuda a generar la alerta con una ventana emergente, ¿De cuál estamos hablando?        
        </h6>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Se trata del metodo que nos ayuda a generar la alerta con una ventana emergente, ¿De cuál estamos hablando?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp4-6.png");
            this.load.image("respuesta1", "../assets/resp3-6.png");
        ...
        function alertWin() {
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 6 de las aventuras de Koubot con 8 puntos y ' + score + ' estrellas de 5',
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'lvl6-3.php';
                }
            });
        }
