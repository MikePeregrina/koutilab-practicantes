...
<body onload="alert1()">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Se trata de la función que genera una pequeña ventana emergente de confirmación que devuelve true o false',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp5-6.png");
            this.load.image("respuesta1", "../assets/resp4-6.png");
