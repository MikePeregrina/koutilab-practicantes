...
<body onload="alert1()">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: '¿Qué etiqueta ocupamos para unificar dos o más celdas de forma vertical?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function alertWin() {
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 2 de las aventuras de Koubot con 8 puntos y ' + score + ' estrellas de 5',
