        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T5.5/202.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T5.5/203.gif');"></li>
                        <li style="background-image: url('../../img/js/T5.5/204.gif');"></li>
                        <li style="background-image: url('../../img/js/T5.5/205.gif');"></li>
                        <li style="background-image: url('../../img/js/T5.5/206.gif');"></li>
                        <li style="background-image: url('../../img/js/T5.5/207.gif');"></li>
                        <li>
                            <div>
