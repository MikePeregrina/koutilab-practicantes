        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T5/188.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T5/189.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/190.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/191.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/192.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/193.gif');"></li>
                        <li>
                            <div>
