        ...
        function miFunc() {
            ...
            if (htmlcode.length > 30 && csscode.indexOf('blue') !== -1 && csscode.indexOf('#') != -1 && csscode.indexOf('rgb') != -1 && csscode.indexOf('hsl') != -1 && csscode.indexOf('opacity') != -1 && opacidad >= 2 && background >= 5) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'correcto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'incorrecto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode='+ document.getElementById("html-code").value + '&csscode='+ document.getElementById("css-code").value + '&jscode='+ document.getElementById("js-code").value;
