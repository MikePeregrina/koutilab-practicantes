        ...
        function miFunc() {
            ...
            if ((jscode.indexOf('*3') !== -1 || jscode.indexOf('* 3') !== -1) && (jscode.indexOf('+6') !== -1 || jscode.indexOf('+ 6') !== -1) && (jscode.indexOf('/3') !== -1 || jscode.indexOf('/ 3') !== -1) && (jscode.indexOf('-2') !== -1 || jscode.indexOf('- 2') !== -1)) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd55.php?validar=' + 'incorrecto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + document.getElementById("html-code").value + '&csscode=' + document.getElementById("css-code").value + '&jscode=' + document.getElementById("js-code").value;
