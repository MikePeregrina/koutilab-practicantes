...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>BOTONES</b></h2>
    </div>
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Es lo que creamos con la etiqueta <button>. Pista: No olvides los acentos",
                respuesta: "botón",
                respondida: false
            },
            {
                pregunta: "Se trata del atributo que nos ayuda a darle un nombre a nuestro botón. Pista: N___E",
                respuesta: "name",
                respondida: false
            },
            {
                pregunta: "Se trata del atributo que nos ayuda a indicar el tipo de botón. Pista: T_P_",
                respuesta: "type",
                respondida: false
            },
            {
                pregunta: "Se trata del atributo que nos ayuda a darle un valor a nuestro botón. Pista: V_L__",
                respuesta: "value",
                respondida: false
            },
            {
                pregunta: "Se trata del atributo que nos ayuda a desactivar un botón si nosotros lo deseamos. Pista: D__AB___",
                respuesta: "disabled",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 25 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml8.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 25 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml8.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
