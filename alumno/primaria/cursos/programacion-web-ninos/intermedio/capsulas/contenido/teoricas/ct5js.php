        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T5/119.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T5/120.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/121.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/122.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/js/T5/123.gif');"></li>
                        <li>
                            <div>
