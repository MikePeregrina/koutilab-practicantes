...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Es la propiedad que determina la cantidad de espacios disponibles dentro de un contenedor flexible        
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es la propiedad que determina la cantidad de espacios disponibles dentro de un contenedor flexible',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta1", "../assets/resp4-4.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 4 de las aventuras de Koubot con 6 puntos y ' + score + ' estrellas de 5',
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../acciones/insertar_ep1.php?id_capsula=' + 4 + '&id_curso=' + 14 + '&estrellas=' + estrellas;
                        }
                    });
                }
            }); 
        ...
        function alertQuestion() {
            ...
            Swal.fire({
                title: '¡Buen intento!',
                text: 'Esa no es la respuesta, pero haz completado el capitulo 4 de las aventuras de Koubot con ' + score + ' estrellas de 5, consigue las siguientes capsulas premium para seguir con la aventura',
                imageUrl: "../img/loop.gif",
                imageHeight: 350,
                confirmButtonText: '¡Vamos!',
                confirmButtonColor: '#85c42c',
