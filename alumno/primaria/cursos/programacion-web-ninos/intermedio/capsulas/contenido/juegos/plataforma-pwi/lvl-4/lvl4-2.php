...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Es la propiedad que define el orden en el que aparecen los elementos        
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es la propiedad que define el orden en el que aparecen los elementos',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp3-4.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 4 de las aventuras de Koubot con 8 puntos y ' + score + ' estrellas de 5',
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'lvl4-3.php';
                }
            });
        }
