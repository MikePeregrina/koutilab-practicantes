...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("MAYOR");
        palabras_array.push("MENOR");
        palabras_array.push("IGUAL");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "MAYOR": // Se debera hacer un case por cada palabra
                    pista = "Es lo que representa el siguiente simbolo: >";
                    break; // Es importante el break en cada case
                case "MENOR": // Se debera hacer un case por cada palabra
                    pista = "Es lo que representa el siguiente simbolo: <";
                    break; // Es importante el break en cada case
                case "IGUAL": // Se debera hacer un case por cada palabra
                    pista = "Es lo que representa el siguiente simbolo: ===";
                    break; // Es importante el break en cada case
