...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>LISTAS DE DEFINICIONES</b></h2>
    </div>
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Se emplea para definir las listas de definición. Pista: D y la letra que sigue después de la K en el abecedario",
                respuesta: "dl",
                respondida: false
            },
            {
                pregunta: "Se emplea para definir los terminos de los elementos de una lista de definición. Pista: D y la letra que sigue después s en el abecedario",
                respuesta: "dt",
                respondida: false
            },
            {
                pregunta: "Se emplea para indicar las definiciones de los elementos de una lista de definición. Pista: Es la misma letra dos veces",
                respuesta: "dd",
                respondida: false
            },
            {
                pregunta: "Se trata del tema que estamos viendo actualmente, lista de...",
                respuesta: "definiciones",
                respondida: false
            },
            {
                pregunta: "Es el lenguaje de etiquetas que actualmente estamos viendo.",
                respuesta: "html",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 7 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml2.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 7 +"&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml2.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
