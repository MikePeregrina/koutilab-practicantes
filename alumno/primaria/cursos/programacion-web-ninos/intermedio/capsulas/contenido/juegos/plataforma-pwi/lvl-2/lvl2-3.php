...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            ¿Qué etiquetas ocupamos para poder crear una tabla en HTML?
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: '¿Qué etiquetas ocupamos para poder crear una tabla en HTML?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp4-2.png");
            this.load.image("respuesta1", "../assets/resp3-2.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 2 de las aventuras de Koubot con 6 puntos y ' + score + ' estrellas de 5',
        ...
        function alertQuestion() {
            ...
            Swal.fire({
                title: '¡Buen intento!',
                text: 'Esa no es la respuesta, pero haz completado el capitulo 2 de las aventuras de Koubot con ' + score + ' estrellas de 5, consigue las siguientes capsulas premium para seguir con la aventura',
                imageUrl: "../img/loop.gif",
                imageHeight: 350,
                confirmButtonText: '¡Vamos!',
                confirmButtonColor: '#85c42c',
