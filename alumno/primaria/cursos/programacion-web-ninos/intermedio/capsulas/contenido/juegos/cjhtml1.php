...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 4 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml1.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("COMENTARIOS");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "COMENTARIOS": // Se debera hacer un case por cada palabra
                    pista = "Se trata de lo que podemos hacer al utilizar la siguiente estructura: <!-- Hola mundo -->";
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 4 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml1.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
