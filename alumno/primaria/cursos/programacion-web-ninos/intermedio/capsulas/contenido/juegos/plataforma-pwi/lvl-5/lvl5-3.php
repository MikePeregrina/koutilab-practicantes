...
<body onload="alert1()">
    ...
    <div class="titulo-gen3" style="top: 30%">
        <h5 class="titulo">
            Es el tipo de loop que se ejecuta cuando NO sabemos cuantas veces queremos que se repita un bloque de código
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es el tipo de loop que se ejecuta cuando NO sabemos cuantas veces queremos que se repita un bloque de código',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp4-5.png");
            this.load.image("respuesta1", "../assets/resp3-5.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 5 de las aventuras de Koubot con 6 puntos y ' + score + ' estrellas de 5',
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../acciones/insertar_ep1.php?id_capsula=' + 5 + '&id_curso=' + 14 + '&estrellas=' + estrellas;
                        }
                    });
                }
            });
        ...
        function alertQuestion() {
            ...
            Swal.fire({
                title: '¡Buen intento!',
                text: 'Esa no es la respuesta, pero haz completado el capitulo 5 de las aventuras de Koubot con ' + score + ' estrellas de 5, consigue las siguientes capsulas premium para seguir con la aventura',
                imageUrl: "../img/loop.gif",
                imageHeight: 350,
                confirmButtonText: '¡Vamos!',
                confirmButtonColor: '#85c42c',
