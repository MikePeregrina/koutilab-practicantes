...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>TABLAS CON ENCABEZADOS</b></h2>
    </div>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml4.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("TH");
        palabras_array.push("SCOPE");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "TH": // Se debera hacer un case por cada palabra
                    pista = "Es la etiqueta de HTML que se ocupa para representar una celda de un encabezado";
                    break; // Es importante el break en cada case
                case "SCOPE": // Se debera hacer un case por cada palabra
                    pista = "Es el atributo que provee un mecanismo para indicar explícitamente a qué celdas afecta una celda de encabezado";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjhtml4.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
