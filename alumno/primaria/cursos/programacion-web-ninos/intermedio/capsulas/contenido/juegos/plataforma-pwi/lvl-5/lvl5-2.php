...
<body onload="alert1()">
    ...
    <div class="titulo-gen3" style="top: 30%">
        <h5 class="titulo">
            Es el tipo de loop que se ejecuta cuando sabemos cuantas veces queremos que se repita un bloque de código
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es el tipo de loop que se ejecuta cuando sabemos cuantas veces queremos que se repita un bloque de código',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 5 de las aventuras de Koubot con 8 puntos y ' + score + ' estrellas de 5',
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'lvl5-3.php';
                }
            });
        }
