        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T4/130.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T4/131.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/132.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/133.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/php/T4/134.gif');"></li>
                        <li>
                            <div>
