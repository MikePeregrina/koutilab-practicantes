        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T4.5/94.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T4.5/95.gif');"></li>
                        <li style="background-image: url('../../img/js/T4.5/96.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/js/T4.5/97.gif');"></li>
                        <li>
                            <div>
