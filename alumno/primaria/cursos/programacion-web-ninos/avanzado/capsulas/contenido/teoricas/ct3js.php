        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T3/83.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T3/84.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/85.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Mensaje de alerta que lanza ventana emergente</div>
                                        <div class="word-box" id="sql">Solicita información al usuario</div>
                                        <div class="word-box" id="html">Muestra mensaje de confirmación</div>
                                        <div class="word-box" id="javascript">Podemos guardar información en ella</div>
                                        <div class="word-box" id="php">Condición para mejorar el sistema</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">alert()
                                        </div>
                        ...
                        <li style="background-image: url('../../img/js/T3/86.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct3js.php">
                                </form>
                            </div>
                        </li>
                    </ul>
