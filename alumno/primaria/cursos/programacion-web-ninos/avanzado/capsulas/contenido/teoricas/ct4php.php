        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T3/125.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T3/126.gif');"></li>
                        <li style="background-image: url('../../img/php/T3/127.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/php/T3/128.gif');"></li>
                        <li>
                            <div>
