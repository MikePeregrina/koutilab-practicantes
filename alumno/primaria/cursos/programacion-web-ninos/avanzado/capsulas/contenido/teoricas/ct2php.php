...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 PHP</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T1.5/113.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T1.5/114.gif');"></li>
                        <li style="background-image: url('../../img/php/T1.5/115.gif');"></li>
                        <li style="background-image: url('../../img/php/T1.5/116.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Se crean para llamarse muchas veces sin tener que escribir mucho código</div>
                                        <div class="word-box" id="sql">Son los objetos que van en los parentesis junto a una función</div>
                                        <div class="word-box" id="html">Es el valor que retornamos al final de una función</div>
                                        <div class="word-box" id="javascript">Es el lenguaje de programación que estamos aprendiento</div>
                                        <div class="word-box" id="php">Son las que nos ayudan a crear una función y todo su código está encerrado en ellas</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">Funciones
                                        </div>
                        ...
                        <li style="background-image: url('../../img/php/T1.5/117.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_ct2php.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Función 'myFunc'</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Función 'square'</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Función 'array'</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Función 'map'</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="53">
