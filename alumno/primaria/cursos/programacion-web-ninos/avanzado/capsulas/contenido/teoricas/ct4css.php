...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalerT3@11"></script>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T3/55.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T3/56.gif');"></li>
                        <li style="background-image: url('../../img/css/T3/57.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Posiciona el título</div>
                                        <div class="word-box" id="sql">Etiqueta que genera una tabla</div>
                                        <div class="word-box" id="html">Etiqueta que genera el título de la tabla</div>
                                        <div class="word-box" id="javascript">Etiqueta que genera el cuerpo de la tabla</div>
                                        <div class="word-box" id="php">Da formato a la tabla</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">caption-side
                                        </div>
                        ...
                        <li style="background-image: url('../../img/css/T3/58.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>Dentro de las tablas el 'table-layout' ¿Para que sirve?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Para dar formato a las celdas, filas y columnas</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Se usa para dar visibilidad a los bordes de celdas sin contenido</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Sirve para indicar el espaciado entre los bordes de celdas adyacentes.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Se utiliza para seleccionar el modelo de los bordes.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="22">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="15">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct4css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
