            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        ...
                        <li style="background-image: url('../../img/php/T2/120.gif');"></li>
                        <li style="background-image: url('../../img/php/T2/121.gif');"></li>
                        <li style="background-image: url('../../img/php/T2/122.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/php/T2/123.gif');"></li>
                        <li>
                            <div>
