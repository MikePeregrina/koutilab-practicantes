        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T1/107.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T1/108.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/109.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/110.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/php/T1/111.gif');"></li>
                        <li>
                            <div>
