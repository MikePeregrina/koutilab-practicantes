        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T1/73.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T1/74.gif');"></li>
                        <li style="background-image: url('../../img/js/T1/75.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/js/T1/76.gif');"></li>
                        <li>
                            <div>
