...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T2/50.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T2/51.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/52.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/css/T2/53.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        var words = ['PSEUDOELEMENTO', 'CSS', 'BEFORE', 'AFTER'];
