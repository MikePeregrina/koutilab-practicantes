...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 24 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjcss3.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("CAPTION-SIDE");
        palabras_array.push("TABLE-LAYOUT");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "CAPTION-SIDE": // Se debera hacer un case por cada palabra
                    pista = "Es la propiedad de CSS que nos sirve para posicionar el título sobre la tabla CSS";
                    break; // Es importante el break en cada case
                case "TABLE-LAYOUT": // Se debera hacer un case por cada palabra
                    pista = "Es la propiedad de CSS funciona para dar formato a las celdas, filas y columnas";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 24 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjcss3.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
