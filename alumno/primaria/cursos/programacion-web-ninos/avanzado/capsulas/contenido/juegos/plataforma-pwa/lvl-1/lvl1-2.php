...
<html lang="es">
    ...
    <body onload="alert1()">
        ...
        <div class="titulo-gen3">
            <h5>
                Es la propiedad que nos permite darle un ancho a nuestra etiqueta svg
            </h5>
        </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es la propiedad que nos permite darle un ancho a nuestra etiqueta svg',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
        ...
        <script>
            ...
            function preload() {
                ...
                this.load.image("respuesta", "../assets/resp4-1.png");
                this.load.image("respuesta1", "../assets/resp3-1.png");
            ...
            function alertWin() {
                ...
                Swal.fire({
                    title: "¡Perfecto!",
                    text:
                        "Has completado el capitulo 1 de las aventuras de Koubot con 8 puntos y " +
                        score +
                        " estrellas de 5",
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '../acciones/insertar_ep1.php?id_capsula=' + 1 + '&id_curso=' + 15 + '&estrellas=' + estrellas;
                            }
                        });
                    }
                });
            ...
            function alertQuestion() {
                Swal.fire({
                    title: "¡Oh no!",
                    text: "Esa no es la respuesta, pero por 6 puntos vamos a intentarlo nuevamente con otra pregunta",
                    imageUrl: "../img/loop.gif",
                    imageHeight: 350,
                    confirmButtonText: "¡Vamos!",
                    confirmButtonColor: "#85c42c",
