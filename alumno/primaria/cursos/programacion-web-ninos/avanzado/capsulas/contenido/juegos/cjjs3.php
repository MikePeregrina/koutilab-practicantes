...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Es la etiqueta que nos ayuda a abrir un formulario. Pista: F___",
                respuesta: "form",
                respondida: false
            },
            {
                pregunta: "Es la etiqueta que nos ayuda a poner una entrada de información en un formulario. Pista: I___T",
                respuesta: "input",
                respondida: false
            },
            {
                pregunta: "Es la etiqueta que nos indica que vamos a poner un área de texto. Pista: T__TA___",
                respuesta: "textarea",
                respondida: false
            },
            {
                pregunta: "Es el atributo que nos ayuda a indicar el tipo de input que queremos poner. Pista: T___",
                respuesta: "type",
                respondida: false
            },
            {
                pregunta: "Es el lenguaje de programación que estamos aprendiendo actualmente. Pista: J_V_S___P_",
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 38 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjjs3.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 38 +"&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjjs3.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
