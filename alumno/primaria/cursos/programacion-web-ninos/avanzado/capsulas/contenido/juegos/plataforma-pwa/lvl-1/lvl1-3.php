...
<html lang="es">
    ...
    <body onload="alert1()">
        ...
        <div class="titulo-gen3">
            <h5>
                Es la propiedad que nos permite darle un alto a nuestra etiqueta svg
            </h5>
        </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Es la propiedad que nos permite darle un alto a nuestra etiqueta svg',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
        ...
        <script>
            ...
            function alertWin() {
                ...
                Swal.fire({
                    title: "¡Perfecto!",
                    text:
                        "Has completado el capitulo 1 de las aventuras de Koubot con 6 puntos y " +
                        score +
                        " estrellas de 5",
