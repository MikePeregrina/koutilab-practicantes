...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
            ...
            {
                pregunta: "Es el lenguaje de estilos que estamos aprendiendo actualmente. Pista: C__",
                respuesta: "css",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 27 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjcss4.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 27 +"&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjcss4.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
