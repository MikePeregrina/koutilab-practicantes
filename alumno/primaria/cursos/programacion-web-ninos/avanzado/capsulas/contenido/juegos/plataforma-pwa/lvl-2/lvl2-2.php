...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            ¿Cuál es el tipo de posicionamiento que hace que nuestros elementos aparezcan normal o estático?
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: '¿Cuál es el tipo de posicionamiento que hace que nuestros elementos aparezcan normal o estático?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: "¡Perfecto!",
                text: "Has completado el capitulo 2 de las aventuras de Koubot con 8 puntos y " +
                    score +
                    " estrellas de 5",
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "lvl2-3.php";
                }
            });
        }
