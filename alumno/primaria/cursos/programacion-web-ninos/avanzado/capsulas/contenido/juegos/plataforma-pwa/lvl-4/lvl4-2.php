...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            En PHP, es la forma en la que nosotros como programadores declaramos una función
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'En PHP, es la forma en la que nosotros como programadores declaramos una función',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp4-4.png");
            this.load.image("respuesta1", "../assets/resp3-4.png");
