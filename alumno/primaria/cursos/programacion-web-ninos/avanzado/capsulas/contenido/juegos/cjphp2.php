...
<body>
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 49 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjphp2.php'; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 49 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjphp2.php'; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
