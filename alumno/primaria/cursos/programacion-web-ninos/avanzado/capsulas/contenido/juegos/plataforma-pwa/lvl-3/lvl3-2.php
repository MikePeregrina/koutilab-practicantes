...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            ¿Qué tipo de evento podemos activar cuando damos click en un elemento de HTML?
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: '¿Qué tipo de evento podemos activar cuando damos click en un elemento de HTML?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp3-3.png");
            this.load.image("respuesta1", "../assets/resp4-3.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: "¡Perfecto!",
                text:
                    "Has completado el capitulo 3 de las aventuras de Koubot con 8 puntos y " +
                    score +
                    " estrellas de 5",
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../acciones/insertar_ep1.php?id_capsula=' + 3 + '&id_curso=' + 15 + '&estrellas=' + estrellas;
                        }
                    });
                }
            });
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "lvl3-3.php";
                }
            });
        }
