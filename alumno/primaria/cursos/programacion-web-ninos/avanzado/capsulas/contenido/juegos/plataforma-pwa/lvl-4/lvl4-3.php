...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            En PHP, ¿Cómo se le llama al valor que retorna un programa?
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'En PHP, ¿Cómo se le llama al valor que retorna un programa?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp5-4.png");
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: "¡Perfecto!",
                text:
                    "Has completado el capitulo 4 de las aventuras de Koubot con 6 puntos y " +
                    score +
                    " estrellas de 5",
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../acciones/insertar_ep1.php?id_capsula=' + 4 + '&id_curso=' + 15 + '&estrellas=' + estrellas;
                        }
                    });
                }
            });
