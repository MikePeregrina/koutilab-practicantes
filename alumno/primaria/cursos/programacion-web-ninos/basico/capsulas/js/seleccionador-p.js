...
function checkAnswer(respuesta) {
    ...
    if (palabraseleccionada) {
        ...
        if (respuesta === 'incompatibilidad' && idPalabraSeleccionada === 'embed') {
            ...
            contexto.lineWidth = 3;
            contexto.strokeStyle = "#84c42c";
            contexto.moveTo(0, 135);
            contexto.lineTo(575, 195);
            contexto.stroke();
            respuestasCorrectas++;
        } else if (
            ...
            contexto.lineWidth = 3;
            contexto.strokeStyle = "#84c42c";
            contexto.moveTo(0, 245);
            contexto.lineTo(560, 73);
            contexto.stroke();
            respuestasCorrectas++;
        } else {
...
function mostrarResultados() {
    ...
    if (todasSeleccionadas) {
        if (respuestasCorrectas < 3) {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 22 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml7.php'; //cancatenation
		    xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
		    xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		    xmlhttp.send(param);
