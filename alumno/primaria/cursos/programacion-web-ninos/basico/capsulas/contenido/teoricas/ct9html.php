...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T3.5/21.gif');"></li>
                        <li style="background-image: url('../../img/html/T3.5/22.gif');"></li>
                        <li style="background-image: url('../../img/html/T3.5/23.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/html/T3.5/24.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        var words = ['HTML', 'HEAD', 'SECTION', 'BODY'];
