...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml4.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("<IMG>");
        palabras_array.push("SRC");
        palabras_array.push("INTERNET");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "<IMG>": // Se debera hacer un case por cada palabra
                    pista = "Se trata de la etiqueta que nos ayuda a poner una imagen en nuestro documento de HTML.";
                    break; // Es importante el break en cada case
                case "SRC":
                    pista =
                        "Se trata del atributo que nos ayuda a indicar la dirección de nuestras imágenes.";
                    break;
                case "INTERNET":
                    pista =
                        "Podemos obtener la dirección de una imagen de forma local o también podemos obtenerla mediante...​";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml4.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
