    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 45 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjcss6.php'; //cancatenation
    ...
    <script>
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "PUNTO": // Se debera hacer un case por cada palabra
                    pista = "Para identificar que un selector es de tipo clase, podemos identificarlo mediante un... Pista: P__T_";
                    break; // Es importante el break en cada case
                case "CLASE":
                    pista =
                        "Es el tipo de selector que estamos aprendiendo actualmente.";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 45 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjcss6.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
