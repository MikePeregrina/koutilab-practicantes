...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("PROPIEDAD");
        palabras_array.push("VALOR");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "PROPIEDAD": // Se debera hacer un case por cada palabra
                    pista = "Se trata de un identificador, que es un nombre leíble por los humanos hablando de CSS.";
                    break; // Es importante el break en cada case
                case "VALOR":
                    pista =
                        "Es lo que describe sobre como deben ser las características que son manejadas por el motor de CSS.";
                    break;
