...
const adivinanzas = [
  { pregunta: "Es un sistema operativo móvil desarrollado por Google y diseñado principalmente para dispositivos móviles.", respuesta: "Android", respondida: false },
  { pregunta: "En que mes fue lanzado Android.", respuesta: "Septiembre", respondida: false },
  { pregunta: "Es el tipo de dispositivo que ocupan Android.", respuesta: "Movil", respondida: false },
  { pregunta: "Esto significa que el código fuente del sistema operativo está disponible públicamente y se puede modificar y distribuir de forma gratuita.", respuesta: "Abierto", respondida: false },
  { pregunta: " Es el nombre que Android ofrece a un sistema que te informa sobre mensajes.", respuesta: "Notificacion", respondida: false }
];
