...
const adivinanzas = [
  { pregunta: "Es una familia de sistemas operativos desarrollada por Microsoft Corporation.", respuesta: "Windows", respondida: false },
  { pregunta: "Windows es conocido por su interfaz gráfica de usuario que utiliza ventanas, iconos y menú:", respuesta: "Gui", respondida: false },
  { pregunta: "Windows es compatible con una amplia variedad de software y aplicaciones(si,no).", respuesta: "si", respondida: false },
  { pregunta: "Windows es el sistema operativo menos utilizado en el mundo(si,no).", respuesta: "no", respondida: false },
  { pregunta: "Microsoft lanza periódicamente actualizaciones y nuevas versiones de Windows para mejorar la seguridad(si,no)", respuesta: "si", respondida: false }
];
