        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/informatica/1/T6/43.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/informatica/1/T6/44.gif');"></li>
                        <li style="background-image: url('../../img/informatica/1/T6/45.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/informatica/1/T6/46.gif');"></li>
                        <li>
                            <div>
