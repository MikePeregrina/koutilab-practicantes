...
function checkAnswer(respuesta) {
  ...
  if (palabraseleccionada) {
    ...
    if (respuesta === "audio" && idPalabraSeleccionada === "sonido") {
      ...
      contexto.lineTo(550, 148);
      contexto.stroke();
      respuestasCorrectas++;
    } else if (
      respuesta === "audifonos" &&
      idPalabraSeleccionada === "salida"
    ) {
      palabraseleccionada.classList.add("correcto");
      contexto.beginPath();
      contexto.lineWidth = 3;
      ...
      contexto.stroke();
      respuestasCorrectas++;
    } else if (respuesta === "mixto" && idPalabraSeleccionada === "laptop") {
      palabraseleccionada.classList.add("correcto");
      contexto.beginPath();
      contexto.lineWidth = 3;
      contexto.strokeStyle = "#84c42c";
      contexto.moveTo(0, 250);
      contexto.lineTo(550, 75);
      contexto.stroke();
      respuestasCorrectas++;
    } else if (respuesta === "usb" && idPalabraSeleccionada === "dispositivo") {
      palabraseleccionada.classList.add("correcto");
      contexto.beginPath();
      contexto.lineWidth = 3;
      contexto.strokeStyle = "#84c42c";
      contexto.moveTo(0, 200);
      contexto.lineTo(650, 280);
      contexto.stroke();
      respuestasCorrectas++;
    } else {
  ...
  if (todasSeleccionadas) {
    if (respuestasCorrectas < 3) {
      ...
      var param =
        ...
        7 +
        "&redireccion=" +
        "../contenido/juegos/cjib1-7.php"; //cancatenation
