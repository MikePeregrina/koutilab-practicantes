...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
            <h2 class="titulo"><b>PRIMEROS PASOS CON EL CORREO ELECTRONICO</b></h2>
    </div>
...
const adivinanzas = [
  { pregunta: "El correo electrónico es un servicio en línea que nos permite enviar y recibir mensajes(si,no).", respuesta: "Si", respondida: false },
  { pregunta: "El contenido de los mensajes de correo  puede variar desde texto, archivos, documentos o.", respuesta: "Multimedia", respondida: false },
  { pregunta: "Se le conoce especialmente por ser uno de los proveedores de correo electrónico, pero también un motor de búsqueda.", respuesta: "Yahoo", respondida: false },
  { pregunta: "Esta conformado por el nombre del servidor, el tipo y region.", respuesta: "Dominio", respondida: false },
  { pregunta: "Para usar el correo, solo necesitas un computador que no tenga conexión a Internet y abrir o crear una cuenta de correo electrónico(si,no).", respuesta: "No", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii1-6.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii1-6.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
