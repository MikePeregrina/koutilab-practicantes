...
<body onload="iniciarTiempo(), iniciar() ">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      //arreglo que almacena las pistas y respuestas de la adivinanza
      const adivinanzas = [{
          pregunta: "El correo electrónico es un servicio en línea que nos permite enviar y recibir mensajes(si,no).",
          respuesta: "Si",
          respondida: false
        },
        {
          pregunta: "El contenido de los mensajes de correo  puede variar desde texto, archivos, documentos o.",
        ...
        {
          pregunta: "Esta conformado por el nombre del servidor, el tipo y region.",
          respuesta: "Dominio",
          respondida: false
        },
        {
          pregunta: "Para usar el correo, solo necesitas un computador que no tenga conexión a Internet y abrir o crear una cuenta de correo electrónico(si,no).",
          respuesta: "No",
          respondida: false
        }
      ];
