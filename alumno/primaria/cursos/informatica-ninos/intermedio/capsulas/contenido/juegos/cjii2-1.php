...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
            <h2 class="titulo"><b>CONFIGURACIÓN DE PAGINA</b></h2>
    </div>
...
const adivinanzas = [
  { pregunta: "Es un software informático procesador de texto.", respuesta: "Word", respondida: false },
  { pregunta: "Word es un programa que pertenece al Paquete Office y se puede instalar en computadoras(si,no).", respuesta: "Si", respondida: false },
  { pregunta: "Es la barra por defecto que siempre vamos a ver, la puedes personalizar.", respuesta: "Inicio", respondida: false },
  { pregunta: "Estas son las herraminetas de word de este submenu, y comandos que enriquecen tu contenido.", respuesta: "Insertar", respondida: false },
  { pregunta: "Este menu de las funciones de word es uno de los más desconocidos en la barra de herramientas de Word.", respuesta: "Referencias", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 30 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii2-1.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 30 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii2-1.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
