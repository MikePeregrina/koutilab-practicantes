...
const adivinanzas = [
  { pregunta: "Googles es un motor de busqueda(si,no).", respuesta: "Si", respondida: false },
  { pregunta: "Es un motor de búsqueda que lanzó Microsoft en el 2009 para quitarle el trono a Google.", respuesta: "Bing", respondida: false },
  ...
  { pregunta: "Donde esta almacenada la informacion que recopilan los motores de búsqueda son sistemas informáticos .", respuesta: "Servidores", respondida: false },
  { pregunta: "Cuando el usuario introduce una palabra clave en el buscador es capaz de encontrar aquellas páginas que contienen esa keyword(si,no).", respuesta: "Si", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii1-4.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 20 + "&redireccion=" + '../contenido/juegos/cjii1-4.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
