...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/informatica/2/T5/93.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/informatica/2/T5/94.gif');"></li>
                        <li style="background-image: url('../../img/informatica/2/T5/95.gif');"></li>
                        <li style="background-image: url('../../img/informatica/2/T5/96.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/informatica/2/T5/97.gif');"></li>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/f (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/f (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/f (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/f (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/f (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/f (6).png" height="60px" width="50px" >'
            ]
        }
