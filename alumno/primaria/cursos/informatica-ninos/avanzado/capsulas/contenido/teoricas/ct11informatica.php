...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/informatica/2/T1/70.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/informatica/2/T1/71.gif');"></li>
                        <li style="background-image: url('../../img/informatica/2/T1/72.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/informatica/2/T1/73.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct11informatica.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/e1.png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/e2.png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/e3.png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/e4.png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/e5.png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/e6.png" height="60px" width="50px" >'
            ]
        }
