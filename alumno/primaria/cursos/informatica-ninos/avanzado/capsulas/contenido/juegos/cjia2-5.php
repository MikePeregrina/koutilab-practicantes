...
<body onload="iniciarTiempo()">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      //arreglo que almacena las pistas y respuestas de la adivinanza
      const adivinanzas = [{
          pregunta: "Comienzan con el signo igual(=) en la celda.",
          respuesta: "Formulas",
          respondida: false
        },
        {
          pregunta: "Cambia al copiar la formula a celdas adyacentes.",
          respuesta: "Referencia",
          respondida: false
        },
        {
          pregunta: "Cuenta el número de celdas que contienen valores numéricos en un rango.",
          respuesta: "Contar",
          respondida: false
        },
        {
          pregunta: "Busca un valor en la primera columna de una tabla y devuelve el valor correspondiente de una columna específica en la misma fila.",
          respuesta: "Buscarv",
          respondida: false
        },
        {
          pregunta: "Que fórmula se ocupa en el ejemplo, =PROMEDIO(A1:A5).",
          respuesta: "Promedio",
          respondida: false
        }
      ];
