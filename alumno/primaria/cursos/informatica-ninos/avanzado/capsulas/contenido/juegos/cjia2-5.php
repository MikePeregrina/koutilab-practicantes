...
const adivinanzas = [
  { pregunta: "Comienzan con el signo igual(=) en la celda.", respuesta: "Formulas", respondida: false },
  { pregunta: "Cambia al copiar la formula a celdas adyacentes.", respuesta: "Referencia", respondida: false },
  { pregunta: "Cuenta el número de celdas que contienen valores numéricos en un rango.", respuesta: "Contar", respondida: false },
  { pregunta: "Busca un valor en la primera columna de una tabla y devuelve el valor correspondiente de una columna específica en la misma fila.", respuesta: "Buscarv", respondida: false },
  { pregunta: "Que fórmula se ocupa en el ejemplo, =PROMEDIO(A1:A5).", respuesta: "Promedio", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 42 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia2-5.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 42 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia2-5.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
