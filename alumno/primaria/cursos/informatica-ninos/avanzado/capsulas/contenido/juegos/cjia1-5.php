...
<body onload="iniciarTiempo(), iniciar() ">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      //arreglo que almacena las pistas y respuestas de la adivinanza
      const adivinanzas = [{
          pregunta: "Define los puntos clave que deseas abordar en cada diapositiva y se organízan en un orden lógico.",
          respuesta: "Planificacion",
          respondida: false
        },
        {
          pregunta: "Antes de comenzar a crear tus diapositivas, planifica el contenido de tu presentación.",
          respuesta: "Estructura",
          respondida: false
        },
        {
          pregunta: "Se utiliza de manera selectiva para resaltar puntos clave o para revelar información gradualmente.",
          respuesta: "Animaciones",
          respondida: false
        },
        {
          pregunta: "Se utiliza de manera  suave y coherente entre diapositivas para mantener la atención del público.",
          respuesta: "Transiciones",
          respondida: false
        },
        {
          pregunta: "Lo que haces antes de presentar, revisar y editar tus diapositivas para corregir errores gramaticales.",
          respuesta: "Revision",
          respondida: false
        }
      ];
