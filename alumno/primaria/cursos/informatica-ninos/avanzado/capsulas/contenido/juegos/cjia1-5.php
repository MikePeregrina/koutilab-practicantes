...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="contenido">
        ...
        <section>
            <div class="cont-st">
                <a href="../../../../../../rutas/ruta-in-a-ninos.php">
                    <button class="btn-b">
...
const adivinanzas = [
  { pregunta: "Define los puntos clave que deseas abordar en cada diapositiva y se organízan en un orden lógico.", respuesta: "Planificacion", respondida: false },
  { pregunta: "Antes de comenzar a crear tus diapositivas, planifica el contenido de tu presentación.", respuesta: "Estructura", respondida: false },
  { pregunta: "Se utiliza de manera selectiva para resaltar puntos clave o para revelar información gradualmente.", respuesta: "Animaciones", respondida: false },
  { pregunta: "Se utiliza de manera  suave y coherente entre diapositivas para mantener la atención del público.", respuesta: "Transiciones", respondida: false },
  { pregunta: "Lo que haces antes de presentar, revisar y editar tus diapositivas para corregir errores gramaticales.", respuesta: "Revision", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 16 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia1-5.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 16 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia1-5.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
