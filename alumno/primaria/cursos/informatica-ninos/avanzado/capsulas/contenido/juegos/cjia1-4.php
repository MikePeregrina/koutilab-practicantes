...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>TEMAS Y FORMATO DE FONDO</b></h2>
    </div>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia1-4.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("TEMAS");
        palabras_array.push("DISEÑO");
        palabras_array.push("FORMATO");
        palabras_array.push("IMAGENES");
        palabras_array.push("POWERPOINT");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "TEMAS": // Se debera hacer un case por cada palabra
                    pista = "Son conjuntos predefinidos de diseños, colores, fuentes y efectos de estilo que se aplican a todas las diapositivas. ";
                    break; // Es importante el break en cada case
                case "DISEÑO":
                    pista =
                        "Es la pestaña en la parte superior de la ventana de PowerPoint muestra  los diferentes estilos de tema disponibles  .";
                    break;
                case "FORMATO":
                    pista =
                        "Se refiere al diseño visual que se aplica a la parte posterior de las diapositivas, proporcionando un aspecto coherente.​";
                    break;
                case "IMAGENES":
                    pista = "Puedes elegir entre diferentes opciones de formato de fondo, como colores sólidos, degradados, texturas o";
                    break;
                case "POWERPOINT":
                    pista =
                        "En que programa de la paqueteria de Office estamos trabajando.";
                    break;
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia1-4.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
