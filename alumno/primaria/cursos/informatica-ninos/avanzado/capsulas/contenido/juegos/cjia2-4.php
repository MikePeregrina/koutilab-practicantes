...
const adivinanzas = [
  { pregunta: "Son símbolos o caracteres especiales que se utilizan para realizar cálculos.", respuesta: "Operadores", respondida: false },
  { pregunta: "Que operador de comparacion se ocupa en el ejemplo, =A1 <> B1.", respuesta: "Diferente", respondida: false },
  { pregunta: "Que operador de comparacion se ocupa en el ejemplo, =A1 = B1 .", respuesta: "Igual", respondida: false },
  { pregunta: "Que operador aritmetico se ocupa en el ejemplo, =A1 + B1 .", respuesta: "Suma", respondida: false },
  { pregunta: "Que operador aritmetico se ocupa en el ejemplo, =A1 - B1.", respuesta: "Resta", respondida: false }
];
...
function iniciarTiempo() {
  ...
  if (segundos == 0) {
    ...
    var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 39 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia2-4.php)'; //cancatenation
...
function alertExcelent() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 39 + "&id_curso=" + 21 + "&redireccion=" + '../contenido/juegos/cjia2-4.php)'; //cancatenation
  xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
  xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  xmlhttp.send(param);
  Swal.fire({
