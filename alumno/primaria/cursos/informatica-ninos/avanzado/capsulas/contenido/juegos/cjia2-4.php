...
<body onload="iniciarTiempo(), iniciar() ">
  ...
  <div class="contenido">
    ...
    <script>
      ...
      //arreglo que almacena las pistas y respuestas de la adivinanza
      const adivinanzas = [{
          pregunta: "Son símbolos o caracteres especiales que se utilizan para realizar cálculos.",
          respuesta: "Operadores",
          respondida: false
        },
        {
          pregunta: "Que operador de comparacion se ocupa en el ejemplo, =A1 <> B1.",
          respuesta: "Diferente",
          respondida: false
        },
        {
        ...
        {
          pregunta: "Que operador aritmetico se ocupa en el ejemplo, =A1 + B1 .",
          respuesta: "Suma",
          respondida: false
        },
        {
