	...
	<script>
		...
		var preguntas = [
			...
			},
			{
				num: 2,
				pregunta:
					"¿El Rigidbody puede recibir fuerza y torque para hacer que sus objetos se muevan en una manera realista?",
				opA: "cierto",
				opB: "falso",
				opC: "ambos",
				correcta: "A",
			...
			},
			{
				num: 3,
				pregunta:
					"¿Los Rigidbodies permiten que sus GameObjects actúen bajo el control del motor de ______?",
				opA: "nanobotica",
				opB: "quimica",
				opC: "fisica",
				correcta: "C",
			...
			},
			{
				num: 4,
				pregunta:
					"Generalmente, no debe manipular el Rigidbody y el _________ del mismo GameObject, solo uno o el otro.",
				opA: "Motor",
				opB: "Transform",
				opC: "Codigo",
				correcta: "B",
			...
			},
			{
				num: 5,
				pregunta:
					"¿Para la creacion de una plataforma que cae debemos agregar un elemeto?",
				opA: "falso",
				opB: "cierto",
				opC: "ninguna",
				correcta: "B",
			...
			},
			{
				num: 6,
				pregunta:
					"Para la creacion de una plataforma que cae en primera agregamos el elemeto con una capa voladora y creamos las paletas de colores ",
				opA: "cierto",
				opB: "ninguna",
				opC: "falso",
				correcta: "C",
			...
			},
			{
				num: 7,
				pregunta:
					"¿Manipular  GameObjects agregando fuerzas a un Transform crea una sensación y una apariencia muy diferentes? ",
				opA: "cierto",
				opB: "falso",
				opC: "ninguna",
				correcta: "B",
			...
			},
			{
				num: 8,
				pregunta:
					"¡Los Rigidbodies Kinematic van a afectar otros objetos, pero ellos mismos  serán afectados por física?",
				opA: "cierto",
				opB: "falso",
				opC: "ambos",
				correcta: "A",
			...
			},
			{
				num: 9,
				pregunta:
					"¿Un Rigidbody es el componente principal que permite el comportamiento físico para un objeto?",
				opA: "cierto",
				opB: "correcto",
				opC: "ambas",
				correcta: "C",
			...
			},
			{
				num: 10,
				pregunta:
					"¿Con un Rigidbody adjunto, el objeto inmediatamente responderá a la gravedad?",
				opA: "negativo",
				opB: "ninguna",
				opC: "falso",
				correcta: "B",
