	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="img/lvl1/word-0-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-1-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-2-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-0-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-1-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-2-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-0-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/word-1-2.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 4 + "&id_curso=" + 20; //cancatenation
				Swal.fire({
					title: 'Oops...',
