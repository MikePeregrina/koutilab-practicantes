...
<body onload="iniciarTiempo();">
	...
	<script>
		...
		var words = ['APARIENCIA', 'AMBIENTES', 'INMERSIVOS', 'HIERARCHY', 'LIGHT', 'FONDOS', 'LUCES', 'ELEMENTOS'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 44 +"&id_curso=" + 11; //cancatenation
