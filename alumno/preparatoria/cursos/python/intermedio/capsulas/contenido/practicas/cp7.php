            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd15.php?validar=' + 'incorrecto' + '&permiso=' + 15 + '&id_curso=' + 5 + '&practico=' + 10 + '&pythoncode=' + encodeV;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd15.php?validar=' + 'correcto' + '&permiso=' + 15 + '&id_curso=' + 5 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
