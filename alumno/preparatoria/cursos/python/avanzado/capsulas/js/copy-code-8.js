...
function iniciarTiempo() {
    ...
    if (segundos == 0) {
        ...
        var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp1-4.php'; //cancatenation
...
function alertExcelent() {
    ...
    if (text1 === text2) {
        var xmlhttp = new XMLHttpRequest();
        var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 13 + "&id_curso=" + 6 + "&redireccion=" + '../contenido/juegos/cjp1-4.php'; //cancatenation
        xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
        xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xmlhttp.send(param);
        Swal.fire({
