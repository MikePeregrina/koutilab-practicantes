        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T8/78.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T8/79.gif');"></li>
                        <li style="background-image: url('../../../img/1/T8/80.gif');"></li>
