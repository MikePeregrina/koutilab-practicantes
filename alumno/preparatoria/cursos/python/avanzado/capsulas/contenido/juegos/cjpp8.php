...
<body onload="iniciarTiempo();">
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        ...
                        <b class="tituloH">Horizontales:</b>
                            <div class="horizontal">
                                ...
                                <div class="vertical">
                                    1. Es la biblioteca de python que ya hemos usado la cual su nombre empieza con U.
                                </div>
                            </div>
                        </td>
                        <td></td>
            ...
            <div class="crucigrama">
                <div class="numero1" style="margin: 180px 0 0 -500px;">2.</div>
                <div class="numero2" style="margin: -500px 0 0 -60px">1.</div>
                <div class="numero1-1" style="margin: -50px 0 0 -380px;">1.</div>
                <div class="numero2-2" style="margin: 410px 0 0 -380px;">3.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
    ...
    <script>
        ...
        //Palabra unittest
        var palabra1_letra1 = document.getElementById("fila1C4");
        var palabra1_letra2 = document.getElementById("fila2C4");
        var palabra1_letra3 = document.getElementById("fila3C4");
        var palabra1_letra4 = document.getElementById("fila4C4");
        var palabra1_letra5 = document.getElementById("fila5C4");
        var palabra1_letra6 = document.getElementById("fila6C4");
        var palabra1_letra7 = document.getElementById("fila7C4");
        var palabra1_letra8 = document.getElementById("fila8C4");
        ...
        var palabra3_letra4 = document.getElementById("fila4C5");
        var palabra3_letra5 = document.getElementById("fila4C6");
        var palabra3_letra6 = document.getElementById("fila4C7");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "unittest" &&
                palabra2.toLowerCase() == "selenium" &&
                palabra3.toLowerCase() == "python" &&
                palabra4.toLowerCase() == "pytest"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra1.toLowerCase() != "unittest") {
                    palabra1_letra1.value = "";
                    palabra1_letra2.value = "";
                    palabra1_letra3.value = "";
                    palabra1_letra4.value = "";
                ...
                if (palabra2.toLowerCase() != "selenium") {
                    palabra2_letra1.value = "";
                    palabra2_letra2.value = "";
                    palabra2_letra3.value = "";
                    palabra2_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "pytest") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "unittes") {
                ...
                if (palabra3.toLowerCase() == "python") {
                    palabra1_letra4.value = "t";
                }

                if (palabra4.toLowerCase() == "pytest") {
                    palabra1_letra8.value = "8";
                }
            }
        }
    </script>
