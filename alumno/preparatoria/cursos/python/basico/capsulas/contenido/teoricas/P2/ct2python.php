        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/2/T2/131.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/2/T2/132.gif');"></li>
                        <li style="background-image: url('../../../img/2/T2/133.gif');"></li>
