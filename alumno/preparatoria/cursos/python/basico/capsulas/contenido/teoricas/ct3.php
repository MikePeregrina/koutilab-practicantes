            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        ...
                        <li style="background-image: url('../../img/CT33.gif');"></li>
                        <li style="background-image: url('../../img/CT333.gif');"></li>
                        <li style="background-image: url('../../img/CT3333.gif');"></li>
                        <li style="background-image: url('../../img/CT33333.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd8.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Como se imprime "koutilab"?</h1>
