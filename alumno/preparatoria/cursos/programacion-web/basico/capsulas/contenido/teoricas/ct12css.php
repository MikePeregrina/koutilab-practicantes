...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 10 CSS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T9.5/208.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T9.5/209.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/210.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/211.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/212.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/213.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_cp10.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Se pueden agregar sombras al texto?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Verdadero</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Falso</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Probablemente</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">No recuerdo</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="10">
