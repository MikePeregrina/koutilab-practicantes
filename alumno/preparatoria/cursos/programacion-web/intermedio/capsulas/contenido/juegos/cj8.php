...
<body onload="iniciarTiempo();">
	...
	<script>
		...
		var words = ['BACKGROUND', 'COLOR', 'IMAGE', 'POSITION', 'REPEAT', 'CENTER', 'URL', 'RGB'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 25 + "&id_curso=" + 2; //cancatenation
				Swal.fire({
					title: 'Oops...',
