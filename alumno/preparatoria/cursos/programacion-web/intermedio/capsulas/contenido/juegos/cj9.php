...
<body onload="iniciarTiempo();">
				...
				<tr>
					...
					<td>
						<div class="horizontal">
							1.HSL (Hue, Saturation, ______ ).
							<br><br>
							2. CSS define 17 palabras clave para referirse a los colores básicos. Uno de ellos es en su valor hexadecimal #800080.
						</div>
					</td>
					<b style="margin-left: 160px;">Verticales:</b>
					<td>
						<div class="vertical">
							1. Es una derivación del color verde, utilizando como indice parte de HSL.
							<br><br>
							2. Los valores de los colores se pueden definir mediante su nombre, en código ______ (#RRGGBBAA)
							<br><br>
							3. CSS define 17 palabras clave para referirse a los colores básicos. Uno de ellos es en su valor hexadecimal #ff00ff.
						</div>
					</td>
				</tr>
			</table>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 3 + "&id_curso=" + 2; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		function verificar() {
			...
			if (palabra1.toLowerCase() == "lightgreen" && palabra2.toLowerCase() == "lightness" && palabra3.toLowerCase() == "hexadecimal" && palabra4.toLowerCase() == "fuchsia" && palabra5.toLowerCase() == "violeta") {
				var xmlhttp = new XMLHttpRequest();

				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 3 + "&id_curso=" + 2; //cancatenation
				...
				if (palabra1.toLowerCase() != "lightgreen") {
				...
				if (palabra2.toLowerCase() != "lightness") {
				...
				if (palabra3.toLowerCase() != "hexadecimal") {
				...
				if (palabra4.toLowerCase() != "fuchsia") {
				...
				if (palabra5.toLowerCase() != "violeta") {
				...
				if (palabra2.toLowerCase() == "lightness") {
					...
					palabra2_letra7.value = "e";
				}

				if (palabra3.toLowerCase() == "hexadecimal") {
					palabra3_letra2.value = "e";
					palabra3_letra11.value = "l";
				}
