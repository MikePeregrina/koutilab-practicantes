...
<body onload="iniciarTiempo();">
    ...
    <div class="contenido">
        ...
        <div class="imagenes">
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiafuentes1.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiafuentes2.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiagenerica1.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiafuentes3.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiagenerica2.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiafuentes4.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiagenerica3.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiafuentes5.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiagenerica4.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/familiagenerica5.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
        </div>
        ...
        <div class="caja-html" style="font-size: 50%;">
            <!-- Etiquetas HTML -->
            <div class="ht1">
                <div class="html-b-t">FAMILIA DE FUENTES</div>
            </div>
            <div class="ht2">
                <div class="html-b-t">FAMILIA DE FUENTES</div>
            </div>
        ...
        <div class="caja-css" style="font-size: 50%;">
            <!-- Etiquetas CSS -->
            <div class="ht1">
                <div class="html-b-t">FAMILIA GENÉRICA</div>
            </div>
            <div class="ht2">
                <div class="html-b-t">FAMILIA GENÉRICA</div>
            </div>
