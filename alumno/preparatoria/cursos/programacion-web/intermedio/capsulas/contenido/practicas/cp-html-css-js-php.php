    ...
    <div class="body">
        <div class="container">
            ...
            <div class="">
                ...
                <div class="editor1">
                    <div class="titulo-edit1" style="margin-left: 150px;">
                        <h6>HTML</h6>
                    </div>
                    <div class="titulo-edit2" style="margin-left: 440px;">
                        <h6>CSS</h6>
                    </div>
                    <div class="titulo-edit3" style="margin-left: 700px;">
                        <h6>JAVASCRIPT</h6>
                    </div>
                    <div class="titulo-edit3" style="margin-left: 1010px;">
                        <h6>PHP</h6>
                    </div>
