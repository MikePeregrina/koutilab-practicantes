...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula de Pago del Lenguaje JavaScript</div><br>
            <section id="container-slider">
                ...
                <ul id="slider">
                    <li style="background-image: url('../../img/Alertas.gif'); z-index:0; opacity: 1;">
                        <form id="pregunta" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_cp3.php">
