        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T2/125.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T2/126.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/127.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/128.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/129.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/130.gif');"></li>
                        <li>
                            <div>
