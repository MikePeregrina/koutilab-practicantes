...
if ($result_sql == 0) {
    $insertarEstrellas = mysqli_query($conexion, "INSERT INTO detalle_intentos_preparatoria(id_capsula, id_alumno, intentos, id_curso) VALUES ($permiso, $id_user, 1, $id_curso)");
