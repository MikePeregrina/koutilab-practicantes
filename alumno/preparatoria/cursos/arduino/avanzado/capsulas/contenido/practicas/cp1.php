            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para esta primera practica del curso avanzado aprenderás
                                    a controlar un motor dc. Más especificamente, un motor
                                    reductor dc como el de la imagen.
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            } else {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 9 + '&practico=' + 10;
                });
            }
        }
    </script>
