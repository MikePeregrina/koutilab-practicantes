            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora que ya sabes como prender y apagar un led
                                    haremos un secuencia con ellos, donde usaremos
                                    un nuevo comando llamado delay. De su nombre en
                                    igual este comando le indica al arduino esperar
                                    cierto tiempo que tu elegiras, antes de que
                                    continue con el siguiente comando.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AD-2.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 7 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }
