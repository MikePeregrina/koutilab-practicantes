            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora ahora vamos a aprender a prender 3 LEDs por nuestra cuenta.
                                    <br><br>
                                    Pista:
                                    <br>
                                    Es repertir lo mismo haremos en la siguiente video práctica para
                                    cada LED, no se te olvide darle un nombre diferente de
                                    variable a cada uno.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AB-1.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
            ...
            if (!esCorrecto) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            } else {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 7 + '&practico=' + 10;
                });
            }
        }
    </script>
