...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/avanzado/capsulas/contenido/teoricas/ct1videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="nombre">
                                <p> Dibuja una parte de algun juego y donde pondrias tus puntos de control (resaltalos). Toma una foto y subela.
                                    <br> <br>
                                </p>
                            </td>
                        </tr>
