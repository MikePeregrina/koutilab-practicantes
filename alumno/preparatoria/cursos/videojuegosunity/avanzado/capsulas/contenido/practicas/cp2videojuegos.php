...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/avanzado/capsulas/contenido/teoricas/ct2videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>
                                    En una corta grabación de pantalla muestra una pequeña transición de camara.<br> <br>
                                </p>
                            </td>
                        </tr>
                    </tbody>
