        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunitya/T7/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T7/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T7/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T7/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T7/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T7/6.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para qué funciona Unity? </h1>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct7videojuegos.php';
                    }
                });
