...
<body onload="iniciarTiempo();">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="horizontal">
                                ...
                                <br>
                                1. El S _ _ _ _ _ Rect puede estar vinculado a un Scrollbar horizontal y/o vertical
                                <br /><br />
                                "Da la respuesta al 2 y al 3"
                                Tenga en cuenta que la propiedad de Direction en tal Scrollbar horizontal
                                se debería configurar a _ _ _ _ To _ _ _ _ _, y en un Scrollbar vertical
                                a Bottom To Top..
                                <br /><br />
                                4.-Traducido al español es arriba
                                <br /><br />
            ...
            <div class="crucigrama">
                ...
                <table id="crucigrama">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila4C9" style="
                                 border-style: none;
                                 background-color: rgba(255, 255, 255, 0)" />
                        </td>
                        <td>
    ...
    <script>
        ...
        //Palabra contenido
        var palabra2_letra1 = document.getElementById("fila1C2");
        var palabra2_letra2 = document.getElementById("fila2C2");
        var palabra2_letra3 = document.getElementById("fila3C2");
        var palabra2_letra4 = document.getElementById("fila4C2");
        var palabra2_letra5 = document.getElementById("fila5C2");
        var palabra2_letra6 = document.getElementById("fila6C2");
        var palabra2_letra7 = document.getElementById("fila7C2");
        var palabra2_letra8 = document.getElementById("fila8C2");
        var palabra2_letra9 = document.getElementById("fila9C2");
        ...
        var palabra5_letra2 = document.getElementById("fila1C2");
        var palabra5_letra3 = document.getElementById("fila1C3");
        var palabra5_letra4 = document.getElementById("fila1C4");
        var palabra5_letra5 = document.getElementById("fila1C5");
        var palabra5_letra6 = document.getElementById("fila1C6");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "left" &&
                palabra2.toLowerCase() == "contenido" &&
                palabra3.toLowerCase() == "top" &&
                palabra4.toLowerCase() == "right" &&
                palabra5.toLowerCase() == "scroll"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra5.toLowerCase() != "scroll") {
                    palabra5_letra1.value = "";
                    palabra5_letra2.value = "";
                    palabra5_letra3.value = "";
                    palabra5_letra4.value = "";
                ...
                if (palabra2.toLowerCase() == "contenido") {
                    palabra5_letra2.value = "c";
                    palabra1_letra2.value = "e";
                    palabra4_letra2.value = "i";
                    palabra3_letra2.value = "o";
                }
