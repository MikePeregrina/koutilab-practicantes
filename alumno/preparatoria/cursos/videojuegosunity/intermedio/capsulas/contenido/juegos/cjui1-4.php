...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>MENU NIVELES</b></h2>
	</div>
	...
	<script>
		...
		var words = ['MENU', 'NIVELES', 'LEVELMENU', 'VARIABLE', 'SCRIP', 'UNITY', 'SELECTED', 'LOADLEVEL'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 13 + "&id_curso=" + 11; //cancatenation
