...
<body>
    ...
    <section>
        <div class="main-content">
            ...
            <!-- PY -->
            <a href="../cursos/python/intermedio/capsulas/contenido/introduccion/ci2.php"><button class="btn24" id="intro" <?php echo 'style="' . (($existe_capsula29 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula introduccion a PY-->
            <!-- TEMA 1 -->
