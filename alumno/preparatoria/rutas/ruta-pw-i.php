    ...
    <section>
        <div class="main-content">
            ...
            <div class="container-premium1">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj2.php"><button class="btn7" id="gamep" <?php echo 'style="' . (($existe_verificar_html1 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_html1 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 2-->
            </div>
            <!-- TEMA 3 -->
            ...
            <div class="container-premium2">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj6.php" <?php echo 'style="' . (($existe_verificar_html2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_html2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>><button class="btn19" id="gamep"></button></a><!--Capsula juego 6-->
            </div>
            <!-- TEMA 7 -->
            ...
            <div class="container-premium3">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj8.php"><button class="btn27" id="gamep" <?php echo 'style="' . (($existe_verificar_css1 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_css1 > 0) ? 'opacity: 1;' : 'opacity: 0.5;') . '"'; ?>></button></a><!--Capsula juego 1-->
            </div>
            <!-- TEMA 2 -->
            ...
            <div class="container-premium4">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj13.php"><button class="btn42" id="gamep" <?php echo 'style="' . (($existe_verificar_css2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_css2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 6-->
            </div>
            <!-- TEMA 7 -->
            ...
            <div class="container-premium5">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj20.php"><button class="btn65" id="gamep" <?php echo 'style="' . (($existe_verificar_js1 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_js1 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 6-->
            </div>
            <!-- TEMA 7 -->
            <div class="container-premium6">
                ...
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/juegos/cj21.php"><button class="btn68" id="gamep" <?php echo 'style="' . (($existe_verificar_js2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_js2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula juego 7-->
            </div>
            <!-- EVALUATIVA JS -->
