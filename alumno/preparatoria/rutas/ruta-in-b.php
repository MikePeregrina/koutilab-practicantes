    ...
    <section>
        <div class="main-content">
            ...
            <div class="snake">
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/introduccion/ci2css.php"><button class="btn33" id="intro"></button></a><!--Capsula introduccion a CSS-->
                <!-- TEMA 1 -->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp11informatica.php"><button class="btn35" id="prac" <?php echo 'style="' . (($existe_capsula27 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 1-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp13informatica.php"><button class="btn38" id="prac" <?php echo 'style="' . (($existe_capsula30 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 2-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp14informatica.php"><button class="btn41" id="prac" <?php echo 'style="' . (($existe_capsula33 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 3-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp15informatica.php"><button class="btn44" id="prac" <?php echo 'style="' . (($existe_capsula36 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 4-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp17informatica.php"><button class="btn47" id="prac" <?php echo 'style="' . (($existe_capsula39 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 5-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp18informatica.php"><button class="btn50" id="prac" <?php echo 'style="' . (($existe_capsula42 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 6-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp19informatica.php"><button class="btn53" id="prac" <?php echo 'style="' . (($existe_capsula45 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 7-->
                ...
                <a href="../cursos/informatica/basico/capsulas/contenido/practicas/cp20informatica.php"><button class="btn59" id="prac" <?php echo 'style="' . (($existe_capsula48 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula practica 9-->
