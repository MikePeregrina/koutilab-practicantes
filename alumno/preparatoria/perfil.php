        ...
        <section class="seccion-perfil-usuario">
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    ...
                    <div class="Logo2">
                        <img src="../preparatoria/img/Bienvenida.png" style="height: 110px; width:170px;">
                    </div>
                    ...
                    <div class="desplegable">
                        ...
                        <button type="button" class="boton-opciones" id="" placeholder="Opciones">
                            <div class="sing"> <img src="../preparatoria/img/ajustes.png" alt="" height="20px" width="20px" class="svg">
                            </div>
