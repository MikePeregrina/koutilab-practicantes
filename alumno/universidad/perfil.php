...
$query_arduino_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 7");
$data_arduino_basico = mysqli_fetch_assoc($query_arduino_basico);

//Estadisticas arduino intermedio
$query_arduino_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 8");
$data_arduino_intermedio = mysqli_fetch_assoc($query_arduino_intermedio);

//Estadisticas arduino avanzado
$query_arduino_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 9");
...
$sql_cont = "UPDATE `alumnos_universidad` SET `conexiones`= '$cont'  WHERE id_alumno = '$id_user'";
            ...
            <div class="perfil-usuario-body">
                <div class="perfil-usuario-bio">
                    ...
                    <ul class="lista-datos">
                        <p><b>&nbsp;Escuela:</b><?php echo $user_escuela["nombre_escuela"] ?></li>
                            <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nivel educativo:</b><?php echo $user["nivel_educativo"] ?></li>
                            <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Profesor:</b><?php echo $user_escuela["cct"] ?></li>
                            <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CCT:</b> <?php if (isset($user_docente)) echo $user_docente["nombre"]; ?></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <dialog close id="modalP" style="border: none; border-radius: 10px; margin-top: 80px; margin-left: 370px;  background: url(../universidad/img/fondoPerfil.png);">
            ...
            <div class="portada" style="width: 500px; height: 300px; margin: 0px 30px 30px 30px; box-shadow: 0 0 12px rgba(61,172,244,.6); border-radius: 10px; background: rgba(255,255,255, .8); overflow-y: scroll;">
                <form id="cambiarportada1" action="acciones/cambiarfondo.php" method="post">
                    ...
                    <button onclick="miPortada1(); return false;" type="submit" style="width: 100px; margin-left: 200px; padding: 5px; border-radius: 5px; border: none; background-color: rgba(0,201,255,2556); color:white;">Seleccionar</button>
                </form>
