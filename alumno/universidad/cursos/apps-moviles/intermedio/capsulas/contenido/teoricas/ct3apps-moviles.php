        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T3/28.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T3/29.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T3/30.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T3/31.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T3/32.gif');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué es la World Wide Web (La Web) según el texto?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Un sistema de transmisión de datos a través de internet.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Un navegador web.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Un protocolo de transferencia de hipertextos.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Un sitio web en particular.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="8">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="8">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct3apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
