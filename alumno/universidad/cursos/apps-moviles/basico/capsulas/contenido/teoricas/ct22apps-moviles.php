        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T5/183.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T5/184.gif');"></li>
                        <li style="background-image: url('../../img/2/T5/185.gif');"></li>
                        <li style="background-image: url('../../img/2/T5/186.gif');"></li>
                        <li style="background-image: url('../../img/2/T5/187.gif');"></li>
                        <li style="background-image: url('../../img/2/T5/188.gif');"></li>
                        <li style="background-image: url('../../img/2/T5/189.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct22apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
