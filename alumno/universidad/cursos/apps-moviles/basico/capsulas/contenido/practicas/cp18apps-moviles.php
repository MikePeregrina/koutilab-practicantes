...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct4apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 18 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Investigar y comparar los diferentes tipos de redes mencionados en el texto: LAN, MAN y WAN. Analiza las características, el alcance y los casos de uso de cada tipo de red. Resume tus hallazgos y destaca las diferencias clave entre ellos.
                                    <br> <br>
                                </p>
                            </td>
