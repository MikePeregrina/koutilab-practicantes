            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crea un manual de instrucciones ilustrado sobre cómo encender y apagar correctamente una computadora. Incluir pasos detallados, imágenes claras y descripciones concisas para guiarse a través del proceso.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (div > 0 && titles > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd3.php?validar=' + 'correcto' + '&permiso=' + 3 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd3.php?validar=' + 'incorrecto' + '&permiso=' + 3 + '&id_curso=' + 7 + '&practico=' + 10;
