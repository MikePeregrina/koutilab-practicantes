...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct10html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 20 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realiza un cuadro comparativo de los diferentes tipos de dispositivos de almacenamiento de datos, como discos duros, memorias USB, discos compactos y DVD regrabables. Analizar las características, capacidades de almacenamiento, velocidades de transferencia y usos recomendados de cada uno.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (divs > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd49.php?validar=' + 'correcto' + '&permiso=' + 49 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd49.php?validar=' + 'incorrecto' + '&permiso=' + 49 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }*/
