...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct20apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 19 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Realiza un cuadro comparativo sobre las diferentes versiones de Windows mencionadas en el texto. Investiga y describe las características y mejoras introducidas en cada una de ellas, así como su impacto y su uso en computadoras personales.
                                    <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (divs > 4) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'correcto' + '&permiso=' + 46 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'incorrecto' + '&permiso=' + 46 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }*/
