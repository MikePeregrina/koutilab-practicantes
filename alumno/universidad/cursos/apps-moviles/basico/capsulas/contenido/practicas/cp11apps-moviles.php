...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct18apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 11 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realiza una investigación sobre la filosofía y los principios fundamentales del software libre y el movimiento de código abierto. Explora las implicaciones éticas, sociales y económicas del software libre y cómo Linux se ajusta a estos conceptos. Presenta los hallazgos en un ensayo o en una presentación visual.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (bolds > 0 && h1 > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'correcto' + '&permiso=' + 28 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'incorrecto' + '&permiso=' + 28 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }*/
