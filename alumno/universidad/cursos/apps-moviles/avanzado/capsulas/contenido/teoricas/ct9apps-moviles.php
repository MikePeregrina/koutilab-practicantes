        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T9/70.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T9/71.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T9/72.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T9/73.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T9/74.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T9/75.gif');"></li>
                        <li>
                            <div>
