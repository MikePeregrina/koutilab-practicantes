        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T6/47.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/48.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/49.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/50.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/51.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/52.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct6apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct6apps-moviles.php';
                    }
                });
