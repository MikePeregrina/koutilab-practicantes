...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct10css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 10 Excel</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/avanzadoinf/prac20.gif" style="height: auto; width: 60%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
