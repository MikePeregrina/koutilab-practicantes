...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct5js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Aquí te dejo las instrucciones para realizar la práctica de eventos en JavaScript.
                                    <br>
                                    Crea un botón con la etiqueta < button> y asignarle un ID.
                                        <br>
                                        Crea dos funciones. La primera debe cambiar el color del botón a azul y la segunda debe volver a ponerlo en verde.
                                        <br>
                                        Agregar dos eventos al botón utilizando el método addEventListener(). Uno de los eventos debe ser el mouseover y
                                        el otro debe ser el mouseout. Al primer evento se le debe asignar la función cambiarColor y al segundo evento se le
                                        debe asignar la función resetearColor.
                                        <br><br>
                                </p>
                            </td>
                        </tr>
