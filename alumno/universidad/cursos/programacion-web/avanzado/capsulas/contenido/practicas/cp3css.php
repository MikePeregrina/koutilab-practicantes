                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/pseudoelementos.png" style="height: 200px; width: 700px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (divs > 0 && csscode.indexOf('position') != -1 && csscode.indexOf('before') != -1 && csscode.indexOf('after') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd19.php?validar=' + 'incorrecto' + '&permiso=' + 19 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
