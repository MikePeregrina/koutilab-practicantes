...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct4php.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 4 PHP</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
        ...
        function miFunc() {
            ...
            if (p > 0 && jscode.indexOf('echo') != -1 && jscode.indexOf('function') != -1) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd48.php?validar=' + 'correcto' + '&permiso=' + 48 + '&id_curso=' + 3 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd48.php?validar=' + 'correcto' + '&permiso=' + 48 + '&id_curso=' + 2 + '&practico=' + 10;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd48.php?validar=' + 'incorrecto' + '&permiso=' + 48 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
