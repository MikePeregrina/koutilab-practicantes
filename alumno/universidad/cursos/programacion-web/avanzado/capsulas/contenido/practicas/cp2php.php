...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct2php.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 2 PHP</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Aquí te dejo una práctica muy sencilla de vectores en PHP:
                                    <br>
                                    Crea un vector con los nombres de tus amigos.
                                    <br>
                                    Imprime el primer nombre del vector en pantalla.
                                    <br><br>
                                </p>
                            </td>
                        </tr>
