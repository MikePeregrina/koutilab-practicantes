...
<body>
        ...
        <div class="container">
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/lineassvg.png" style="height: 380px; width: 350px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="editor-container">
                ...
                <div class="editor1">
                    ...
                    <iframe onkeyup="actualizar()" id="output" class="editor" style="margin-top: 20px;"></iframe>
                </div>
    ...
    <script>
        ...
        function miFunc() {
            ...
            console.log("svg: " + svg);
            let line = frame.querySelectorAll("line").length;
