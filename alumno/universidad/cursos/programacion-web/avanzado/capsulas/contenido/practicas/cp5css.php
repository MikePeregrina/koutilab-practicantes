            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Genera un formulario html según la imagen adjunta y que cumpla las siguientes especificaciones:
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/formularios.png" style="height: 400px; width: 300px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (inputext > 0 && inputemail > 0 && textarea > 0 && inputboton > 0 && csscode.indexOf('background-color') != -1 && csscode.indexOf('color') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd25.php?validar=' + 'incorrecto' + '&permiso=' + 25 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
