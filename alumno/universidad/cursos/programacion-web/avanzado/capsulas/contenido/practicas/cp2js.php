...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct2js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 2 JavaScript</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Aquí te dejo una práctica para que puedas usar funciones en JavaScript:
                                    <br>
                                    Vamos a crear una función que sume tu número favorito con otro número.
                                    <br>
                                    Ahora, escribe una función básica en JavaScript que sume tu número favorito.
                                    <br>
                                    Esta función se llamará "sumarNumeroFavorito" y que cuando la llamamos, sumará tu número favorito con
                                    10 y mostrará el resultado en una ventana emergente.
                                    <br>
        ...
        function miFunc() {
            ...
            if (button > 0 && script > 0 && jscode.indexOf('function') != -1 && jscode.indexOf('var') != -1 && jscode.indexOf('alert') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd32.php?validar=' + 'incorrecto' + '&permiso=' + 32 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
