...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct4js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 4 JavaScript</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Aquí te presento una práctica sencilla para que puedas entender cómo funcionan los eventos en JavaScript:
                                    <br>
                                    Primero, crea un archivo HTML con un botón:
                                    <br>
                                    Ahora, crea un archivo JavaScript y vincúlalo con tu archivo HTML. En este archivo, vamos a crear una función que se llame saludar():
                                    <br>
        ...
        function miFunc() {
            ...
            if (button > 0 && script > 0 && jscode.indexOf('function') != -1 && jscode.indexOf('getElementById') != -1 && jscode.indexOf('alert') != -1) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd38.php?validar=' + 'correcto' + '&permiso=' + 38 + '&id_curso=' + 3 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd38.php?validar=' + 'correcto' + '&permiso=' + 38 + '&id_curso=' + 2 + '&practico=' + 10;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd38.php?validar=' + 'incorrecto' + '&permiso=' + 38 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
