        ...
        function miFunc() {
            ...
            if (p > 0 && jscode.indexOf('echo') != -1 && jscode.indexOf('function') != -1) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd45.php?validar=' + 'correcto' + '&permiso=' + 45 + '&id_curso=' + 3 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd45.php?validar=' + 'correcto' + '&permiso=' + 45 + '&id_curso=' + 2 + '&practico=' + 10;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd45.php?validar=' + 'incorrecto' + '&permiso=' + 45 + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
