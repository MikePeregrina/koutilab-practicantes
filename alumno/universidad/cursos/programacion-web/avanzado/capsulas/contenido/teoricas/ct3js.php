...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 3 JS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T3/111.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T3/112.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/113.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/114.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/115.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/116.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd34.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para que sirven los formularios?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Es donde los usuarios pueden escribir información y enviarla a otro lugar.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son serie de preguntas que el usuario tendra que responder.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Es un carrusel de imagenes.</label>
                                    </div>
                                    <div class="container-question">
