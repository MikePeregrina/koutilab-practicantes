        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T1/97.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T1/98.gif');"></li>
                        <li style="background-image: url('../../img/js/T1/99.gif');"></li>
                        <li style="background-image: url('../../img/js/T1/100.gif');"></li>
                        <li style="background-image: url('../../img/js/T1/101.gif');"></li>
                        <li style="background-image: url('../../img/js/T1/102.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd28.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué es el redireccionamiento?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Cuando un sitio web te lleva automáticamente a otra pagina. </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Cuando un sitio web te lleva automáticamente a otro modulo de la misma pagina. </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Cuando un sitio web te muestra anuncios de otra pagina.</label>
                                    </div>
                                    <div class="container-question">
