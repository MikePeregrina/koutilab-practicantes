        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T4.5/34.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T4.5/35.gif');"></li>
                        <li style="background-image: url('../../img/html/T4.5/36.gif');"></li>
                        <li style="background-image: url('../../img/html/T4.5/37.gif');"></li>
                        <li style="background-image: url('../../img/html/T4.5/38.gif');"></li>
                        <li style="background-image: url('../../img/html/T4.5/39.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd11.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué significa 'SVG'?</h1>
