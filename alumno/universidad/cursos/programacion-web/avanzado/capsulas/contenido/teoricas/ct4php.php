...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 4 PHP</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T3/160.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T3/161.gif');"></li>
                        <li style="background-image: url('../../img/php/T3/162.gif');"></li>
                        <li style="background-image: url('../../img/php/T3/163.gif');"></li>
                        <li style="background-image: url('../../img/php/T3/164.gif');"></li>
                        <li style="background-image: url('../../img/php/T3/165.gif');"></li>
                        <li>
                            <div >
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd47.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>include ¿Para que sirve?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Para emitir una advertencia</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Para emitir una mensaje</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Para emitir un hipervunculo</label>
                                    </div>
                                    <div class="container-question">
