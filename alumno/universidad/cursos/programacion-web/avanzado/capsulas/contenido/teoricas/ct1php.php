...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 PHP</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T1/139.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T1/140.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/141.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/142.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/143.gif');"></li>
                        <li style="background-image: url('../../img/php/T1/144.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd41.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son las variables?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Son cajas que guardan información</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son cajas que borran información</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Son cajas que actualizan información</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Todas las anteriores</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="41">
