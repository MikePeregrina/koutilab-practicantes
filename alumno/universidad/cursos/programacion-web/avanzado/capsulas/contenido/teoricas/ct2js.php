        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T2/104.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T2/105.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/106.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/107.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/108.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/109.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd31.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué es la función?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Es un conjunto de instrucciones que indica que no hacer.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Es un conjunto de instrucciones que indica que se puede hacer. </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Es un conjunto de instrucciones que indica que hacer.</label>
                                    </div>
                                    <div class="container-question">
