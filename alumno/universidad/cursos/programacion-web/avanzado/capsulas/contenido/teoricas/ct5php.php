...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 5 PHP</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/php/T4/167.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/php/T4/168.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/169.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/170.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/171.gif');"></li>
                        <li style="background-image: url('../../img/php/T4/172.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd50.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el ejemplo sencillo de un formulario?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Preguntar por el nombre y edad</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Realizar un login</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Realizar un registro</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Ninguna de las anteriores</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="50">
