    ...
    <section>
        ...
        <div class="container-all">
            ...
            <div class="left-column">
                ...
                <div class="word-box" id="css">&lt;Button&gt;</div>
                <div class="word-box" id="sql">$_POST["nombre"];</div>
                <div class="word-box" id="html">button { color: red; }</div>
                <div class="word-box" id="javascript">alert("Hola");</div>
                <div class="word-box" id="php">method</div>
            </div>
            ...
            <div class="right-column">
                <!-- Respuestas -->
                <div class="word-box" id="interactividad" onclick="checkAnswer('interactividad')">Javascript</div>
                <div class="word-box" id="funcionalidad" onclick="checkAnswer('funcionalidad')">POST</div>
                <div class="word-box" id="estructura" onclick="checkAnswer('estructura')">CSS</div>
                <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">HTML</div>
                <div class="word-box" id="administrar" onclick="checkAnswer('administrar')">PHP</div>
            </div>
        </div>
