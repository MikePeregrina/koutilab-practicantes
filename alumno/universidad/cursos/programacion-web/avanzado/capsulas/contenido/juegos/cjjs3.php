...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <script>
        ...
        function tiempoAgotado() {
            ...
            var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 36 + "&id_curso=" + 3; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 36 + "&id_curso=" + 3; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_pd36.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
    ...
    <script>
        ...
        function iniciar() {
            base_preguntas = readText("../../js/base-preguntas1.json");
