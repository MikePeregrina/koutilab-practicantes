...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>VECTORES O ARRAYS</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				...
				'<i class="fab fa-css3-alt" style="color: #4d8eff;"></i>',
				'<i class="fab fa-php" style="color: #a8c8ff;"></i>',
				'<i class="fas fa-keyboard" style="color: gray;"></i>',
				'<i class="fab fa-html5" style="color: orange;"></i>',
				'<i class="fab fa-js-square" style="color: #fff700;"></i>',
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 46 + "&id_curso=" + 3; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_pd46.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
