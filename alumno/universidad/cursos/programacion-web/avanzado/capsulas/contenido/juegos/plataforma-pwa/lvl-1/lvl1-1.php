...
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_universidad c INNER JOIN detalle_capsulas_pauniversidadrsidad d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 3;");
...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            El formato de imagen ___ es bidimensional, puede escalarse sin perder calidad
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'El formato de imagen ___ es bidimensional, puede escalarse sin perder calidad',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function preload() {
            ...
            this.load.image("respuesta", "../assets/resp1-1.png");
            this.load.image("respuesta1", "../assets/resp2-1.png");
        ...
        function create() {
            ...
            plataforms.create(300, 475, "moon-stone");
            plataforms.create(70, 375, "moon-stone");
            plataforms.create(270, 280, "moon-stone");
            plataforms.create(500, 475, "moon-stone");
            plataforms.create(730, 375, "moon-stone");
            plataforms.create(530, 280, "moon-stone");
            plataforms.create(400, 180, "moon-stone");
            plataforms.create(60, 150, "moon-label");
            plataforms.create(740, 150, "moon-label");
            ...
            this.add.image(60, 180, "respuesta").setScale(0.17);
            ...
            player = this.physics.add.sprite(60, 520, "dude").setScale(0.5);
            ...
            stars.create(730, 300, "star");
            stars.create(400, 10, "star");
            stars.create(530, 190, "star");
            stars.create(270, 190, "star");
            ...
            setTimeout(() => {
                fire = this.physics.add.sprite(0, 150, "fire");
                this.anims.create({
                    key: "fire-a",
                    frames: this.anims.generateFrameNumbers("fire", {
                        start: 0,
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: "¡Perfecto!",
                text: "Has completado el capitulo 1 de las aventuras de Koubot con 10 puntos y " +
                    score +
                    " estrellas de 5",
        ...
        function alertQuestion() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "lvl1-2.php";
                }
            });
        }
