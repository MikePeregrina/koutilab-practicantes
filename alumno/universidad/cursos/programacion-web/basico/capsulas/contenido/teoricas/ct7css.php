...
$permiso = "capsula44";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_universidaddad c INNER JOIN detalle_capsuluniversidadrsidad d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 1");
...
$permiso_intento = 45;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_universidaddad WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 1");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_universidaddad WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 1");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 7 CSS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T7/132.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T7/133.gif');"></li>
                        <li style="background-image: url('../../img/css/T7/134.gif');"></li>
                        <li style="background-image: url('../../img/css/T7/135.gif');"></li>
                        <li style="background-image: url('../../img/css/T7/136.gif');"></li>
                        <li style="background-image: url('../../img/css/T7/137.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd45.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son los selectores ID?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Buscan un elemento basado en el atributo id</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Es un buscador de elementos</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Es el id de los elementos</label>
                                    </div>
                                    <div class="container-question">
