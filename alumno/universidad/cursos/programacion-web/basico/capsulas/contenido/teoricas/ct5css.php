                            ...
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd39.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Para afectar con unos estilos determinados</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Para editar estilos determinados</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Para agregar estilos determinados</label>
                                    </div>
                                    <div class="container-question">
