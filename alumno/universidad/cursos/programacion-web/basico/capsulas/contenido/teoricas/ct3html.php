                            ...
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd8.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Listas enumeradas y listas con viñetas</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Listas desordenadas y listas con viñetas</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Listas ordenadas y listas desordenadas</label>
                                    </div>
                                    <div class="container-question">
