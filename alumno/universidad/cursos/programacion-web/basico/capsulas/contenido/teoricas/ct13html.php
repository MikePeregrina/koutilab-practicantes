        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/T10/92.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/T10/93.gif');"></li>
                        <li style="background-image: url('../../img/1/T10/94.gif');"></li>
                        <li style="background-image: url('../../img/1/T10/95.gif');"></li>
                        <li style="background-image: url('../../img/1/T10/96.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct13html.php">
                                </form>
                            </div>
                        </li>
                    </ul>
