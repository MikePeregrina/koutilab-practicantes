...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 CSS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T2/97.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T2/98.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/99.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/100.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/101.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/102.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd30.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué es la sintaxis?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Es el conjunto de reglas</label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox3">Es el conjunto de reglas que definen los estilos</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Es el conjunto de reglas que definen como escribir codigo</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="30">
