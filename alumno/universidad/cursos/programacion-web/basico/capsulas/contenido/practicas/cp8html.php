...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 8 HTML</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Agrega un botón < button> solo con código HTML. Colócale un título arriba de botón y texto dentro del botón < h1>.
                                            <br> <br>
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (h1 > 0 && buttons > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'correcto' + '&permiso=' + 24 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode=' + encodeHTML;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'incorrecto' + '&permiso=' + 24 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode='+ document.getElementById("cd").value;
