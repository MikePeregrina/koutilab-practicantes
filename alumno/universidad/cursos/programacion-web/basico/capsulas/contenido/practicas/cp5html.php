...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct5html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 5 HTML</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
        ...
        function miFunc() {
            ...
            if (a > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd15.php?validar=' + 'correcto' + '&permiso=' + 15 + '&id_curso=' + 1 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd15.php?validar=' + 'correcto' + '&permiso=' + 15 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode=' + encodeHTML;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd15.php?validar=' + 'incorrecto' + '&permiso=' + 15 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode='+ document.getElementById("cd").value;
