...
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_universidaddad c INNER JOIN detalle_capsuluniversidadrsidad d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct6css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>A continuación, se muestra un código HTML lo que tienes
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/selectorcpractica.png" style="height: 220px; width: 480px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd43.php?validar=' + 'correcto' + '&permiso=' + 43 + '&id_curso=' + 1 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd43.php?validar=' + 'correcto' + '&permiso=' + 43 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode=' + encodeHTML;
