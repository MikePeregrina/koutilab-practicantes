...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct10css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>En un documento HTML crea una división que
                                    contenga el fondo de un color, margenes que centren el div y una sombra en el respaldo del color de tu preferencia < div>.
                                        <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/practica10css.png" style="height: 200px; width: 380px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
