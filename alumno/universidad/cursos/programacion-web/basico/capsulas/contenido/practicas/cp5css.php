...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct5css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 5 CSS</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realiza que tus etiquetas de párrafo estén de color azul
            ...
            if (p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'correcto' + '&permiso=' + 40 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode=' + encodeHTML;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'incorrecto' + '&permiso=' + 40 + '&id_curso=' + 1 + '&practico=' + 10 + '&htmlcode='+ document.getElementById("cd").value;
