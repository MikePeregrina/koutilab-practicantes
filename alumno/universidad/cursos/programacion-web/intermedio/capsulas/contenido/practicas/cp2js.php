...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct2js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
        ...
        function miFunc() {
            ...
            if (jscode.indexOf('const') !== -1 && jscode.toLowerCase().indexOf('pi') !== -1 && jscode.indexOf('3.1416') !== -1 && (jscode.indexOf('*2') !== -1 || jscode.indexOf('* 2') !== -1) && jscode.toLowerCase().indexOf('perimetro') !== -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd38.php?validar=' + 'incorrecto' + '&permiso=' + 38 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
