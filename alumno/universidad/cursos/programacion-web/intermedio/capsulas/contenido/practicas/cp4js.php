...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct4js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
    ...
    <script>
        ...
        function miFunc() {
            ...
            //Validando existencia de operadores lógicos
            if (jscode.indexOf('>') !== -1) {
            ...
            if (jscode.indexOf('>') !== -1 && jscode.indexOf('<') !== -1 && jscode.indexOf('=') !== -1 && condicional >= 2 && alertas == 3) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd41.php?validar=' + 'correcto' + '&permiso=' + 41 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd41.php?validar=' + 'incorrecto' + '&permiso=' + 41 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
