...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct1js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 1 JavaScript</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
            ...
            if (jscode.indexOf('var') == -1 || jscode.toLowerCase().indexOf('nombre') == -1 || jscode.indexOf('"') == -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd35.php?validar=' + 'incorrecto' + '&permiso=' + 35 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
