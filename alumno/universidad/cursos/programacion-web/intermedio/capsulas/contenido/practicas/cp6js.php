            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Imprime los números del 1 al 10 en la consola utilizando un loop while.
                                    <br><br>
                                </p>
                            </td>
                            <td class="ne">
        ...
        function miFunc() {
            ...
            if (loopwhile == 1 && consola >= 1 && jscode.indexOf('let') !== -1 && jscode.indexOf('++') !== -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd47.php?validar=' + 'incorrecto' + '&permiso=' + 47 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
