...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct3css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/practica3cssI.png" style="height: 260px; width: 400px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            if (htmlcode.length > 30 && csscode.indexOf('blue') !== -1 && csscode.indexOf('#') != -1 && csscode.indexOf('rgb') != -1 && csscode.indexOf('hsl') != -1 && csscode.indexOf('opacity') != -1 && opacidad >= 2 && background >= 5) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp10.php?validar=' + 'correcto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10;
                    }
                });
