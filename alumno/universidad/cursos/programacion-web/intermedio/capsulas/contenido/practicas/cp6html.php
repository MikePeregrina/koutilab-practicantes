...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct6html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
    ...
    <script>
        ...
        function miFunc() {
            ...
            if (htmlcode.indexOf('colspan="3"') !== -1 || htmlcode.indexOf('colspan= "3"') !== -1) {
                console.log("Si aparece colspan");
            } else {
            ...
            if (table == 1 && tr == 3 && th == 7 && td == 6 && (htmlcode.indexOf('colspan="3"') !== -1 || htmlcode.indexOf('colspan= "3"') !== -1)) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd12.php?validar=' + 'incorrecto' + '&permiso=' + 12 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
