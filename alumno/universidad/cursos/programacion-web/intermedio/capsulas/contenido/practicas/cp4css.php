...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct4css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/practica4html.png" style="height: 200px; width: 450px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (htmlcode.length > 10 && (csscode.toLowerCase().indexOf('font-family:georgia') !== -1 || csscode.toLowerCase().indexOf('font-family: georgia') !== -1) && (csscode.toLowerCase().indexOf('font-size:medium') !== -1 || csscode.toLowerCase().indexOf('font-size: medium') !== -1) && (csscode.toLowerCase().indexOf('font-style:italic') !== -1 || csscode.toLowerCase().indexOf('font-style: italic') !== -1) && (csscode.toLowerCase().indexOf('font-weight:bold') !== -1 || csscode.toLowerCase().indexOf('font-weight: bold') !== -1)) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd25.php?validar=' + 'incorrecto' + '&permiso=' + 25 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
