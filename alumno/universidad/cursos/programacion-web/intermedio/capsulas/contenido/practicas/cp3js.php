...
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_universidaddad c INNER JOIN detalle_capsulas_pauniversidadrsidad d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 2;");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct3js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 3 JavaScript</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                        ...
                        <tr>
                            <td class="nombre">
                                <p> Aquí te dejo otra práctica divertida para que puedas practicar los operadores matemáticos en JavaScript!.
                                    ...
                                    4.A continuación, divide el resultado entre 3.
        ...
        function miFunc() {
            ...
            if ((jscode.indexOf('3') !== -1 || jscode.indexOf(' 3') !== -1) && (jscode.indexOf('+6') !== -1 || jscode.indexOf('+ 6') !== -1) && (jscode.indexOf('/3') !== -1 || jscode.indexOf('/ 3') !== -1) && (jscode.indexOf('-2') !== -1 || jscode.indexOf('- 2') !== -1)) {
                ...
                Correcto.play();
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp12.php?validar=' + 'correcto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp12.php?validar=' + 'incorrecto' + '&permiso=' + 10 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + document.getElementById("html-code").value + '&csscode=' + document.getElementById("css-code").value + '&jscode=' + document.getElementById("js-code").value;
