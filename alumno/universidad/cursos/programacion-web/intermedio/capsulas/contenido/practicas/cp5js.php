...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct5js.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 5 JavaScript</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para practicar la entrada de datos por teclado en
                                    JavaScript, realiza un pequeño programa que le pida
                                    al usuario su edad y le diga si es lo suficientemente
    ...
    <script>
        ...
        function miFunc() {
            ...
            //Validando aparición de instrucciones
            ...
            if (jscode.toLowerCase().indexOf('edad') !== -1 && jscode.indexOf('>') !== -1 && jscode.indexOf('prompt') !== -1 && condicional == 1 && alertas >= 1) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd44.php?validar=' + 'correcto' + '&permiso=' + 44 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd44.php?validar=' + 'incorrecto' + '&permiso=' + 44 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
