        ...
        function miFunc() {
            ...
            if (jscode.toLowerCase().indexOf('edad') !== -1 && jscode.indexOf('>') !== -1 && jscode.indexOf('prompt') !== -1 && condicional == 1 && alertas >= 1) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd59.php?validar=' + 'correcto' + '&permiso=' + 17 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd59.php?validar=' + 'incorrecto' + '&permiso=' + 17 + '&id_curso=' + 2 + '&practico=' + 10;
                    }
                });
            }
        }
