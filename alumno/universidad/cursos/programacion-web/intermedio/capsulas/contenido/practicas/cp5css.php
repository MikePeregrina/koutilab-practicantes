...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct5css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
        ...
        function miFunc() {
            ...
            if (div >= 6 && csscode.toLowerCase().indexOf('background') !== -1 && (csscode.toLowerCase().indexOf('flex-direction: column') !== -1 || csscode.toLowerCase().indexOf('flex-direction:column') !== -1) && (csscode.toLowerCase().indexOf('flex-wrap: wrap') !== -1 || csscode.toLowerCase().indexOf('flex-wrap:wrap') !== -1) && (csscode.toLowerCase().indexOf('flex-flow: column nowrap') !== -1 || csscode.toLowerCase().indexOf('flex-flow:column nowrap') !== -1)) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'correcto' + '&permiso=' + 28 + '&id_curso=' + 2 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'incorrecto' + '&permiso=' + 28 + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS;
