...
//validacion para capsulas premiun
...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct2html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 1.5 HTML</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                                <img src="../../../../../../img/practicahtml2.png" style="height: 350px; width: 300px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            if ((h1 > 0 || h2 > 0) && ol > 0 && ul > 0 && li == 7) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp8.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 2 + '&practico=' + 10;
                    }
                });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp8.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 2 + '&practico=' + 10;
