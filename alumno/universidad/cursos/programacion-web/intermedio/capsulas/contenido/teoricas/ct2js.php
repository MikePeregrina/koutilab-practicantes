...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 JS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T2/132.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T2/133.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/134.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/135.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/136.gif');"></li>
                        <li style="background-image: url('../../img/js/T2/137.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd37.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son las constantes?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Son cajas abiertas con identificación</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son cajas cerradas sin identificación</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Son cajas cerradas y podemos ponerle nombre para identificarlas </label>
                                    </div>
                                    <div class="container-question">
