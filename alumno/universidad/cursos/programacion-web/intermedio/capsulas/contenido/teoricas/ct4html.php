...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 3 HTML</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T3/34.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T3/35.gif');"></li>
                        <li style="background-image: url('../../img/html/T3/36.gif');"></li>
                        <li style="background-image: url('../../img/html/T3/37.gif');"></li>
                        <li style="background-image: url('../../img/html/T3/38.gif');"></li>
                        <li style="background-image: url('../../img/html/T3/39.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd11.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuáles son las 2 etiquetas que se usan para crear una tabla?</h1>
