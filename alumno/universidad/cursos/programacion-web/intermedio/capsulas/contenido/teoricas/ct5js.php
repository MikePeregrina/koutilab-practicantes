...
$permiso = "capsula42";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_universidaddad c INNER JOIN detalle_capsuluniversidadrsidad d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 2");
...
$permiso_intento = 43;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_universidaddad WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 2");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_universidaddad WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 2");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 5 JS</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T5/153.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T5/154.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/155.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/156.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/157.gif');"></li>
                        <li style="background-image: url('../../img/js/T5/158.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd43.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>La función prompt() ¿Para que nos sirve?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Para poder integrar un PDF</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Para obtener información del usuario a través del teclado</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Para poder integrar in carrusel de imagenes y videos</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Para poder integrar un formulario</label>
                                    </div>
