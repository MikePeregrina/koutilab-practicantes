        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T3/90.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T3/91.gif');"></li>
                        <li style="background-image: url('../../img/css/T3/92.gif');"></li>
                        <li style="background-image: url('../../img/css/T3/93.gif');"></li>
                        <li style="background-image: url('../../img/css/T3/94.gif');"></li>
                        <li style="background-image: url('../../img/css/T3/95.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd24.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuáles son los 2 tipos de nombres de familia de fuente?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Familia de fuentes y Familia genérica</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Familia de tipografia y Familia de fuentes</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Familia genérica y Familia de videos</label>
                                    </div>
                                    <div class="container-question">
