        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T4/97.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T4/98.gif');"></li>
                        <li style="background-image: url('../../img/css/T4/99.gif');"></li>
                        <li style="background-image: url('../../img/css/T4/100.gif');"></li>
                        <li style="background-image: url('../../img/css/T4/101.gif');"></li>
                        <li style="background-image: url('../../img/css/T4/102.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd27.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Es un contenedor flexible que contiene varios elementos flexibles</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Es un contenedor donde podemos incluir muchos elementos</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Contiene varios elementos flexibles</label>
                                    </div>
                                    <div class="container-question">
