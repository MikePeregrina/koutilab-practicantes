        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T2/27.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T2/28.gif');"></li>
                        <li style="background-image: url('../../img/html/T2/29.gif');"></li>
                        <li style="background-image: url('../../img/html/T2/30.gif');"></li>
                        <li style="background-image: url('../../img/html/T2/31.gif');"></li>
                        <li style="background-image: url('../../img/html/T2/32.gif');"></li>
                        <li>
                            <div>
