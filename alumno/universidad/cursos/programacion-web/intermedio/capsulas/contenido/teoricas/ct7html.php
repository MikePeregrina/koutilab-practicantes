        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T5/55.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T5/56.gif');"></li>
                        <li style="background-image: url('../../img/html/T5/57.gif');"></li>
                        <li style="background-image: url('../../img/html/T5/58.gif');"></li>
                        <li style="background-image: url('../../img/html/T5/59.gif');"></li>
                        <li style="background-image: url('../../img/html/T5/60.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para qué sirve un campo de texto multilínea?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Ninguna de las anteriores</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Grabador de múltiples líneas de texto</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Lector de múltiples líneas de texto</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Permite el ingreso de múltiples líneas de texto</label>
                                    </div>
