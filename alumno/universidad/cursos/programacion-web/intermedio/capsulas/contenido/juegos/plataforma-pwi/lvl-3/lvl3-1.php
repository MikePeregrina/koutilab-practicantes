...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Hablamos de una palabra clave que se añade a los selectores y que especifica un estado especial del elemento seleccionado, ¿a qué nos referimos?
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Hablamos de una palabra clave que se añade a los selectores y que especifica un estado especial del elemento seleccionado, ¿a qué nos referimos?',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 3 de las aventuras de Koubot con 10 puntos y ' + score + ' estrellas de 5',
