...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Cuando tenemos un sitio web y al mismo tiempo lo dividimos en categorías o sub-sitios, estamos creando un...
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Cuando tenemos un sitio web y al mismo tiempo lo dividimos en categorías o sub-sitios, estamos creando un...',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
