...
$consultaEstrellasCurso = mysqli_query($conexion, "SELECT estrellas FROM estrellas_universidaddad WHERE id_capsula = '$id_capsula' AND id_alumno = '$id_user' AND id_curso = '$id_curso'");
...
if ($result_sql == 0) {
    $insertarEstrellas = mysqli_query($conexion, "INSERT INTO estrellas_universidaddad(id_capsula, id_alumno, estrellas, id_curso) VALUES ($id_capsula, $id_user, $estrellas, $id_curso)");
    $insertarEstrellaTabla =  mysqli_query($conexion, "INSERT INTO total_estrellas_universidaddad (estrellas, id_alumno) 
   VALUES ('$estrellas_a_insertar', '$id_user')");
    ...
    if ($estrellas_a_insertar > 0) {
        ...
        $actualizarEstrellasTabla = mysqli_query($conexion, "UPDATE total_estrellas_universidaddad SET estrellas = estrellas + '$estrellas_a_insertar' 
