...
<body onload="alert1()">
    ...
    <div class="titulo-gen3">
        <h5>
            Una carpeta se puede dividir en sub-carpetas si existen objetos que son de dos o más...
        </h5>
    </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Una carpeta se puede dividir en sub-carpetas si existen objetos que son de dos o más...',
                        imageUrl: "../img/loop.gif",
                        imageHeight: 320,
                        confirmButtonText: '¡Vamos!',
                        confirmButtonColor: '#85c42c',
    ...
    <script>
        ...
        function alertWin() {
            ...
            Swal.fire({
                title: '¡Perfecto!',
                text: 'Has completado el capitulo 1 de las aventuras de Koubot con 8 puntos y ' + score + ' estrellas de 5',
