...
<body onload="iniciarTiempo();">
				...
				<tr>
					...
					<td>
						<div class="horizontal">
							1. :hover aplicará un estilo cuando el usuario haga hover sobre el elemento especificado por el ______.
							<br><br>
							2. Es una pseudoclase en CSS que se utiliza para seleccionar elementos de un formulario que están siendo seleccionados por el usuario.
						</div>
					</td>
					<b style="margin-left: 160px;">Verticales:</b>
					<td>
						<div class="vertical">
							1. Pseudoclase que permite insertar contenido antes del contenido del elemento a través de la propiedad "content".
							<br><br>
							2. Pseudoclase que permite insertar contenido después del contenido del elemento a través de la propiedad "content".
							<br><br>
							3. Se utiliza como pseudoclase en CSS para seleccionar el primer elemento hijo de otro elemento.
							<br><br>
							4. Es una abreviatura para la pseudoclase ":read-only" en CSS. Esta pseudoclase se utiliza para seleccionar elementos de formulario que tienen el atributo "readonly".
						</div>
					</td>
				</tr>
			</table>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 6 + "&id_curso=" + 2; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		function verificar() {
			...
			if (palabra1.toLowerCase() == "first" && palabra2.toLowerCase() == "after" && palabra3.toLowerCase() == "select" && palabra4.toLowerCase() == "selector" && palabra5.toLowerCase() == "rdr" && palabra6.toLowerCase() == "before") {
				var xmlhttp = new XMLHttpRequest();

				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 6 + "&id_curso=" + 2; //cancatenation
				...
				if (palabra3.toLowerCase() != "select") {
				...
				if (palabra4.toLowerCase() != "selector") {
				...
				if (palabra6.toLowerCase() != "before") {
				...
				if (palabra1.toLowerCase() == "first") {
					palabra4_letra6.value = "t";
				}

				if (palabra2.toLowerCase() == "after") {
					palabra4_letra4.value = "e";
				}
				...
				if (palabra4.toLowerCase() == "selector") {
					palabra6_letra2.value = "e";
					palabra2_letra4.value = "e";
					palabra1_letra5.value = "t";
					palabra5_letra1.value = "r";
				}

				if (palabra5.toLowerCase() == "rdr") {
					palabra4_letra8.value = "r";
				}
