...
<body>
    <div class="body">
        <div class="container">
            <a href="../../../../../../rutas/ruta-ar-a.php"><button style="float: left;" class="btn-b" id="btn-cerrar-modalV"><i class="fas fa-reply"></i></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Con todo lo visto, ahora podrás contruir y programar un pequeño carrito.
                                    Consistira de dos pequeños motores dc en la parte de atras, una rueda loca
                                    al frente, y pequeño chasis de madera, plastico o material disponible para
                                    el alumno, donde se colocará el arduino, bateráas, protoboard, sensor
                                    ultrasónico, buzzer y LEDs.
                                    <br><br>
                                    El carrito se controlará a traves del teclado de la pc, y se detendrá si
                                    detecta un objeto a 10 cm o menos.
                                </p>
                            </td>
                            <td class="ne">
            ...
            <div class="">
                ...
                <div class="editor-container">
                    <div class="cd" id="editor">// Programación avanzada con Arduino</div>
                </div>
            </div>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd17.php?validar=' + 'correcto' + '&permiso=' + 17 + '&id_curso=' + 9 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd17.php?validar=' + 'incorrecto' + '&permiso=' + 17 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }
