...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Introducción 2 Arduino Intermedio</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        ...
                        <li style="background-image: url('../../img/CI5.gif');"></li>
                        <li style="background-image: url('../../img/CI55.gif');"></li>
                    </ul>
                </section>
        </div>
    </div>
