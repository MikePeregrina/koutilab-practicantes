            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ya sabes controlar LEDs como un pro, ahora aprenderar como se usa un boton,
                                    lo cual es tambien muy basico, pero necesario y util para los proyectos
                                    que vayas a hacer en el futuro.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AB-4.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'correcto' + '&permiso=' + 13 + '&id_curso=' + 7 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'incorrecto' + '&permiso=' + 13 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }
