...
<body>
  <div class="body">
    <div class="container">
      ...
      <div class="new-g" style="text-align: center;">Evaluación 3 Arduino Básico</div><br>
      <div class="quiz-wrapper">
        <hr>
        <p id="inform" class="question-description">Obtenga tantos puntajes como desee en el pequeño cuestionario de 2 preguntas. Arrastre y suelte las opciones en el cuadro de arriba.</p>
