...
<body>
  <div class="body">
    <div class="container">
      <a href="../../../../../../rutas/ruta-ar-b.php"><button style="float: left; position: relative" class="btn-b" id="btn-cerrar-modalV">
      ...
      setTimeout(() => {
        ...
        if (trasera1.innerHTML != trasera2.innerHTML) {
          ...
          if (total == 12) {
            ...
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 7; //cancatenation
