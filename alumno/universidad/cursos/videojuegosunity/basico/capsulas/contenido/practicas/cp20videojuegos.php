...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/basico/capsulas/contenido/teoricas/ct20videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crea tu menu de pausa y sube una captura de pantalla del resultado.
                                    <br> <br>
                                </p>
                            </td>
