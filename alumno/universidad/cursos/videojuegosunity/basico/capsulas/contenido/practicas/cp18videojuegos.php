...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/basico/capsulas/contenido/teoricas/ct18videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Con ayuda del script que se mostro anteriormente implementalo en tu proyecto y haz que la
                                    cámara rote horizontalmente con el movimiento del ratón y graba el resultado.
                                    <br> <br>
                                </p>
                            </td>
