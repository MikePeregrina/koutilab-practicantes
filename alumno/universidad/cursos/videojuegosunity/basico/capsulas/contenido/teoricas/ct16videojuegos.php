        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T16/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T16/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T16/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T16/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T16/5.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.1.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Utiliza herramientas y técnicas que involucran la creación de terrenos, creacion de un objeto y diseñar niveles?</h1>
                                    <div>
