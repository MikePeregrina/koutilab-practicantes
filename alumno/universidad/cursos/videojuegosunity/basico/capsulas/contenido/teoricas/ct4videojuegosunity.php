    ...
    <body>
        <div class="body">
            <div class="container">
                ...
                <div class="new-g" style="text-align: center;">Cápsula teórica 3.5 videojuegosunity</div><br>
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/videojuegosunity/T4/37.gif'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/38.gif');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/39.gif');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/40.gif');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/41.gif');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/42.gif');"></li>
                            <li>
                                <div>
            ...
            function comprueba() {
                if (checkbox1.checked) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../teoricas/ct4videojuegosunity.php';
                        }
                    });
