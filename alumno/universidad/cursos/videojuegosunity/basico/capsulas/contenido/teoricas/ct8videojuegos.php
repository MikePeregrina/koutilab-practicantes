        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T8/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T8/8.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd20.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son los Packages en Unity?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Son los errores de un proyecto
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Son una colección de archivos y datos de proyectos.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Son los errores de diseño
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            Es la colección de datos del juego.
                                        </label>
                                    </div>
