...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T2/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/8.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/9.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el nombre del archivo al descargar Unity?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">UnityHubSetup.exe</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Unityexe</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Unitydoc</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">HubUnity</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="5">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="10">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct2videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
