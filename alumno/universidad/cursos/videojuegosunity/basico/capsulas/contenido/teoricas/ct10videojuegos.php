        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T10/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T10/7.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd23.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para qué sirven las cámaras ?</h1>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox2">
                                            Capturan y muestran el mundo al jugador.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Para el servicio del juego.
                                        </label>
                                    </div>
                                    <div>
