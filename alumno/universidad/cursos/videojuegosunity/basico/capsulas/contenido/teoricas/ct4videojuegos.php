    ...
    <body>
        <div class="body">
            <div class="container">
                ...
                <div class="new-g" style="text-align: center;">Cápsula teórica 3.5 Videojuegos Unity</div><br>
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/videojuegosunity/T4/1.jpg'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/2.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/3.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/4.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/5.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/6.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/7.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunity/T4/8.jpg');"></li>
                            <li>
                                <div style="width:80%; margin-left:10%; ">
                                    <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd11.php">
                                        <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                        <h1>¿Qué es una interfaz?</h1>
                                        <div>
