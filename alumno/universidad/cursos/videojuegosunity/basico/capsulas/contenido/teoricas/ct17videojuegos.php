        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T17/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T17/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T17/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T17/4.jpg');"></li>

                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.3.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cómo puedes detectar colisiones en tu código?</h1>
                                    <div>
