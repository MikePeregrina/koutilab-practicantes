...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T1/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/6.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para que sirve Unity?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Permite crear juegos 3D y 2D en muchas plataformas.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Permite crear juegos para una sola plataforma.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Permite crear usuarios.</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Permite crear juegos de varios niveles.</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="2">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="10">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct1videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
