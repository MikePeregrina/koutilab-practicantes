        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T1/13.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/14.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/15.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/16.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/17.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/18.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T1/19.gif');"></li>
                        <li>
                            <div>
