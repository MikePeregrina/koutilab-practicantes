...
<!--fIN CAMBIOS -->
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="img/lvl1/parallax1-1-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-2-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-3-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-4-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-5-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-6-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-7-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/parallax1-8-0.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
		...
		function alert1() {
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					imageUrl: "img/parallax1.png",  //aqui va la imagen que se muestra
					imageHeight: 320,
