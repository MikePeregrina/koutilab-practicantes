...
<body onload="iniciarTiempo()">
	...
	<script>
		...
		var preguntas = [{
				num: 1,
				pregunta: "Se puede agragar barra de vida a un personaje en unity",
				opA: "No",
				opB: "Si",
				opC: "Tal vez",
				correcta: "B",
			...
			{
				num: 2,
				pregunta: "Una barra de vida es una  común en ___________ muchos juegos",
				opA: "caracteristica",
				opB: "Image",
				opC: "Vida",
				correcta: "A",
			...
			{
				num: 3,
				pregunta: "En Unity, puedes crear una barra de vida visualmente atractiva y ________ utilizando las características y herramientas proporcionadas por el motor de juego.",
				opA: "carateristica",
				opB: "Etiquetas",
				opC: "funcional",
				correcta: "C",
			...
			{
				num: 4,
				pregunta: "Crea un nuevo script llamado ______________ para manejar la lógica de la vida.",
				opA: "Juego",
				opB: "HealthManager",
				opC: "Barra",
				correcta: "B",
			...
			{
				num: 5,
				pregunta: "En el ______, define una variable para representar la vida actual y otra para la vida máxima.",
				opA: "CSS",
				opB: "SCRIP",
				opC: "JavaScript",
				correcta: "B",
			...
			{
				num: 6,
				pregunta: "Utiliza métodos para aumentar o disminuir la vida según los eventos y acciones del juego.",
				opA: "link",
				opB: "stylesheet",
				opC: "metodo",
				correcta: "C",
			...
			{
				num: 7,
				pregunta: "Asegúrate de tener un componente de imagen _________ en el lienzo de la interfaz de usuario para representar la barra de vida.",
				opA: "public",
				opB: "(UI Image)",
				opC: "link",
				correcta: "B",
			...
			{
				num: 8,
				pregunta: "En los eventos o acciones del juego donde la vida cambie, utiliza los métodos _________ o Heal del script HealthManager.",
				opA: "TakeDamage",
				opB: "Java",
				opC: "HTML",
				correcta: "A",
			...
			{
				num: 9,
				pregunta: "En el método ______________ del script HealthManager, calcula el porcentaje de vida actual en relación con la vida máxima.",
				opA: "fillAmount",
				opB: "TakeDamage",
				opC: "UpdateHealthBar",
				correcta: "C",
			...
			{
				num: 10,
				pregunta: "Utiliza este porcentaje para ajustar el valor de _____________ de la imagen de la barra de vida. Un valor de 1 representa la vida completa, y 0 representa la vida vacía.",
				opA: "var",
				opB: "fillAmount",
				opC: "UpdateHealthBar",
				correcta: "B",
