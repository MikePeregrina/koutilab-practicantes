...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>PATRULLAJE</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				...
				'<i><img src="/memorama/memorama/img/hqdefault (1).jpg"  width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/descargar (1).jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/descargar.jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/hqdefault.jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/images.jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/maxresdefault.jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/images (1).jpg" width= "50px"></i>',
				'<i><img src="/memorama/memorama/img/maxresdefault.jpg" width= "50px"></i>'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 11; //cancatenation
	...
	<script>
		...
		Correcto.src = "../../todos los juegos res/sonidos/correcto.mp3";
		var Incorrecto = document.createElement("audio");
		Incorrecto.src = "../../todos los juegos res/sonidos/incorrecto.mp3";
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 11; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_pd19.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
