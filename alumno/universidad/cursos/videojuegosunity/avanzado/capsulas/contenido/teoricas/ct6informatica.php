        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T6/47.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/48.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/49.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/50.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/51.gif');"></li>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct6videojuegosunity.php';
                    }
                });
