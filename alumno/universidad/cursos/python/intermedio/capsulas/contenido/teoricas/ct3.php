...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 3</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/CT5.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/CT555.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_pd8.php">
                                    <h2>Para poder avanzar, completa la siguiente tarea:.</h2>
                                    <h1>Resuelve algún ejercicio anterior</h1>
    ...
    <script>
        ...
        function miFunc() {
            ...
            let opciones = ['for i in range(1,10,2):\nprint(i)', 'for i in range(10,1,-1):\nprint(i)']
            let esCorrecto = opciones.includes(ta);
