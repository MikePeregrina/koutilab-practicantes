		...
		var preguntas = [
			{
				num: 1,
				pregunta:
					"En Python los argumentos pueden crearse a partir de...",
				opA: "Funciones",
				opB: "Palabras",
				opC: "Números",
				correcta: "A",
			...
			},
			{
				num: 2,
				pregunta:
					"Para crear un argumento, es necesario poder llenar una variable con un...",
				opA: "Tipo de dato",
				opB: "Argumento",
				opC: "Nombre",
				correcta: "A",
			...
			},
			{
				num: 3,
				pregunta:
					"Es importante asegurarse de darle a la función la información correcta en los argumentos para que pueda hacer su trabajo de manera efectiva",
				opA: "Falso",
				opB: "Verdadero",
				opC: "Tengo hambre",
				correcta: "B",
			...
			},
			{
				num: 5,
				pregunta:
					"a = 5 <br> b = 4 <br> suma = a + b <br> print(____)",
				opA: "a",
				opB: "b",
				opC: "suma",
				correcta: "C",
