...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h4 class="titulo" style="margin-left: 480px"><b>TUPLAS</b></h4>
    </div>
    ...
    <div class="contenido">
        <a href="../../../../../../rutas/ruta-py-i.php"><button style="
                        float: left;
                        position: relative;
                ...
                <tr>
                    ...
                    <td>
                        <div class="horizontal">
                            1. Es el lenguaje de programación que actualmente estamos trabajando.
                            <br /><br />
                            2. Se le llama _________ al elemento donde podemos guardar números, cadenas, tuplas y
                            cualquier cosa que ocupemos.
                            <br /><br />
                            <b style="margin-left: 66px" class="tituloV">Verticales:</b>
                            <div class="vertical">
                                1. Se le llama _____ al conjunto de datos acoplados dentro de paréntesis
                                que pueden ser agrupados dentro de una variable.
                                <br /><br />
                                2. Podemos acceder a un elemento dentro de una tupla usando...
                            </div>
                        </div>
                    </td>
        ...
        <div class="crucigrama" style="scale: 85%;">
            <div class="numero1" style="margin: 150px 0 0 110px">1.</div>
            <div class="numero2" style="margin: 40px 0 0 480px">2.</div>
            <div class="numero1-1" style="margin: -20px 0 0 155px">1.</div>
            <div class="numero2-2" style="margin: 410px 0 0 -20px">2.</div>
            <table id="crucigrama">
                <tr>
                    <td>
    ...
    <script>
        ...
        //Palabra tupla
        var palabra1_letra1 = document.getElementById("fila1C3");
        var palabra1_letra2 = document.getElementById("fila2C3");
        var palabra1_letra3 = document.getElementById("fila3C3");
        var palabra1_letra4 = document.getElementById("fila4C3");
        var palabra1_letra5 = document.getElementById("fila5C3");

        //Palabra python
        var palabra2_letra1 = document.getElementById("fila3C3");
        var palabra2_letra2 = document.getElementById("fila3C4");
        var palabra2_letra3 = document.getElementById("fila3C5");
        var palabra2_letra4 = document.getElementById("fila3C6");
        var palabra2_letra5 = document.getElementById("fila3C7");
        var palabra2_letra6 = document.getElementById("fila3C8");

        //Palabra indice
        var palabra3_letra1 = document.getElementById("fila2C8");
        var palabra3_letra2 = document.getElementById("fila3C8");
        var palabra3_letra3 = document.getElementById("fila4C8");
        var palabra3_letra4 = document.getElementById("fila5C8");
        var palabra3_letra5 = document.getElementById("fila6C8");
        var palabra3_letra6 = document.getElementById("fila7C8");
        ...
        var palabra4_letra8 = document.getElementById("fila7C8");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "tupla" &&
                palabra2.toLowerCase() == "python" &&
                palabra3.toLowerCase() == "indice" &&
                palabra4.toLowerCase() == "variable"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra3.toLowerCase() != "indice") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "variable") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "tupla") {
                    palabra2_letra1.value = "p";
                }

                if (palabra2.toLowerCase() == "python") {
                    palabra1_letra3.value = "p";
                    palabra3_letra2.value = "n";
                }

                if (palabra3.toLowerCase() == "indice") {
                    palabra2_letra6.value = "n";
                    palabra4_letra8.value = "e";
                }

                if (palabra4.toLowerCase() == "variable") {
                    palabra3_letra6.value = "e";
                }
            }
        }
    </script>
