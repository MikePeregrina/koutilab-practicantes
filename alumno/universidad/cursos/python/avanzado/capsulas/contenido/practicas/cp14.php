            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'incorrecto' + '&permiso=' + 37 + '&id_curso=' + 6 + '&practico=' + 10;
                    }
                });
            } else {
                correcto.play();
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'correcto' + '&permiso=' + 37 + '&id_curso=' + 6 + '&practico=' + 10;
                });
            }
        }
    </script>
