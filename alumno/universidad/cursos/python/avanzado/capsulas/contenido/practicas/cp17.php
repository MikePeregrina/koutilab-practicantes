            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'incorrecto' + '&permiso=' + 46 + '&id_curso=' + 6 + '&practico=' + 10;
                    }
                });
            } else {
                correcto.play();
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'correcto' + '&permiso=' + 46 + '&id_curso=' + 6 + '&practico=' + 10;
                });
            }
        }
    </script>
