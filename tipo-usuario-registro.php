...
<!-- Pregunta para tipo de usuario y su registro -->
...
<body onload="recuperarDatos()">
    ...
    <div class="container">
        ...
        <div class="form-box">
            ...
            <p class="preg">¿Qué tipo de usuario eres?</p>
            <div class="opt-user">
                <a href="./registro-ps.php">
            ...
            <div class="opt-user">
                <a href="#" onclick="history.back();">
                    <p style="width: 100px;">Regresar</p>
                </a>
            </div>
        </div>
