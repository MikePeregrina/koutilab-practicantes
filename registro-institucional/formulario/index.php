	...
	<div class="row">
		<div class="col-sm-8" style="scale: 110%; margin-top: 50px; width: 1000px; height: 450px; margin-left: 70px;">
			...
			<form id="register_form" style="padding: 30px;" novalidate action="multi_form_action.php" method="post" class="form">
				...
				<fieldset>
					<div class="form-group">
						<label for="nombre_e" class="text-f">Nombre de la institución</label>
				...
				<fieldset>
					<div class="form-group">
						<label for="grado">Número de docentes</label>
						<input type="text" class="form-control" name="grado" id="grado" placeholder="10">
					</div>
					<div class="form-group">
						<label for="numero_a" class="text-f">Número de alumnos (aproximado)</label>
