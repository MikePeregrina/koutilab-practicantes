...
$query = "SELECT a.nombre FROM alumnos_preparatoria a 
JOIN docentes_preparatoria d
ON a.id_alumno = d.id_docente
WHERE $id_user = d.id_docente";


$query_grupo = "SELECT nombre_grupo FROM grupos_preparatoria WHERE id_docente = $id_user";
...
$grupo = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT * FROM grupos_preparatoria WHERE id_docente = $id_user"));


//Conteo de alumnos
$sql = "SELECT COUNT(*) id_alumno FROM alumnos_preparatoria a 
JOIN docentes_preparatoria d
...
//Estadisticas
$query1 = mysqli_query($conexion, "SELECT * FROM estadisticas_preparatoria WHERE id_alumno = $id_user");
                ...
                <form id="contacto" method="POST" enctype="multipart/form-data" action="acciones/insertar_alumnos.php">
                    <div class="user-details1">
                        ...
                        <div class="input-box1">
                            ...
                            <input type="text" value="preparatoria" name="nivel_educativo" placeholder="Nivel educativo" required readonly>
                        </div>
                        <div class="input-box1">
        ...
        <div class="board p-2">
            <table id="alumnos" width="100%" class="table border-top" style="z-index: 1;">
                ...
                <tbody>
                    ...
                    $query_alumnos = mysqli_query($conexion, "SELECT a.id_alumno, a.nombre, a.grado_escolar, a.email FROM alumnos_preparatoria a
                JOIN docentes_preparatoria d
                ON a.id_docente = d.id_docente
