<?php
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['nombre']) || empty($_POST['grado_escolar'])) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE alumnos_preparatoria SET nombre = '$nombre', usuario = '$usuario', contrasena = '$contrasena', grado_escolar = '$gradoescolar' WHERE id_alumno = $idalumno");
    ...
    $sql = mysqli_query($conexion, "SELECT * FROM alumnos_preparatoria WHERE id_alumno = '$idalumno'");
    $result_sql = mysqli_num_rows($sql);
    //Seleccionar nombre del grupo
    $query = "SELECT nombre_grupo FROM grupos_preparatoria WHERE id_docente = $id_user";
