...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/89.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/90.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/91.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/92.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/c (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/c (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/c (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/c (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/c (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/c (6).png" height="60px" width="50px" >'
            ]
        }
