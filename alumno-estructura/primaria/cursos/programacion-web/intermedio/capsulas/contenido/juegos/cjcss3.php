...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Es la propiedad de texto que nos permite cambiar el tamaño del fuente. Pista: F_N_-S__E",
                respuesta: "font-size",
                respondida: false
            },
            {
                pregunta: "Es la propiedad de texto que nos permite cambiar el grosor de fuente como bold(negrita). Pista: F__T-W__GH_",
                respuesta: "font-weight",
                respondida: false
            },
            {
                pregunta: "Un tipo de familia se llama... Pista: Familia de f___T_S",
                respuesta: "fuentes",
                respondida: false
            },
            {
                pregunta: "Un tipo de familia se llama... Pista: Familia G__É_C_",
                respuesta: "genérica",
                respondida: false
            },
            {
                pregunta: "Estamos manejando propiedades de... Pista: T_X__S",
                respuesta: "textos",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 27 + "&id_curso=" + 2 + "&redireccion=" + '../contenido/juegos/cjcss3.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 27 + "&id_curso=" + 2 + "&redireccion=" + '../contenido/juegos/cjcss3.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
