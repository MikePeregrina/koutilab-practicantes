        ...
        function miFunc() {
            ...
            if (jscode.indexOf('const') !== -1 && jscode.toLowerCase().indexOf('pi') !== -1 && jscode.indexOf('3.1416') !== -1 && (jscode.indexOf('*2') !== -1 || jscode.indexOf('* 2') !== -1) && jscode.toLowerCase().indexOf('perimetro') !== -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp2js.php';
