        ...
        function miFunc() {
            ...
            if (table == 1 && tr == 3 && th == 5 && td == 5 && (htmlcode.indexOf('colspan="3"') !== -1 || htmlcode.indexOf('colspan= "3"') !== -1)) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp6html.php';
