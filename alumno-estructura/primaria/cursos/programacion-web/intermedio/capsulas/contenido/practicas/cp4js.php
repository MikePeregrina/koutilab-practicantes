        ...
        function miFunc() {
            ...
            if (jscode.indexOf('>') !== -1 && jscode.indexOf('<') !== -1 && jscode.indexOf('=') !== -1 && condicional >= 2 && alertas == 3) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp4js.php';
