        ...
        function miFunc() {
            ...
            if (ul > 0 && ol > 0 && li > 0 && bold > 0 && h1 > 0) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS; + '&redireccion=' + '../contenido/practicas/cp3html.php'
