        ...
        function miFunc() {
            ...
            if (body > 0 && csscode.indexOf('body') !== -1 && csscode.indexOf('background') != -1 && csscode.indexOf('right repeat-y') != -1 && csscode.indexOf('left repeat-y') != -1 && csscode.indexOf('url') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 2 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp2css.php';
