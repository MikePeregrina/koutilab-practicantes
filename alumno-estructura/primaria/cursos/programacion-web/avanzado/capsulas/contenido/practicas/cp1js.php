        ...
        function miFunc() {
            ...
            if (inputext > 0 && button > 0 && jscode.indexOf('getElementById') != -1 && jscode.indexOf('var') != -1 && jscode.indexOf('window.location.href') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp1js.php';
