        ...
        function miFunc() {
            ...
            if (table > 0 && thead > 0 && tr > 0 && th > 0 && tbody > 0 && csscode.indexOf('background-color') != -1 && csscode.indexOf('color') != -1 && csscode.indexOf('border') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp4css.php';
