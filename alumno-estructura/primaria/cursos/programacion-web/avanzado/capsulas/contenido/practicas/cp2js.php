<?php
session_start();
$id_user = $_SESSION['id_alumno_primaria']; $rol = $_SESSION['rol'];
        ...
        function miFunc() {
            ...
            if (button > 0 && jscode.indexOf('function') != -1 && jscode.indexOf('var') != -1 && jscode.indexOf('alert') != -1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 3 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp2js.php';
