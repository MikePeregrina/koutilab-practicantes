            ...
            <div class="container">
                ...
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/apps-moviles/1/T4/23.gif'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/apps-moviles/1/T4/24.gif');"></li>
                            <li style="background-image: url('../../img/apps-moviles/1/T4/25.gif');"></li>
