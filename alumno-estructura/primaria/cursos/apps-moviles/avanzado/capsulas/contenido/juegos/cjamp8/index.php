...
<body onload="alert1()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>FUNCIONALIDADES AVANZADAS: PORCENTAJE, RAÍZ CUADRADA Y POTENCIACIÓN</b></h2>
	</div>
	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-0-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-1-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-2-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-0-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-1-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-2-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-0-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/lvl1/img1-1-2.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire({
						...
						imageUrl: "../../../img/img-juegos/lvl1/img1.png",
						imageHeight: 320,
