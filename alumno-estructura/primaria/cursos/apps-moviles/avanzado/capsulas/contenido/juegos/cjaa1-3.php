...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>VISTA Y EXPLICACION DEL LAYOUT</b></h2>
    </div>
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("ESTETICA");
        palabras_array.push("LAYOUT");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "ESTETICA": // Se debera hacer un case por cada palabra
                    pista = "El 'layout' determina la apariencia visual de la aplicación, lo que influye en la percepción del usuario y la impresión general.";
                    break; // Es importante el break en cada case
                case "LAYOUT":
                    pista =
                        "Es la representación gráfica de cómo se colocan los elementos en un espacio determinado..";
                    break;
