...
<body onload="iniciarTiempo()">
  ...
  <div class="titulo-gen">
    <h2 class="titulo"><b>EDITANDO NUESTRA LAYOUT Y CREANDO UNA CELDA</b></h2>
  </div>
  ...
  <section>
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "En que vista  navegas a la carpeta 'java' > 'tu.paquete.app' (reemplaza 'tu.paquete.app' con el nombre real de tu paquete). Pista: P _ _  J _ _ T",
                respuesta: "project",
                respondida: false
            },
            {
                pregunta: "Dale un nombre a tu clase, por ejemplo, 'MyListAdapter', y asegúrate de que 'Kind' esté configurado en 'C _ L _ _ S'.",
                respuesta: "class",
                respondida: false
            },
            {
                pregunta: "En la sección 'S _ P _ _ C _ A _ S', selecciona androidx.recyclerview.widget.RecyclerView.Adapter.",
                respuesta: "superclass", 
                respondida: false
            },
            {
                pregunta: "(UI) Interfaz de _ _ U _ _ _ O .",
                respuesta: "usuario",
                respondida: false
            },
            {
                pregunta: "Puedes editar el diseño según tus necesidades. Por ejemplo, puedes agregar un T _ _ T _ _ _ W y un Button dentro de un LinearLayout",
                respuesta: "textview",
                respondida: false
            }
        ];
