...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>DIAGRAMA(MOCKUPS) </b></h2>
    </div>
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("INICIAL");
        palabras_array.push("MOCKUP");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "INICIAL": // Se debera hacer un case por cada palabra
                    pista = "¿En que fase se desarrollan los mockups?.";
                    break; // Es importante el break en cada case
                case "MOCKUP":
                    pista =
                        "Es un diagrama que representa visualmente la app.";
                    break;
