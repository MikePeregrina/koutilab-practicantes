...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>PATRONES GENERALES</b></h2>
    </div>
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("BUSQUEDA");
        palabras_array.push("NAVEGACION");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "BUSQUEDA": // Se debera hacer un case por cada palabra
                    pista = "¿Que patron se refiere a como los usuarios pueden investigar y encontrar informacion?.";
                    break; // Es importante el break en cada case
                case "NAVEGACION":
                    pista =
                        "¿Que patron se refiere a como los usuarios pueden cruzar a traves de distintas secciones o pantallas de una app?.";
                    break;
