...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("NATIVAS");
        palabras_array.push("HIBRIDAS");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "NATIVAS": // Se debera hacer un case por cada palabra
                    pista = "Aumenta la experiencia de usuario, velocidad de ejecucion, funcionamiento offline.";
                    break; // Es importante el break en cada case
                case "HIBRIDAS":
                    pista =
                        "Menor inversion que una App Nativa, la desventaja esta en la dificultad para su distribucion .";
                    break;
