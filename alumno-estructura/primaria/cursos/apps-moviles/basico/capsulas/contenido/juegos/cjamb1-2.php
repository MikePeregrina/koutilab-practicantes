...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("LINUX");
        palabras_array.push("WINDOWS");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "LINUX": // Se debera hacer un case por cada palabra
                    pista = "Sistema basado en Unix.";
                    break; // Es importante el break en cada case
                case "WINDOWS":
                    pista =
                        "Todos los virus como los troyanos estan diseñado para atacarlo.";
                    break;
