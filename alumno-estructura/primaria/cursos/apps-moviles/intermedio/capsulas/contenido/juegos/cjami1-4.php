...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>PARTES DE LA INTERFAZ DE ANDROID STUDIO</b></h2>
    </div>
    <div class="cont-st">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("DEPURACION");
        palabras_array.push("MENU");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "DEPURACION": // Se debera hacer un case por cada palabra
                    pista = " Las diversas secciones de la interfaz facilitan la navegación, el diseño de interfaces de usuario, la escritura de código y la?.";
                    break; // Es importante el break en cada case
                case "MENU":
                    pista =
                        "En esta barra se encuentran opciones y herramientas para administrar proyectos, editar código, compilar y ejecutar aplicaciones.";
                    break;
