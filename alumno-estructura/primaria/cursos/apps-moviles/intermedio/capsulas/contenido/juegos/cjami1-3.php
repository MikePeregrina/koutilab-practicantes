...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>WINDOWS: COMO DESCARGAR E INSTALAR ANDROID STUDIO</b></h2>
	</div>
	...
	<section>
		...
		<h5 class="titulo" style="margin-top: -90px;"><b>Usa las flechas para ayudar a Koubot a llegar hasta su cohete espacial</b></h5>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 1 + "&redireccion=" + '../contenido/juegos/cjhtml6.php'; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		function displayVictoryMess(moves) {
			...
			var xmlhttp = new XMLHttpRequest();
			var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 1 + "&redireccion=" + '../contenido/juegos/cjhtml6.php'; //cancatenation
			xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
			xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			xmlhttp.send(param);
			Swal.fire({
