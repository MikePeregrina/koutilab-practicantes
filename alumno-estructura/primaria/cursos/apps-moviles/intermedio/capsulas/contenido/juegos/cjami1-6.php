...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("AVANZADA");
        palabras_array.push("REFERENCIAS");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "AVANZADA": // Se debera hacer un case por cada palabra
                    pista = "Este tipo de busqueda tiene opciones y ajustes adicionales.";
                    break; // Es importante el break en cada case
                case "REFERENCIAS":
                    pista =
                        "Este tipo de busqueda  encuentra usos relacionados.";
                    break;
