...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("ESPECIALES");
        palabras_array.push("UNICODE");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "ESPECIALES": // Se debera hacer un case por cada palabra
                    pista = "Estos caracteres a menudo se utiluizan para representar espacios en blanco, caracteres de escape y otros?.";
                    break; // Es importante el break en cada case
                case "UNICODE":
                    pista =
                    "KOTLIN admite representacion de caracteres utilizando la sinntaxis '/oxxx'.";
                    break;
