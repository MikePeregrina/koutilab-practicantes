            ...
            <div class="container">
                ...
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/apps-moviles/1/T4/25.gif'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/apps-moviles/1/T4/26.gif');"></li>
                            <li style="background-image: url('../../img/apps-moviles/1/T4/27.gif');"></li>
                            <li>
                                <!-- Copiar de aqui -->
                                <div class="mjuego">
                            ...
                            <li style="background-image: url('../../img/apps-moviles/1/T4/28.gif');"></li>
                            <li style="background-image: url('../../img/apps-moviles/1/T4/29.gif');"></li>
                            <li>
                                <div>
