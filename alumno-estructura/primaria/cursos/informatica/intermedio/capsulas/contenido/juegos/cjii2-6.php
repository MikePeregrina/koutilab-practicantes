    ...
    <section>
        ...
        <div class="container-all">
            ...
            <div class="left-column">
                ...
                <div class="word-box" id="atajo">Imágenes</div>
                <div class="word-box" id="temporal">Tablas</div>
                <div class="word-box" id="mensaje">Gráficos</div>
                <div class="word-box" id="renviar">Formas</div>
                <div class="word-box" id="arrastrar">Cuadros de texto</div>
            </div>
            ...
            <div class="right-column">
                <!-- Respuestas -->
                <div class="word-box" id="borrar" onclick="checkAnswer('borrar')"><i class="fas fa-chart-line fa-lg"></i></div>
                <div class="word-box" id="recuperar" onclick="checkAnswer('recuperar')"><i class="fas fa-circle fa-lg"></i></div>
                <div class="word-box" id="mover" onclick="checkAnswer('mover')"><i class="fas fa-text-height fa-lg"></i></div>
                <div class="word-box" id="portapapeles" onclick="checkAnswer('portapapeles')"><i class="fas fa-table fa-lg"></i></div>
                <div class="word-box" id="copiar" onclick="checkAnswer('copiar')"><i class="fas fa-image fa-lg"></i></div>
            </div>
        </div>
