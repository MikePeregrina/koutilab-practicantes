            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una variable llamada "texto" y asígnale una cadena de texto como valor. Luego, imprime el valor de la variable y su tipo de datos.
                                </p>
                            </td>
                            <td class="ne">
...
>>>>>>> ab0d9f83dd8aa5fe045d17edeb827cffa8330373
    ...
    <script>
        ...
        function miFunc() {
            ...
            // alert(val[2]+" "+val[3]);
            // let esCorrecto = ta == '1\n2\n3\ntexto = "Hola, mundo!"\nprint("El texto es:", texto)\nprint("El tipo de datos de texto es:", type(texto))';
