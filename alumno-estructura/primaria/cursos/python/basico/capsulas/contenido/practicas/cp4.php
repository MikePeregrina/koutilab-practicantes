...
if (empty($existe)) {
    header("Location: ../../../../contenido/alertas/paquete_premium2.php");
}
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Intenta utilizar una palabra reservada como nombre de variable. Crea una variable llamada "for" y asígnale el valor 5. Luego, intenta imprimir el valor de la variable.
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'incorrecto' + '&permiso=' + 12 + '&id_curso=' + 4 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp4.php?validar=' + 'correcto' + '&permiso=' + 12 + '&id_curso=' + 4 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
