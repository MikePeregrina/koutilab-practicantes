...
if (empty($existe)) {
    header("Location: ../../../../contenido/alertas/paquete_premium1.php");
}
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Escribe una declaración condicional que verifique si el valor de la variable "x" es mayor que 7. Si es así, muestra en pantalla "x es mayor que 7"; de lo contrario, muestra "x es menor o igual que 7".
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp2.php?validar=' + 'incorrecto' + '&permiso=' + 6 + '&id_curso=' + 4 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp2.php?validar=' + 'correcto' + '&permiso=' + 6 + '&id_curso=' + 4 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
