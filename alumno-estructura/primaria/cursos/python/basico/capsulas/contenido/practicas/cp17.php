...
<body>
    <div class="body">
        <div class="container">
            <a href="../../../../../../rutas/ruta-py-b-<?php echo $rol;?>.php" ><button style="float: left;" class="btn-b" id="btn-cerrar-modalV"><i class="fas fa-reply"></i></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Utiliza una estructura "if-else" para verificar si el número es positivo. Si es así, imprime "El número es positivo"; de lo contrario, imprime "El número es negativo".
                                </p>
                            </td>
                            <td class="ne">
