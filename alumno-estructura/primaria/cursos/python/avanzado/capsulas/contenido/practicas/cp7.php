                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="ne">
                            fh = open("mi_archivo.txt") <br>
                                for linea in fh.readlines(): <br>
                                    &nbsp;&nbsp;&nbsp;&nbsp;print(linea) <br>
                                    &nbsp;&nbsp;&nbsp;&nbsp;fh.close()
                            </td>
                        </tr>
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                         window.location.href = '../../acciones/insertar_practica.php?validar=' + 'incorrecto' + '&permiso=' + <?php echo $permiso_intento; ?> + '&id_curso=' + 6 + '&practico=' + 10 + '&htmlcode=' + encodeHTML + '&csscode=' + encodeCSS + '&jscode=' + encodeJS + '&redireccion=' + '../contenido/practicas/cp7.php';
                    }
                });
            } else {
