...
<body>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 48 + "&id_curso=" + 9 + "&redireccion=" + '../contenido/juegos/cjia2-7.php'; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		function displayVictoryMess(moves) {
			...
			var xmlhttp = new XMLHttpRequest();
			var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 48 + "&id_curso=" + 9 + "&redireccion=" + '../contenido/juegos/cjia2-7.php'; //cancatenation
			xmlhttp.open("POST", "../../acciones/insertar_pd47.php", true);
			xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			xmlhttp.send(param);
			Swal.fire({
