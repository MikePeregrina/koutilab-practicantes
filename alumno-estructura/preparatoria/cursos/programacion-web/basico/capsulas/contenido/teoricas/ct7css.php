        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T7/98.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T7/99.gif');"></li>
                        <li style="background-image: url('../../img/css/T7/100.gif');"></li>
                        <li>
                            <!-- Acoplado -->
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/css/T7/101.gif');"></li>
                        <li>
                            <div>
