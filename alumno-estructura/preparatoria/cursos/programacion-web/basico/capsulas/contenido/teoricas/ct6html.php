...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T6/41.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T6/42.gif');"></li>
                        <li style="background-image: url('../../img/html/T6/43.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/html/T6/44.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        var words = ['VIDEO', 'LLAVES', 'HTML', 'CONTROLS'];
