        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P2/T3/81.gif'); z-index:0; opacity: 1;"></li>
                        ...
                        <li style="background-image: url('../../../img/P2/T3/84.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T3/85.gif');"></li>
                        <li>
                            <div>
