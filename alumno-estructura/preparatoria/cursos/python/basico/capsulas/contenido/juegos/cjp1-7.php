...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 22 + "&id_curso=" + 4 + "&redireccion=" + '../contenido/juegos/cjp1-7.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("TRUE");
        palabras_array.push("FALSE");
        palabras_array.push("RELACIONALES");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "TRUE": // Se debera hacer un case por cada palabra
                    pista = "Es el valor que se devuelve cuando el resultado es verdadero";
                    break; // Es importante el break en cada case
                case "FALSE": // Se debera hacer un case por cada palabra
                    pista = "Es el valor que se devuelve cuando el resultado es falso";
                    break; // Es importante el break en cada case
                case "RELACIONALES": // Se debera hacer un case por cada palabra
                    pista = "El tema que actualmente se llama operadores...";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 22 + "&id_curso=" + 4 + "&redireccion=" + '../contenido/juegos/cjp1-7.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
