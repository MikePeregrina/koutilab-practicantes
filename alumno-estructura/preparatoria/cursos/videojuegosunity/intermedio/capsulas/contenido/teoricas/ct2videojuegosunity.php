        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T2/13.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T2/14.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T2/15.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T2/16.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T2/17.gif');"></li>
                        <li>
                            <div>
