        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T6/105.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T6/106.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T6/107.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T6/108.gif');"></li>
                        <li>
                            <div>
