...
$id_user = $_SESSION['id_alumno_preparatoria'];
$permiso = "capsula22";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 11");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 8 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/52.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/53.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/54.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="menu">Menu</div>
                                        <div class="word-box" id="mensaje">Mensaje</div>
                                        <div class="word-box" id="asunto">Asunto</div>
                                        <div class="word-box" id="copiar">Copiar</div>
                                        <div class="word-box" id="tecla">Tecla</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="direccion" onclick="checkAnswer('direccion')">
                                            Direccion</div>
                                        <div class="word-box" id="informacion" onclick="checkAnswer('informacion')">
                                            Informacion</div>
                                        <div class="word-box" id="contextual" onclick="checkAnswer('contextual')">
                                            Contextual
                                        </div>
                                        <div class="word-box" id="descripcion" onclick="checkAnswer('descripcion')">Descripcion
                                        </div>
                                        <div class="word-box" id="mayus" onclick="checkAnswer('mayus')">
                                            Mayus</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/55.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/56.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/57.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct9videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'contextual' &&
                palabraseleccionada.id !== 'informacion' &&
                palabraseleccionada.id !== 'descripcion' &&
                palabraseleccionada.id !== 'direccion' &&
                palabraseleccionada.id !== 'mayus'
            ) {
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'contextual' && idPalabraSeleccionada === 'menu') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'informacion' && idPalabraSeleccionada === 'mensaje') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === 'descripcion' && idPalabraSeleccionada === 'asunto'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'direccion' && idPalabraSeleccionada === 'copiar'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'mayus' && idPalabraSeleccionada === 'tecla'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
