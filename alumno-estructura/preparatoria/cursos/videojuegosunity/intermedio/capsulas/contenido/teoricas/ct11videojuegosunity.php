...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T1/68.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T1/69.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T1/70.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T1/71.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuándo nació Microsoft Word ?</h1>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/w (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/w (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/w (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/w (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/w (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/w (6).png" height="60px" width="50px" >'
            ]
        }
