...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T3/78.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T3/79.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T3/80.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="filas">Filas</div>
                                        <div class="word-box" id="columnas">Columnas</div>
                                        <div class="word-box" id="estructura">Estructura</div>
                                        <div class="word-box" id="organizar">Organizar</div>
                                        <div class="word-box" id="alinear">Alinear</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="horizontal" onclick="checkAnswer('horizontal')">
                                            Horizontal</div>
                                        <div class="word-box" id="rectangular" onclick="checkAnswer('rectangular')">
                                            Rectangular</div>
                                        <div class="word-box" id="vertical" onclick="checkAnswer('vertical')">
                                            Vertical
                                        </div>
                                        <div class="word-box" id="datos" onclick="checkAnswer('datos')">Datos
                                        </div>
                                        <div class="word-box" id="contenido" onclick="checkAnswer('contenido')">
                                            Contenido</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T3/81.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el propósito principal de utilizar tablas en Word según el texto?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Organizar y presentar información en filas y columnas.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox4">
                                            Alinear contenido en el documento.
                                        </label>
                                    </div>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'horizontal' &&
                palabraseleccionada.id !== 'vertical' &&
                palabraseleccionada.id !== 'rectangular' &&
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'horizontal' && idPalabraSeleccionada === 'filas') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'vertical' && idPalabraSeleccionada === 'columnas') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === 'rectangular' && idPalabraSeleccionada === 'estructura'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'datos' && idPalabraSeleccionada === 'organizar'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'contenido' && idPalabraSeleccionada === 'alinear'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
