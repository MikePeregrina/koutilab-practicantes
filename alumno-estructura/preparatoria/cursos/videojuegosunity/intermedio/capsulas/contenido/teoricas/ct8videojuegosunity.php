...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T7/46.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T7/47.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T7/48.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T7/49.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T7/50.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct8videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        var words = ['REDACTAR', 'CORREO', 'MENSAJE', 'BANDEJA'];
