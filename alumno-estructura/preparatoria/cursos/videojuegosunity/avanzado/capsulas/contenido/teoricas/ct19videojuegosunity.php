        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T7.5/110.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T7.5/111.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T7.5/112.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T7.5/113.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T7.5/114.gif');"></li>
                        <li>
                            <div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('evaluar').submit();
                        window.location.href = '../teoricas/ct19videojuegosunity.php';
                    }
                });
