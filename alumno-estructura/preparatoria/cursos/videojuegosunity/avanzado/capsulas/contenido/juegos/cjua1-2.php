...
<body onload="iniciarTiempo()">
  ...
  <div class="cont-st">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("VELOCIDAD");
        palabras_array.push("CORRIENDO");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "VELOCIDAD": // Se debera hacer un case por cada palabra
                    pista = "¿Si añadimos a FixedUpdate una condición puede  que triplique la?.";
                    break; // Es importante el break en cada case
                case "CORRIENDO":
                    pista =
                        "¡En cuanto a las animaciones, debemos tener en cuenta que nuestro jugador pasará de andando a?";
                    break;
