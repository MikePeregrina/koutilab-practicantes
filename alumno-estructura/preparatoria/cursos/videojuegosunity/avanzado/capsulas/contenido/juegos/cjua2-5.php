    ...
    <script>
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "SCROLL": // Se debera hacer un case por cada palabra
                    pista = "Se puede ajustar la velocidad del _____ de un fondo en una escena 2D.";
                    break; // Es importante el break en cada case
                case "FONDO":
                    pista =
                        "Adjunta el script 'AumentoVelocidadScroll' a tu objeto que se desplaza, como un _____.";
                    break;
