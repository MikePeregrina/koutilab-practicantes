...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/sopa-letras.css">
...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>PANTALLAS DE INICIO DE SESIÓN</b></h2>
	</div>
	...
	<script>
		...
		var words = ['KOTLIN', 'MANTENIMIENTO', 'APPS', 'PANTALLAS', 'MOVILES', 'INICIO', 'PROGRAMACION', 'SESION'];
