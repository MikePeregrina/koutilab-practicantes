...
if (!isset($_SESSION['actualizacion_realizada_vjin'])) {
    ...
    $_SESSION['actualizacion_realizada_vjin'] = true;
}
?>
<!DOCTYPE html>
    ...
    <section>
        <div class="main-content">
            ...
            <div class="snake">
                ...
                <!-- EVALUATIVA CSS -->
                <a href="../cursos/videojuegosunity/intermedio/capsulas/contenido/evaluativas/ce2css.php"><button onmouseover="playHoverSound()" onclick="playClickSound()" onmousedown="playClickSound()" onmouseover="playHoverSound()" onclick="playClickSound()" class="btn64" id="eva" <?php echo 'style="' . (($existe_capsula51 > 0) ? 'opacity: 1;' : 'opacity: 0.5; ') . '"'; ?>></button></a><!--Capsula evaluativas videojuegosunity-->
            </div>
        </div>
    </section>
