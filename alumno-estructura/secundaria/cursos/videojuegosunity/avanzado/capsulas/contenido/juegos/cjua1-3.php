...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>DESLIZAR DASH</b></h2>
    </div>
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Puedes crea un S _ R _ _ T llamado DeslizarDash y adjúntalo al objeto que realizará el deslizamiento.",
                respuesta: "script",
                respondida: false
            },
            {
                pregunta: "Dentro del script, necesitarás definir algunas V A _ _ A _ L _ S para controlar el deslizamiento.",
                respuesta: "variables",
                respondida: false
            },
            {
                pregunta: "¿Se utiliza la tecla de E _ P _ _ _ O (KeyCode.Space) para activar el dash?",
                respuesta: "espacio", 
                respondida: false
            },
            {
                pregunta: "Puedes tener una variable para la V _ L _ _ I _ _ D del dash",
                respuesta: "velocidad",
                respondida: false
            },
            {
                pregunta: "¿En donde puedes crear un deslizamiento con dash (rápido desplazamiento). Pista: U _ _ _ Y ?",
                respuesta: "unity",
                respondida: false
            }
        ];
