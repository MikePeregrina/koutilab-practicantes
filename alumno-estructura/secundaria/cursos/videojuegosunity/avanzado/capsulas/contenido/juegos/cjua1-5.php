...
<body onload="iniciarTiempo()">
  ...
  <div class="cont-st">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("RIGIDBODY");
        palabras_array.push("SUELO");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "RIGIDBODY": // Se debera hacer un case por cada palabra
                    pista = "¿Para que el Jugador pueda saltar, bastaría con aplicar una fuerza vertical a su?";
                    break; // Es importante el break en cada case
                case "SUELO":
                    pista =
                        "¿Lo primero que debemos hacer es seleccionar el tilemap Suelo y crear y a añadirle una nueva etiqueta o tag llamada?";
                    break;
