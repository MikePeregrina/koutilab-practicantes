...
function checkAnswer(respuesta) {
  ...
  if (palabraseleccionada) {
    ...
    if (respuesta === "incompatibilidad" && idPalabraSeleccionada === "embed") {
      ...
      contexto.stroke();
      respuestasCorrectas++;
    } else if (respuesta === "data" && idPalabraSeleccionada === "object") {
      palabraseleccionada.classList.add("correcto");
      contexto.beginPath();
      contexto.lineWidth = 3;
      contexto.strokeStyle = "#84c42c";
      ...
      respuesta === "archivo" &&
      idPalabraSeleccionada === "readfile"
    ) {
      palabraseleccionada.classList.add("correcto");
      contexto.beginPath();
      contexto.lineWidth = 3;
  ...
  if (todasSeleccionadas) {
    if (respuestasCorrectas < 3) {
      ...
      var param =
        ...
        13 +
        "&redireccion=" +
        "../contenido/juegos/cjhtml7.php"; //cancatenation
