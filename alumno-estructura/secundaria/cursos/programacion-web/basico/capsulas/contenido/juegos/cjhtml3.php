...
&ltli&gt No ingresar con alimentos &lt/li&gt &lt/ol&gt`;
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 10 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml3.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            if (text1 === text2) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 10 + "&id_curso=" + 13 + "&redireccion=" + '../contenido/juegos/cjhtml3.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
