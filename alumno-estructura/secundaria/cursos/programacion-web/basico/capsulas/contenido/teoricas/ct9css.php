        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T8/103.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T8/104.gif');"></li>
                        <li style="background-image: url('../../img/css/T8/105.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/css/T8/106.gif');"></li>
                        <li>
                            <div>
