...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Es lo que se encargar de repetir un bloque de código de forma iterativa las veces que sea necesario. Pista: B___L_",
                respuesta: "bucles",
                respondida: false
            },
            {
                pregunta: "El tema que estamos viendo es estructuras...",
                respuesta: "iterativas",
                respondida: false
            },
            {
                pregunta: "El lenguaje de programación que actualmente estamos viendo es...",
                respuesta: "python",
                respondida: false
            },
            {
                pregunta: "Así como tenemos bucles fijos o con condiciones ordenadas, también tenemos bucles con múltiples... Pista: C__D___O_E_",
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 42 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp2-6.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 42 + "&id_curso=" + 16 + "&redireccion=" + '../contenido/juegos/cjp2-6.php'; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
