        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T1.5/70.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T1.5/71.gif');"></li>
                        <li style="background-image: url('../../img/2/T1.5/72.gif');"></li>
                        <li style="background-image: url('../../img/2/T1.5/73.gif');"></li>
                        <li style="background-image: url('../../img/2/T1.5/74.gif');"></li>
                        <li style="background-image: url('../../img/2/T1.5/75.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_ct2css.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">position</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">relative</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">absolute</label>
                                    </div>
                                    <div class="container-question">
