        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T5.5/158.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T5.5/159.gif');"></li>
                        <li style="background-image: url('../../img/3/T5.5/160.gif');"></li>
                        <li style="background-image: url('../../img/3/T5.5/161.gif');"></li>
                        <li style="background-image: url('../../img/3/T5.5/162.gif');"></li>
                        <li>
                            <div>
