...
<body onload="iniciarTiempo();">
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="horizontal">
                                1. Propiedad de CSS que ocupamos para posicionar un objeto
                                <br /><br />
                                2. Es la etiqueta de HTML que ocupamos para hacer el pie de página
                                <br /><br />
                                <b class="tituloV">Verticales:</b>
                                <div class="vertical">
                                    1. Es el lenguaje de cascada de estilos que estamos aprendiendo a usar
                                    <br /><br />
                                    2. Es la propiedad de CSS que nos permite posicionar un objeto con respecto a su posición que tiene debajo. Pista: Es lo contrario de top
                                </div>
                            </div>
                        </td>
            ...
            <div class="crucigrama">
                <div class="numero1" style="margin: -60px 0 0 -500px;">1.</div>
                <div class="numero2" style="margin: 180px 0 0 -260px;">2.</div>
                <div class="numero1-1" style="margin: -380px 0 0 -180px;">1.</div>
                <div class="numero2-2" style="margin: -380px 0 0 60px;">2.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
    ...
    <script>
        ...
        var palabra3_letra2 = document.getElementById("fila5C4");
        var palabra3_letra3 = document.getElementById("fila5C5");
        var palabra3_letra4 = document.getElementById("fila5C6");
        var palabra3_letra5 = document.getElementById("fila5C7");
        var palabra3_letra6 = document.getElementById("fila5C8");

        //Palabra bottom
        var palabra4_letra1 = document.getElementById("fila1C5");
        var palabra4_letra2 = document.getElementById("fila2C5");
        var palabra4_letra3 = document.getElementById("fila3C5");
        var palabra4_letra4 = document.getElementById("fila4C5");
        var palabra4_letra5 = document.getElementById("fila5C5");
        var palabra4_letra6 = document.getElementById("fila6C5");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "css" &&
                palabra2.toLowerCase() == "position" &&
                palabra3.toLowerCase() == "footer" &&
                palabra4.toLowerCase() == "bottom"
            ) {
                Swal.fire({
                    title: "¡Bien hecho!",
                    ...
                    if (result.isConfirmed) {
                        window.location.href = './plataforma-pwa/acciones/insertar_ep1.php?id_capsula=' + 6 + '&id_curso=' + 3 + '&estrellas=' + 15;
                    }
                });
                ...
                if (palabra3.toLowerCase() != "footer") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "bottom") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "css") {
                    palabra2_letra3.value = "s";
                }

                if (palabra2.toLowerCase() == "position") {
                    palabra1_letra3.value = "s";
                    palabra4_letra3.value = "t";
                }

                if (palabra3.toLowerCase() == "footer") {
                    palabra4_letra5.value = "o";
                }
