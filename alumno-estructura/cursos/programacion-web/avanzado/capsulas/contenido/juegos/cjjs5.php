...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>DECLARACIÓN Y LLAMADA DE FUNCIONES</b></h2>
	</div>
	...
	<script>
		...
		var words = ['HTML', 'CSS', 'JAVASCRIPT', 'FUNCTION', 'RETURN', 'VARIABLE', 'CONST', 'RESULTADO'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 4 + "&id_curso=" + 3 + "&redireccion=" + '../contenido/juegos/cjhtml1.php'; //cancatenation
