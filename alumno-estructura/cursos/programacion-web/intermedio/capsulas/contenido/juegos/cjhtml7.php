...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h4 class="titulo"><b>CARACTERÍSTICAS DE ACCESIBILIDAD WEB</b></h4>
	</div>
	<section>
	...
	<script>
		...
		var words = ['HTML', 'WEB', 'HEADER', 'ACCESIBILIDAD', 'NAV', 'SECTION', 'FOOTER', 'ASIDE'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 41 + "&id_curso=" + 2 + "&redireccion=" + '../contenido/juegos/cjjs2.php'; //cancatenation
