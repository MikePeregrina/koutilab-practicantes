        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T4.5/118.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T4.5/119.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/120.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/121.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/122.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/123.gif');"></li>
                        <li>
                            <div>
