        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T2/167.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T2/168.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/169.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/170.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/171.gif');"></li>
                        <li style="background-image: url('../../img/3/T2/172.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="51">
