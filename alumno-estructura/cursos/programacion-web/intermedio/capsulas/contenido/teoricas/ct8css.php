        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T6/132.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T6/133.gif');"></li>
                        <li style="background-image: url('../../img/2/T6/134.gif');"></li>
                        <li style="background-image: url('../../img/2/T6/135.gif');"></li>
                        <li style="background-image: url('../../img/2/T6/136.gif');"></li>
                        <li style="background-image: url('../../img/2/T6/137.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct8css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
