        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T4/181.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T4/182.gif');"></li>
                        <li style="background-image: url('../../img/3/T4/183.gif');"></li>
                        <li style="background-image: url('../../img/3/T4/184.gif');"></li>
                        <li style="background-image: url('../../img/3/T4/185.gif');"></li>
                        <li style="background-image: url('../../img/3/T4/186.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="57">
