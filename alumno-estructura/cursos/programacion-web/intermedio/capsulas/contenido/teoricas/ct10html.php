        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/T7/69.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/T7/70.gif');"></li>
                        <li style="background-image: url('../../img/1/T7/71.gif');"></li>
                        <li style="background-image: url('../../img/1/T7/72.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct10html.php">
                                </form>
                            </div>
                        </li>
                    </ul>
