...
<body onload="iniciarTiempo()">
    ...
    <section>
        ...
        <!-- Boton para regresar -->
        <a href="../../../../../../rutas/ruta-pw-b-<?php echo $rol; ?>.php"><button style="float: left; position: absolute; margin: 10px 0 0 10px;" class="btn-b" id="btn-cerrar-modalV">
...
.contenedorCentral { background:white; }`;
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 39 + "&id_curso=" + 1 + "&redireccion=" + '../contenido/juegos/cjcss4.php'; //cancatenation
        ...
        function alertExcelent() {
            ...
            if (text1 === text2) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 39 + "&id_curso=" + 1 + "&redireccion=" + '../contenido/juegos/cjcss4.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
