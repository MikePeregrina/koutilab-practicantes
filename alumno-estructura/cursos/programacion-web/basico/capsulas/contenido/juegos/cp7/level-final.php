...
<body onload="alert1()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>UNIDADES DE MEDIDA</b></h2>
	</div>
	...
	<section>
		...
		<div class="slide-contenedor" style="margin-top: 70px;">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s3.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s4.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s5.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s6.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s7.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s8.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s9.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s10.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s11.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s12.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s13.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s14.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s15.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s16.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s17.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s18.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s19.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s20.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s21.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s22.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s23.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/level3/s24.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire({
						...
						imageUrl: "../../../img/img-juegos/s3.png",
						imageHeight: 320,
