...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>POSICIONAMIENTO RELATIVO</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<img src="../../img/img-juegos/a (1).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (2).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (3).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (4).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (5).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (6).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (7).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (8).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (9).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (10).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (11).png" width="50px" height="60px">',
				'<img src="../../img/img-juegos/a (12).png" width="50px" height="60px">'
			]
		}
