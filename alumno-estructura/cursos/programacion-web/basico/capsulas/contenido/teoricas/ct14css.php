        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T11/223.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T11/224.gif');"></li>
                        <li style="background-image: url('../../img/2/T11/225.gif');"></li>
                        <li style="background-image: url('../../img/2/T11/226.gif');"></li>
                        <li style="background-image: url('../../img/2/T11/227.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct14css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
