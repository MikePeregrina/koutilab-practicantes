        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/T12/114.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/T12/115.gif');"></li>
                        <li style="background-image: url('../../img/1/T12/116.gif');"></li>
                        <li style="background-image: url('../../img/1/T12/117.gif');"></li>
                        <li style="background-image: url('../../img/1/T12/118.gif');"></li>
                        <li style="background-image: url('../../img/1/T12/119.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct16html.php">
                                </form>
                            </div>
                        </li>
                    </ul>
