        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/I/123.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/I/124.gif');"></li>
                        <li style="background-image: url('../../img/2/I/125.gif');"></li>
                        <li style="background-image: url('../../img/2/I/126.gif');"></li>
                        <li style="background-image: url('../../img/2/I/127.gif');"></li>
                        <li style="background-image: url('../../img/2/I/128.gif');"></li>
                        <li style="background-image: url('../../img/2/I/129.gif');"></li>
