...
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_pago_preparatoria WHERE id_capsula = '$permiso' AND id_alumno = '$id_user' AND id_curso = '$id_curso'");
