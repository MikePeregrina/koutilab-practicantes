...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/avanzado/capsulas/contenido/teoricas/ct3videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>
                                    <br>
                                    En tu libreta escribe para que podemos ocupar FixedUpdate. Toma foto y sube la imagen.
                                    <br>
                                    <br>
                                </p>
                            </td>
