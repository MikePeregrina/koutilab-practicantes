...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/avanzado/capsulas/contenido/teoricas/ct19videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 7.5 Videojuegos Unity</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Graba la pantalla cuando estes compilando tu proyecto, no importa que no tenga muchas cosas.
                                    Sube tu video, recuerda que no debe de durar mas de 2 minutos.
                                    <br> <br>
                                </p>
                            </td>
                        </tr>
