...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/avanzado/capsulas/contenido/teoricas/ct14videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Replica el primer codigo de GameOver que aparece en la teoria. Toma foto y subela.
                                    <br> <br>
                                </p>
                            </td>
                        </tr>
