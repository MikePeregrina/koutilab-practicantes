        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunitya/T9/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T9/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T9/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T9/4.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué hace la función Groundcheck?</h1>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct9videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
