        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunitya/T12/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T12/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T12/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T12/4.jpg');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué significa Translate , Rotate y Scale?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Trasladar Cortar y Mover
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Trasladar, Girar y Escalar
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Mover Trasladar y Mapas
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            Mover Correr Y Escalar
                                        </label>
                                    </div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct12videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
