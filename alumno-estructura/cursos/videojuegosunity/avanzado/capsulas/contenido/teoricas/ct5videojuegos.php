        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunitya/T5/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T5/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T5/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T5/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T5/5.jpg');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuántas Plataformas se mencionan en la lectura?</h1>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('evaluar').submit();
                        window.location.href = '../teoricas/ct5videojuegos.php';
                    }
                });
