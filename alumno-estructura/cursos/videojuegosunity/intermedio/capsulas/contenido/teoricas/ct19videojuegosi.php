        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T19/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T19/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T19/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T19/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T19/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T19/6.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para que sirve el scrip layerController?</h1>
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox2">
                                            Para controlar el movimiento y las acciones del jugador
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Para tolerar los turnos necesarios
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            Para ver las acciones y reacciones
                                        </label>
                                    </div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct19videojuegosi.php">
                                </form>
                            </div>
                        </li>
                    </ul>
