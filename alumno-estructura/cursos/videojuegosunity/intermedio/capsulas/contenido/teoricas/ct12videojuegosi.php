        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T12/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T12/7.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>Al crear un juego infinito en Unity ¿Qué Implica?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Genera un Menu de niveles
                                        </label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox3">
                                            Genera un mejor Patrullaje
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            Generra mejor nivel de desempeño
                                        </label>
                                    </div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct12videojuegosi.php">
                                </form>
                            </div>
                        </li>
                    </ul>
