...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 8 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T20/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T20/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T20/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T20/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T20/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T20/6.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Se utiliza comúnmente en juegos para crear la ilusión de profundidad y movimiento en los fondos? </h1>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct20videojuegosi.php">
                                </form>
                            </div>
                        </li>
                    </ul>
