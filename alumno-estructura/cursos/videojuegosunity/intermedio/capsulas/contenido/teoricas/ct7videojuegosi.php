...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6.5 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T7/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T7/8.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Se usa para crear comportamientos de movimiento predefinidos para personajes no jugables?</h1>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct7videojuegosi.php';
                    }
                });
