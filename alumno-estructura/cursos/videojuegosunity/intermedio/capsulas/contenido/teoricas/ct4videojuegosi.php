            ...
            <div class="container">
                ...
                <section id="container-slider">
                    <section id="container-slider">
                        ...
                        <ul id="slider">
                            <li style="background-image: url('../../img/videojuegosunityi/T4/1.jpg'); z-index:0; opacity: 1;"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/2.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/3.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/4.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/5.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/6.jpg');"></li>
                            <li style="background-image: url('../../img/videojuegosunityi/T4/7.jpg');"></li>
                                ...
                                <div>
                                    <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                        ...
                                        <div class="container-question">
                                            ...
                                            <label for="checkbox4">Menu de Entrada </label>
                                        </div>
