        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T1/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T1/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T1/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T1/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T1/5.jpg');"></li>
                            ...
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Menu de selección de personaje </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Menu de Inicio</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Menu de Registro</label>
                                    </div>
                                    <div class="container-question">
