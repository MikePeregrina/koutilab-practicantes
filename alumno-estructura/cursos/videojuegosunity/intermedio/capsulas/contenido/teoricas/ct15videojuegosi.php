...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 4.5 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunityi/T15/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T15/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T15/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T15/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T15/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunityi/T15/6.jpg');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Es una mecánica común que permite a los jugadores guardar su progreso en un nivel y regresar a puntos específicos en caso de fallos?</h1>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct15ivideojuegosi.php';
                    }
                });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct15videojuegosi.php';
                    }
                });
