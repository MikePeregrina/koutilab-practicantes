...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Introducción a Videojuegos Unity</div><br>
            <section id="container-slider">
                ...
                <ul id="slider">
                    <li style="background-image: url('../../img/bienvenida/1.jpg'); z-index:0; opacity: 1;"></li>
                    <li style="background-image: url('../../img/bienvenida/2.jpg');"></li>
                    <li style="background-image: url('../../img/bienvenida/3.jpg');"></li>
                    <li style="background-image: url('../../img/bienvenida/4.jpg');"></li>
                    <li style="background-image: url('../../img/bienvenida/5.jpg');"></li>
                    <li style="background-image: url('../../img/bienvenida/6.jpg');"></li>
