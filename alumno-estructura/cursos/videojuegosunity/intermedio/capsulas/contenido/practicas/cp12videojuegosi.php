...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/intermedio/capsulas/contenido/teoricas/ct12videojuegosi.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 2 Videojuegos Unity</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Genera un script de Generador de Nivel. Toma captura y sube la imagen.
                                    <br> <br>
                                </p>
                            </td>
                        </tr>
