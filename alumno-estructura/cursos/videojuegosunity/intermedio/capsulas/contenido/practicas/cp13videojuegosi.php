...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/intermedio/capsulas/contenido/teoricas/ct13videojuegosi.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 3 Videojuegos Unity</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Genera un script de LevelManager. Captura el resultado y sube la imagen.
                                    <br>
                                </p>
                            </td>
                        </tr>
