        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/10/209.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/10/210.gif');"></li>
                        <li style="background-image: url('../../img/2/10/211.gif');"></li>
                        <li style="background-image: url('../../img/2/10/212.gif');"></li>
                        <li style="background-image: url('../../img/2/10/213.gif');"></li>
                        <li style="background-image: url('../../img/2/10/214.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct22informatica.php">
                                </form>
                            </div>
                        </li>
                    </ul>
