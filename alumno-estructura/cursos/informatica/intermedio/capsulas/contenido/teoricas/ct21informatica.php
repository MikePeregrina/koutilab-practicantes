        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/9/198.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/9/199.gif');"></li>
                        <li style="background-image: url('../../img/2/9/200.gif');"></li>
                        <li style="background-image: url('../../img/2/9/201.gif');"></li>
                        <li style="background-image: url('../../img/2/9/202.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct21informatica.php">
                                </form>
                            </div>
                        </li>
                    </ul>
