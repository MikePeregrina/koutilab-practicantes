        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/12/110.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/12/111.gif');"></li>
                        <li style="background-image: url('../../img/1/12/112.gif');"></li>
                        <li style="background-image: url('../../img/1/12/113.gif');"></li>
                        <li style="background-image: url('../../img/1/12/114.gif');"></li>
                        <li style="background-image: url('../../img/1/12/115.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct12informatica.php">
                                </form>
                            </div>
                        </li>
                    </ul>
