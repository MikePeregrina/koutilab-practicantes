        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/3/135.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/3/136.gif');"></li>
                        <li style="background-image: url('../../img/2/3/137.gif');"></li>
                        <li style="background-image: url('../../img/2/3/138.gif');"></li>
                        <li style="background-image: url('../../img/2/3/139.gif');"></li>
                        <li style="background-image: url('../../img/2/3/140.gif');"></li>
                        <li style="background-image: url('../../img/2/3/141.gif');"></li>
                        <li style="background-image: url('../../img/2/3/142.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct15informatica.php">
                                </form>
                            </div>
                        </li>
                    </ul>
