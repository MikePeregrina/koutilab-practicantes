        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/8/193.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/8/194.gif');"></li>
                        <li style="background-image: url('../../img/2/8/195.gif');"></li>
                        <li style="background-image: url('../../img/2/8/196.gif');"></li>
