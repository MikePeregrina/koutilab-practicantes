        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/6/40.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/6/41.gif');"></li>
                        <li style="background-image: url('../../img/1/6/42.gif');"></li>
                        <li style="background-image: url('../../img/1/6/43.gif');"></li>
