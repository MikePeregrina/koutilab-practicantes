        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/1/110.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/1/111.gif');"></li>
                        <li style="background-image: url('../../img/2/1/112.gif');"></li>
                        <li style="background-image: url('../../img/2/1/113.gif');"></li>
                        <li style="background-image: url('../../img/2/1/114.gif');"></li>
