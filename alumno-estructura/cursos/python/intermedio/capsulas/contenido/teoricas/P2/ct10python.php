        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/2/T10/203.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/2/T10/204.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T10/205.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T10/206.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T10/207.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T10/208.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="61">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="5">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct10python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
