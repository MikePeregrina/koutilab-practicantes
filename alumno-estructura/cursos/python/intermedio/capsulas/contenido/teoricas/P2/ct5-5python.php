...
if (empty($existe)) {
    header("Location: ../../../../capsulas/contenido/alertas/paquete_premium4.php");
}
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 5.5 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/2/T5.5/153.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/2/T5.5/154.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T5.5/155.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T5.5/156.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T5.5/157.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T5.5/158.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_P2ct5-5py.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cómo se pueden organizar paquetes en múltiples directorios en Python?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">es posible organizar paquetes en múltiples directorios utilizando el concepto de "paquetes anidados".</label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox4">Todos los módulos y paquetes deben colocarse en el mismo directorio principal en Python, no se pueden anidar en subdirectorios.</label>
                                    </div>
