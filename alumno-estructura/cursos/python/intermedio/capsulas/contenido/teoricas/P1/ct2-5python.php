...
if (empty($existe)) {
    header("Location: ../../../../capsulas/contenido/alertas/paquete_premium1.php");
}
//Verificar si ya se tiene permiso y no dar puntos de más
//Verificar si permiso_intento es correcto
$permiso_intento = 8;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_$rol WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 5");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_$rol WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 5");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2.5 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/1/T2.5/23.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/1/T2.5/24.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T2.5/25.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T2.5/26.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T2.5/27.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T2.5/28.gif');"></li>
                        <li>
                            <div>
