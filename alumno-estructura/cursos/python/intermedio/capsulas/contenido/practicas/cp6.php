...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 6</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea una variable global llamada contador y asígnale el valor 0. Crea una función llamada incrementar_contador que aumente el valor de la variable global contador en 1. Llama a la función incrementar_contador varias veces desde diferentes partes de tu programa. Imprime el valor de la variable global contador después de cada llamada a incrementar_contador para ver cómo cambia su valor.
                                </p>
                            </td>
                            <td class="ne">
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd12.php?validar=' + 'incorrecto' + '&permiso=' + 12 + '&id_curso=' + 5 + '&practico=' + 10 + '&pythoncode=' + encodeV;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'correcto' + '&permiso=' + 12 + '&id_curso=' + 5 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd12.php?validar=' + 'correcto' + '&permiso=' + 12 + '&id_curso=' + 5 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 8) {
                    Swal.fire({
