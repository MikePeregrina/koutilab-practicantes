            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crea un nuevo directorio llamado proyecto en tu computadora. Dentro de este directorio, crea dos subdirectorios llamados paquete1 y paquete2. Dentro de paquete1, crea un archivo llamado modulo1.py. Dentro de este archivo, define una función llamada saludar() que imprima "Hola desde el paquete 1!". También define una variable global llamada mensaje y asígnale el valor "Este es un mensaje desde el paquete 1".
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../img/code16.png" ">
                                </img>
                            </td>
                        </tr>
                    </tbody>
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd43.php?validar=' + 'incorrecto' + '&permiso=' + 43 + '&id_curso=' + 5 + '&practico=' + 10;
                    }
                });
            } else {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd43.php?validar=' + 'correcto' + '&permiso=' + 43 + '&id_curso=' + 5 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
