...
<body onload="alert1()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>BUSQUEDA Y MANIPULACION DE TEXTO</b></h2>
	</div>
	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p3.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p4.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p5.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p6.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p7.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p8.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p9.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p10.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p11.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p12.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p13.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p14.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p15.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p16.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p17.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p18.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p19.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p20.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p21.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p22.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p23.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel3/p24.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire({
						...
						imageUrl: "../../../img/img-juegos/p3.png",
						imageHeight: 320,
