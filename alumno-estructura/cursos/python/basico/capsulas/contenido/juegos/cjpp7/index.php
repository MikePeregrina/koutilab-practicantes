	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p3.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p4.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p5.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p6.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p7.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="../../../img/img-juegos/nivel1/p8.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire({
						...
						imageUrl: "../../../img/img-juegos/p1.png",
						imageHeight: 320,
