...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>CREACION Y MANIPULACION DE DICCIONARIOS</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<img src="../../img/img-juegos/p (1).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (2).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (3).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (4).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (5).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (6).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (7).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (8).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (9).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (10).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (11).png" width="50px" heigth="60px">',
				'<img src="../../img/img-juegos/p (12).png" width="50px" heigth="60px">'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 19 + "&id_curso=" + 4 + "&redireccion=" + '../contenido/juegos/cjp1-6.php'; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				var xmlhttp = new XMLHttpRequest();
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 4 + "&redireccion=" + '../contenido/juegos/cjp1-6.php'; //cancatenation
				xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
				xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlhttp.send(param);
				Swal.fire({
