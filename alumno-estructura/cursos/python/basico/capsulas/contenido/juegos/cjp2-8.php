...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h4 class="titulo"><b>FUNCIONES INCORPORADAS</b></h4>
	</div>
	...
	<script>
		...
		var words = ['FUNCIONES', 'ELEMENTO', 'LONGITUDES', 'USUARIO', 'CONSOLA', 'FLOTANTE', 'CADENA', 'ENTERO'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 48 + "&id_curso=" + 4 + "&redireccion=" + '../contenido/juegos/cjcss7.php'; //cancatenation
