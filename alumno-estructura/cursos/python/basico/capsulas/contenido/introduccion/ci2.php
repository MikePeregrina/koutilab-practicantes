...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Introducción 2 Python Básico</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/I/110.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/I/111.gif');"></li>
