...
if (empty($existe)) {
     header("Location: ../../../../../contenido/alertas/paquete_premium1.php");paquete_premium2.php");
}
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2.5 Python Básico</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T2.5/29.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T2.5/30.gif');"></li>
                        <li style="background-image: url('../../../img/1/T2.5/31.gif');"></li>
                        <li style="background-image: url('../../../img/1/T2.5/32.gif');"></li>
                        <li style="background-image: url('../../../img/1/T2.5/33.gif');"></li>
                        <li style="background-image: url('../../../img/1/T2.5/34.gif');"></li>
                        <li>
                            <div>
