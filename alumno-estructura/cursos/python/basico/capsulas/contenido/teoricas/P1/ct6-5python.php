...
if (empty($existe)) {
     header("Location: ../../../../../contenido/alertas/paquete_premium1.php");paquete_premium3.php");
}
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T6.5/64.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T6.5/65.gif');"></li>
                            ...
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_ct6-5py.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox2"> list </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">"in"</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">set</label>
                                    </div>
