...
class Prueba(unittest.TestCase):</br>
&nbsp;&nbsp;def test_suma_positiva(self:)</br>
&nbsp;&nbsp;&nbsp;&nbsp;resultado = suma(2, 3)</br>
&nbsp;&nbsp;&nbsp;&nbsp;self.assertEqual(resultado, 5)</br>
`;
...
function iniciarTiempo() {
    ...
    if (segundos == 0) {
        ...
        var param =
            ...
            6 +
            "&redireccion=" +
            "../contenido/juegos/cjp2-7.php"; //cancatenation
