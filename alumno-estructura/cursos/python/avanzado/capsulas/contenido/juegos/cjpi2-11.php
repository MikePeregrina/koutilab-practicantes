...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h4 class="titulo"><b>TIPOS DE DATOS MUTABLES E INMUTABLES</b></h4>
	</div>
	...
	<script>
		...
		var words = ['MUTABLES', 'DATOS', 'ERRORES', 'INMUTABLES', 'CODIGO', 'TUPLAS', 'CADENAS', 'OBJETO'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 25 + "&id_curso=" + 5 + "&redireccion=" + '../contenido/juegos/cjp1-10.php'; //cancatenation
