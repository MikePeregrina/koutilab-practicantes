        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T7.5/71.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T7.5/72.gif');"></li>
                        <li style="background-image: url('../../../img/1/T7.5/73.gif');"></li>
