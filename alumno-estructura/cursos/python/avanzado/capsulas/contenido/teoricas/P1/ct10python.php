        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T10/101.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T10/102.gif');"></li>
                        <li style="background-image: url('../../../img/1/T10/103.gif');"></li>
                        <li style="background-image: url('../../../img/1/T10/104.gif');"></li>
                        <li style="background-image: url('../../../img/1/T10/105.gif');"></li>
                        <li style="background-image: url('../../../img/1/T10/106.gif');"></li>
                        <li style="background-image: url('../../../img/1/T10/107.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct10python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
