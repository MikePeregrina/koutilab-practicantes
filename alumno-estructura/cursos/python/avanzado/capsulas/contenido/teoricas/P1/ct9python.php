        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/1/T9/86.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/1/T9/87.gif');"></li>
                        <li style="background-image: url('../../../img/1/T9/88.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P1/ct9python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
