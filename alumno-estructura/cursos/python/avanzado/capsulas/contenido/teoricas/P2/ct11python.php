        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/2/T11/231.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/2/T11/232.gif');"></li>
                        <li style="background-image: url('../../../img/2/T11/233.gif');"></li>
                        <li style="background-image: url('../../../img/2/T11/234.gif');"></li>
                        <li style="background-image: url('../../../img/2/T11/235.gif');"></li>
                        <li style="background-image: url('../../../img/2/T11/236.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/P2/ct11python.php">
                                </form>
                            </div>
                        </li>
                    </ul>
