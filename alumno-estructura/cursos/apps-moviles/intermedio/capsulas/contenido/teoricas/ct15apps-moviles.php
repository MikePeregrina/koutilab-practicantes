...
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 14;");
...
$permiso_intento = 14;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_preparatoria WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 14");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_preparatoria WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 14");
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T15/110.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/111.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/112.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/113.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/114.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/115.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/116.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/117.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/118.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/119.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/120.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/121.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T15/122.gif');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el objetivo de utilizar plantillas en Word?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Ahorrar tiempo y esfuerzo al comenzar desde cero.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Dividir el documento en secciones independientes.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Aplicar formatos coherentes al texto.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            Organizar y estructurar el contenido de manera eficiente.
                                        </label>
                                    </div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct15apps-moviles.php';
                    }
                });
