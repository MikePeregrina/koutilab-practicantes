...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>ESTRUCTURA</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<img src="../../img/img-juegos/p (1).png" width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (2).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (3).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (4).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (5).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (6).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (7).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (8).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (9).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (10).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (11).png" " width="60px" height = "50px" >',
				'<img src="../../img/img-juegos/p (12).png" " width="60px" height = "50px" >'
			]
		}
