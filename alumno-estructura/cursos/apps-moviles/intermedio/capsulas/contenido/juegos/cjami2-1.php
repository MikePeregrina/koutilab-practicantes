...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>DECLARACION VARIABLE</b></h2>
    </div>
    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1.Son Aquellas Que Pueden Cambiar De Valor Después De Su Inicialización
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="correcto">var</option>
                        <option value="incorrecto">vall</option>
                        <option value="incorrecto">val</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2.Su Valor No Puede Cambiar Después De La Inicialización, Similar A Una Constante.?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">var</option>
                        <option value="correcto">val</option>
                        <option value="incorrecto">vall</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3. Para Valores nullos ¿Que simbolo se utiliza?
                ...
                <h3>4.Kotlin ofrece una variedad de tipos de datos, incluyendo enteros, flotantes, caracteres y ?
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="correcto">cadenas</option>
                        <option value="incorrecto">enteros dobles</option>
                        <option value="incorrecto">enteros flotantes</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
