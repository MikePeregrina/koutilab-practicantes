...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct17apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Investigar cómo Android ha influido en el mercado de dispositivos móviles y en la forma en que las personas interactúan con la tecnología. Pueden analizar su impacto en términos de acceso a la información, comunicación, entretenimiento y productividad.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (divs > 0 && h3 > 0 && ps > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_cp2.php?validar=' + 'correcto' + '&permiso=' + 2 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_cp2.php?validar=' + 'incorrecto' + '&permiso=' + 2 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }*/
