        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T9.5/225.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T9.5/226.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/227.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/228.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/229.gif');"></li>
                        <li style="background-image: url('../../img/2/T9.5/230.gif');"></li>
                        <li>
                            <div>
