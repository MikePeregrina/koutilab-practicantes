        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T4.5/171.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T4.5/172.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/173.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/174.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/175.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/176.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/177.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/178.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/179.gif');"></li>
                        <li style="background-image: url('../../img/2/T4.5/180.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">
                                            Gestionar los recursos de hardware y proporcionar servicios a los programas de aplicación.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Manejar archivos de datos multimedia.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox4">
                                            Generar salidas y resultados del sistema.
                                        </label>
                                    </div>
