...
<body onload="iniciarTiempo()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>¿QUÉ ES EL DESARROLLO NATIVO?</b></h2>
	</div>
	...
	<script>
		...
		var preguntas = [{
				num: 1,
				pregunta: "¿Qué es el desarrollo nativo?",
				opA: "Desarrollar una app para un SO específico",
				opB: "Desarrollar una app para varios SO",
				opC: "No lo sé",
				correcta: "A",
				tiempo: "30",
			},
			{
				num: 2,
				pregunta: "¿Para que sirve un desarrollo nativo?",
				opA: "Para una mejor optimización de la app",
				opB: "No sirve de nada",
				opC: "Para ser más lenta",
				correcta: "A",
				tiempo: "30",
			},
			{
				num: 3,
				pregunta: "Son ventajas del desarrollo nativo",
				opA: "Rendimiento optimo",
				opB: "Mejor adaptación con el sistema operativo",
				opC: "Ambas respuestas",
				correcta: "C",
				tiempo: "20",
			},
			{
				num: 4,
				pregunta: "Es uno de los frameworks para crear apps nativas sin tener que hacer doble trabajo",
				opA: "Flutter",
				opB: "Kotlin",
				opC: "Swift",
				correcta: "A",
