    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- ¿Qué es un mockup?
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="correcto">Es un diagrama que representa visualmente la app</option>
                        <option value="incorrecto">Un diagrama de flujo</option>
                        <option value="incorrecto">No es nada</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- ¿Durante que fase se desarrollan los mockups?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">Al final</option>
                        <option value="correcto">En la fase de diseño</option>
                        <option value="incorrecto">Durante la codificación</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- Los mockups son necesarios para una mejor
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="incorrecto">Vista</option>
                        <option value="correcto">Comprensión del proyecto</option>
                    </select>
                </h3><!--Generando primer pregunta-->

                <h3>4- Para ajustar la posición y el tamaño de los elementos, ocupamos
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">Canvas</option>
                        <option value="correcto">Rect transform</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
