...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>PRIMEROS SISTEMAS OPERATIVOS</b></h2>
    </div>
    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- Se refiere a cómo los usuarios navegan a través de las distintas secciones o pantallas de una aplicación
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="correcto">Patrón de navegación</option>
                        <option value="incorrecto">Patrón de busqueda</option>
                        <option value="incorrecto">Patrón de pantalla de inicio</option>
                        <option value="incorrecto">Patrón de notificaciones</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- Se refiere a cómo los usuarios pueden buscar y encontrar información dentro de una aplicación
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">Patrón de navegación</option>
                        <option value="correcto">Patrón de busqueda</option>
                        <option value="incorrecto">Patrón de pantalla de inicio</option>
                        <option value="incorrecto">Patrón de notificaciones</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- Se refiere a cómo se presenta la pantalla de inicio de un juego o aplicación
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="incorrecto">Patrón de navegación</option>
                        <option value="incorrecto">Patrón de busqueda</option>
                        <option value="correcto">Patrón de pantalla de inicio</option>
                        <option value="incorrecto">Patrón de notificaciones</option>
                    </select>
                </h3><!--Generando primer pregunta-->

                <h3>4- Se utiliza para permitir que objetos dentro de una aplicación se comuniquen entre sí de manera eficiente sin acoplarlos directamente
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">Patrón de navegación</option>
                        <option value="incorrecto">Patrón de busqueda</option>
                        <option value="incorrecto">Patrón de pantalla de inicio</option>
                        <option value="correcto">Patrón de notificaciones</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
