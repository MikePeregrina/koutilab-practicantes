    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- ¿En qué decada surgieron los primeros sistemas operativos?
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="correcto">1950 y 1960</option>
                        <option value="incorrecto">1940 y 1950</option>
                        <option value="incorrecto">1960 y 1970</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- Es el significado de las siglas FMS
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">JOHNNIAC Open Shop System</option>
                        <option value="correcto">Fortran Monitor System</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- El sistema operativo
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="correcto">Windows</option>
                        <option value="incorrecto">Linux</option>
                        <option value="incorrecto">FMS</option>
                    </select>se creó en el año 1985 y vino para quedarse
                </h3><!--Generando primer pregunta-->

                <h3>4- Son los sistemas operativos para teléfonos móviles que conocemos hoy en día 
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">Windows y MacOS</option>
                        <option value="correcto">Android y IOS</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
