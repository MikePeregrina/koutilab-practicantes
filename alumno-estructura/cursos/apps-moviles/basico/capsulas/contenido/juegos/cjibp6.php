...
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 13");
...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>DISEÑO DE INTERFAZ UX</b></h2>
    </div>
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="horizontal">
                                ...
                                <br>
                                1. Son la siglas de Experiencia de Usuario en inglés
                                <br /><br />
                                2. Se trata de lo que compone la parte lógica de las computadoras, el como trabajan y que no podemos tocar, empieza con S
                                <br /><br />
                                <b style="margin-left: 66px" class="tituloV">Verticales:</b>
                                <div class="vertical">
                                    1. Es parte de las siglas UI, que es _______ de usuario
                                    <br /><br />
                                    2. Es la parte física de las compuradoras, todo aquello que las compone y que si pidemos tocar, empieza con H
                                    <br /><br />
                                    3. Es parte de las siglas UX, que es experiencia de ________
                                    <br /><br />
                                </div>
                        </td>
            ...
            <div class="crucigrama">
                <div class="numero1" style="margin: -550px 0 0 -175px;">1.</div>
                <div class="numero1-1" style="margin: -355px 0 0 210px;">1.</div>
                <div class="numero2-2" style="margin: -435px 0 0 60px;">2.</div>
                <div class="numero3-3" style="margin: -435px 0 0 295px;">3.</div>
                <div class="numero2" style="margin: 120px 0 0 -500px;">2.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
    ...
    <script>
        ...
        //Palabra usuario
        var palabra1_letra1 = document.getElementById("fila2C7");
        var palabra1_letra2 = document.getElementById("fila3C7");
        var palabra1_letra3 = document.getElementById("fila4C7");
        var palabra1_letra4 = document.getElementById("fila5C7");
        var palabra1_letra5 = document.getElementById("fila6C7");
        var palabra1_letra6 = document.getElementById("fila7C7");
        var palabra1_letra7 = document.getElementById("fila8C7");
        ...
        var palabra2_letra4 = document.getElementById("fila4C3");
        var palabra2_letra5 = document.getElementById("fila5C3");
        var palabra2_letra6 = document.getElementById("fila6C3");
        var palabra2_letra7 = document.getElementById("fila7C3");
        var palabra2_letra8 = document.getElementById("fila8C3");
        ...
        var palabra3_letra7 = document.getElementById("fila6C7");
        var palabra3_letra8 = document.getElementById("fila6C8");

        //Palabra hardware
        var palabra4_letra1 = document.getElementById("fila2C5");
        var palabra4_letra2 = document.getElementById("fila3C5");
        var palabra4_letra3 = document.getElementById("fila4C5");
        var palabra4_letra4 = document.getElementById("fila5C5");
        var palabra4_letra5 = document.getElementById("fila6C5");
        var palabra4_letra6 = document.getElementById("fila7C5");
        var palabra4_letra7 = document.getElementById("fila8C5");
        var palabra4_letra8 = document.getElementById("fila9C5");

        //Palabra ux
        var palabra5_letra1 = document.getElementById("fila2C7");
        var palabra5_letra2 = document.getElementById("fila2C8");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "usuario" &&
                palabra2.toLowerCase() == "interfaz" &&
                palabra3.toLowerCase() == "software" &&
                palabra4.toLowerCase() == "hardware" &&
                palabra5.toLowerCase() == "ux"
            ) {
                var xmlhttp = new XMLHttpRequest();
            ...
            `,
                ...
                if (palabra1.toLowerCase() != "usuario") {
                    palabra1_letra1.value = "";
                    palabra1_letra2.value = "";
                    palabra1_letra3.value = "";
                    palabra1_letra4.value = "";
                ...
                if (palabra2.toLowerCase() != "interfaz") {
                    palabra2_letra1.value = "";
                    palabra2_letra2.value = "";
                    palabra2_letra3.value = "";
                    palabra2_letra4.value = "";
                ...
                if (palabra3.toLowerCase() != "software") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "hardware") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "usuario") {
                    palabra3_letra7.value = "r";
                    palabra5_letra1.value = "u";
                }

                if (palabra2.toLowerCase() == "interfaz") {
                    palabra3_letra3.value = "f";
                }

                if (palabra3.toLowerCase() == "software") {
                    palabra1_letra5.value = "r";
                    palabra2_letra6.value = "f";
                    palabra4_letra5.value = "w";
                }

                if (palabra4.toLowerCase() == "hardware") {
                    palabra3_letra5.value = "w";
                }

                if (palabra5.toLowerCase() == "ux") {
                    palabra1_letra1.value = "u";
                }
            }
        }
    </script>
