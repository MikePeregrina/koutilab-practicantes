  ...
  <div class="contenido">
    ...
    <div class="container">
      <section>
        ...
        <h3>
          1- Crea o adquiere modelos 3D o sprites que representen a tu superhéroe para su apariencia, traje y accesorios.
          <select class="select" id="respuesta0">
            <!--Generando lista de opciones de respuesta de la pregunta 1-->
            <option value="----">...</option>
            <option value="correcto">Diseño</option>
            <option value="incorrecto">Concepto</option>
            <option value="incorrecto">Animaciones</option>
          </select>
        </h3>
        <!--Generando pregunta 2-->
        <h3>
          2-Le agrega al personaje  movimientos y acciones específicas. Esto puede incluir caminar, correr, volar, etc 
          <select class="select" id="respuesta1">
            <!--Generando lista de opciones de respuesta de la pregunta 2-->
            <option value="----">...</option>
            <option value="incorrecto">Concepto</option>
            <option value="correcto">Animaciones</option>
            <option value="incorrecto">Diseño</option>
          </select>
        </h3>
        <!--Generando pregunta 3-->
        <h3>
          3- Define la idea de tu superhéroe, incluyendo sus poderes, apariencia, personalidad y origen.
          <select class="select" id="respuesta2">
            <!--Generando lista de opciones de respuesta de la pregunta 3-->
            <option value="----">...</option>
            <option value="correcto">Concepto</option>
            <option value="incorrecto">Diseño</option>
            <option value="incorrecto">Animaciones</option>
          </select>
        </h3>
        ...
        <h3>
          4- ¿Crear objetos de superhéroes en Unity implica diseñar personajes con habilidades y características especiales?
