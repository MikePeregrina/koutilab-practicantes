...
// $sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 15");
...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>COMPARTIR Y COLABORAR EN PRESENTACIONES</b></h2>
    </div>
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        <td>
                            <div class="horizontal">
                                ...
                                1. Es una forma de recibir una invitación a realizar una presentación colaborativa, mendiante ________ electrónico
                                <br /><br />
                                2. Es la traducción de cloud, también es una forma de almacenamiento en línea
                                <br /><br />
                                3. Es el software que estamos aprendiendo a usar
                                <br /><br />
                                4. Es la acción de que tu y tus compañeros trabajen en un mismo proyecto o presentación, empieza con c
                                <br /><br />
                                <b class="tituloV">Verticales:</b>
                                <div class="vertical">
                                    1. Para que un compañero pueda trabajar contigo en una presentación, se le tiene que dar a_____
                                    <br /><br />
                                    2. Se pueden Agregar sugerencias y _______ para dar retroalimentación o notificar de un cambio a nuestros compañeros
                                </div>
                            </div>
                        </td>
            ...
            <div class="crucigrama">
                <div class="numero1" style="margin: -440px 0 0 -355px">1.</div>
                <div class="numero2" style="margin: 470px 0 0 -670px">4.</div>
                <div class="numero1-1" style="margin: 240px 0 0 -560px">3.</div>
                <div class="numero2-2" style="margin: -120px 0 0 -80px">2.</div>
                <div class="numero3-3" style="margin: -590px 0 0 -80px">1.</div>
                <div class="numero3-3" style="margin: -670px 0 0 0">2.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="casilla" type="text" maxlength="1" id="fila11C11" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <script>
        ...
        //Palabra nube
        var palabra1_letra1 = document.getElementById("fila5C6");
        var palabra1_letra2 = document.getElementById("fila5C7");
        var palabra1_letra3 = document.getElementById("fila5C8");
        var palabra1_letra4 = document.getElementById("fila5C9");

        //Palabra correo
        var palabra2_letra1 = document.getElementById("fila1C6");
        var palabra2_letra2 = document.getElementById("fila1C7");
        var palabra2_letra3 = document.getElementById("fila1C8");
        var palabra2_letra4 = document.getElementById("fila1C9");
        var palabra2_letra5 = document.getElementById("fila1C10");
        var palabra2_letra6 = document.getElementById("fila1C11");

        //Palabra acceso
        var palabra3_letra1 = document.getElementById("fila3C3");
        var palabra3_letra2 = document.getElementById("fila4C3");
        var palabra3_letra3 = document.getElementById("fila5C3");
        var palabra3_letra4 = document.getElementById("fila6C3");
        var palabra3_letra5 = document.getElementById("fila7C3");
        var palabra3_letra6 = document.getElementById("fila8C3");

        //Palabra powerpoint
        var palabra4_letra1 = document.getElementById("fila8C2");
        var palabra4_letra2 = document.getElementById("fila8C3");
        var palabra4_letra3 = document.getElementById("fila8C4");
        var palabra4_letra4 = document.getElementById("fila8C5");
        var palabra4_letra5 = document.getElementById("fila8C6");
        var palabra4_letra6 = document.getElementById("fila8C7");
        var palabra4_letra7 = document.getElementById("fila8C8");
        var palabra4_letra8 = document.getElementById("fila8C9");
        var palabra4_letra9 = document.getElementById("fila8C10");
        var palabra4_letra10 = document.getElementById("fila8C11");

        //Palabra colaborar
        var palabra5_letra1 = document.getElementById("fila10C1");
        var palabra5_letra2 = document.getElementById("fila10C2");
        var palabra5_letra3 = document.getElementById("fila10C3");
        var palabra5_letra4 = document.getElementById("fila10C4");
        var palabra5_letra5 = document.getElementById("fila10C5");
        var palabra5_letra6 = document.getElementById("fila10C6");
        var palabra5_letra7 = document.getElementById("fila10C7");
        var palabra5_letra8 = document.getElementById("fila10C8");
        var palabra5_letra9 = document.getElementById("fila10C9");

        //Palabra comentarios
        var palabra6_letra1 = document.getElementById("fila1C6");
        var palabra6_letra2 = document.getElementById("fila2C6");
        var palabra6_letra3 = document.getElementById("fila3C6");
        var palabra6_letra4 = document.getElementById("fila4C6");
        var palabra6_letra5 = document.getElementById("fila5C6");
        var palabra6_letra6 = document.getElementById("fila6C6");
        var palabra6_letra7 = document.getElementById("fila7C6");
        var palabra6_letra8 = document.getElementById("fila8C6");
        var palabra6_letra9 = document.getElementById("fila9C6");
        var palabra6_letra10 = document.getElementById("fila10C6");
        var palabra6_letra11 = document.getElementById("fila11C6");
        ...
        palabra6_letra9.readOnly = false;
        palabra6_letra10.readOnly = false;
        palabra6_letra11.readOnly = false;
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "nube" &&
                palabra2.toLowerCase() == "correo" &&
                palabra3.toLowerCase() == "acceso" &&
                palabra4.toLowerCase() == "powerpoint" &&
                palabra5.toLowerCase() == "colaborar" &&
                palabra6.toLowerCase() == "comentarios" 
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra2.toLowerCase() != "correo") {
                    palabra2_letra1.value = "";
                    palabra2_letra2.value = "";
                    palabra2_letra3.value = "";
                    palabra2_letra4.value = "";
                ...
                if (palabra3.toLowerCase() != "acceso") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "powerpoint") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra5.toLowerCase() != "colaborar") {
                    palabra5_letra1.value = "";
                    palabra5_letra2.value = "";
                    palabra5_letra3.value = "";
                    palabra5_letra4.value = "";
                ...
                if (palabra6.toLowerCase() != "comentarios") {
                    palabra6_letra1.value = "";
                    palabra6_letra2.value = "";
                    palabra6_letra3.value = "";
                    palabra6_letra4.value = "";
                ...
                if (palabra4.toLowerCase() == "powerpoint") {
                    ...
                    palabra6_letra8.value = "r";
                }

                if (palabra5.toLowerCase() == "colaborar") {
                    palabra6_letra10.value = "o";
                }

                if (palabra6.toLowerCase() == "comentarios") {
                    palabra2_letra1.value = "c";
                    palabra1_letra1.value = "n";
                    palabra4_letra5.value = "r";
                    palabra5_letra6.value = "o";
                }
            }
        }
    </script>
