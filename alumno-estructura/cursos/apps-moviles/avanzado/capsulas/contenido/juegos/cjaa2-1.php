...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>CONFIGURANDO NUESTRO PROYECTO</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<img src="../../img/img-juegos/d (1).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (2).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (3).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (4).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (5).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (6).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (7).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (8).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (9).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (10).png" width="60px" height="50px"  >',
				'<<img src="../../img/img-juegos/d (11).png" width="60px" height="50px"  >',
				'<img src="../../img/img-juegos/d (12).png" width="60px" height="50px"  >'
			]
		}
