	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container">
				<div class="puzzle_block"><img src="img/lvl1/power-point-0-0.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-1-0.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-2-0.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-0-1.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-1-1.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-2-1.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-0-2.jpg" class="contenedor-img" alt=""></div>
				<div class="puzzle_block"><img src="img/lvl1/power-point-1-2.jpg" class="contenedor-img" alt=""></div>
			</div>
		</div>
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire({
						...
						imageUrl: "img/lvl1/power-point.jpg",
						imageHeight: 320,
