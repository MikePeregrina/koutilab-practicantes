            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Durante esta primera práctica sobre Arduino de nivel intermedio,
                                    vamos a aprender a utilizar el sensor ultrasónico, por lo que vamos
                                    acupar de uno. Es necesario prestar atención a la video práctica,
                                    ya que, en base en ella, se va a desarrollar toda la práctica, además
                                    de que ya debimos haber completado el primer curso de Arduino básico.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AI-1.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
            ...
            if (!esCorrecto) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'incorrecto' + '&permiso=' + 4 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            } else {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd4.php?validar=' + 'correcto' + '&permiso=' + 4 + '&id_curso=' + 8 + '&practico=' + 10;
                });
            }
        }
    </script>
