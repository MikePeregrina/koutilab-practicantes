            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para esta práctica, vamos a usar el codigo anterior
                                    para controlar el sensor ultrasónico, y le agregara
                                    más comandos para que ahora haga que parpadee un LED
                                    si no hay un objeto a 15 cm o menos, y cuando haya un
                                    objeto a menos de 15 cm prendera un LED rojo a maximo brillo.
                                    <br><br>
                                    Pista:
                                    <br>
                                    Necesitarás usar un ciclo <b>if</b>, y otro llamado <b>else</b>.
                                    <b>no puedes usar delays</b>, tendras que investigar como
                                    usar la funcion <b>millis()</b>.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AI-2.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 8 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            }
        }
