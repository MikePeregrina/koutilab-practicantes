            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora aprenderás a usar bocinas o zumbadores con
                                    el arduino. Con estos podras reproducir desde
                                    pequeños tonos hasta canciones completas usando el
                                    arduino (aunque eso ultimo es para un curso más avanzado).
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AI-3.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
