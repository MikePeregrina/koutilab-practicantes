            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora vamos a agregar 1 LED azul y un LED rojo, para que parezca
                                    sirena de policia, los cuales se prenderán y apagarán junto con los tonos de la alarma.
                                    <br><br>
                                    Pista:
                                    <br>
                                    ¡Ya tienes todo lo que necesitas! Busca en tu códigos anteriores.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AI-6.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'correcto' + '&permiso=' + 20 + '&id_curso=' + 8 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'incorrecto' + '&permiso=' + 20 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            }
        }
