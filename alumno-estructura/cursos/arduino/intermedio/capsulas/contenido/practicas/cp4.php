            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora vamos a hacer una pequeña 'caja musical' usando un dip switch,
                                    dos leds que parpadeen al son de los tonos, y al menos dos variaciones
                                    de secuencias de tonos.
                                    <br><br>
                                    Pista:
                                    <br>
                                    En el <b>if</b> de cada sequencia de tonos puedes meter los comandos para
                                    hacer parpadear los LEDs. Aqui tendras que pensarle bastante, y
                                    hay varias maneras de hacerlo, pero si tendras que implementar <b>if</b>
                                    dentro de otro <b>if</b>.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/AI-4.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (esCorrecto) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'correcto' + '&permiso=' + 13 + '&id_curso=' + 8 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'incorrecto' + '&permiso=' + 13 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            }
        }
