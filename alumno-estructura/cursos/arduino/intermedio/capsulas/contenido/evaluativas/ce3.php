...
<body>
  <div class="body">
    <div class="container">
      ...
      <div class="new-g" style="text-align: center;">Evaluación 3 Arduino Intermedio</div><br>
      <div class="quiz-wrapper">
        <hr>
        <p id="inform" class="question-description">Obtenga tantos puntajes como desee en el cuestionario de 4 preguntas. Arrastre y suelte las opciones en el cuadro de arriba.</p>
