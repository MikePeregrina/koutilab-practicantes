...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 Arduino Intermedio</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/CT1.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/CT11.mp4');"></li>
                        <li style="background-image: url('../../img/CT111.gif');"></li>
                        <li>
