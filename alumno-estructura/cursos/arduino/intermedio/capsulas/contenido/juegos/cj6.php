...
<body>
  <div class="body">
    <div class="container">
      <a href="../../../../../../rutas/ruta-ar-i.php"><button style="float: left; position: relative" class="btn-b" id="btn-cerrar-modalV">
  ...
  <script>
    ...
    function cargarIconos() {
      iconos = [
        '<i class="fa-solid fa-fill-drip" style="color:gray;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:black;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:brown;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:purple;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:pink;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:orange;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:yellow;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:green;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:red;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:blue;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:white;"></i>',
        '<i class="fa-solid fa-fill-drip" style="color:antiquewhite;"></i>'
      ];
    }
