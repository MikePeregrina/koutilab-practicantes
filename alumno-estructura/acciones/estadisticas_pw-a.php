...
$consultaEstadistica = mysqli_query($conexion, "SELECT trofeos, SUM(trofeos) AS total_trofeos, progreso, SUM(progreso) AS total_progreso, puntos, SUM(puntos) AS total_puntos, practico, SUM(practico) AS total_practico, teorico, SUM(teorico) AS total_teorico FROM estadisticas_$rol WHERE id_alumno = $id_user AND id_curso = 3"); // Modificando consulta por cada curso
...
<body>
    ...
    <div class="containers">
        <a href="../rutas/ruta-pw-a-<?php echo $rol; ?>.php"><button class="btn-b"><i class="fas fa-reply fa-lg"></i></button></a>
