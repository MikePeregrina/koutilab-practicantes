...
$permiso_ruta_r13 = "13";
$sql_verificar_r13 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_universidad a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r13'");
$existe_verificar_r13 = mysqli_num_rows($sql_verificar_r13);

//Verificar si ya se tiene permiso en ruta 14
$permiso_ruta_r14 = "14";
$sql_verificar_r14 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_universidad a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r14'");
$existe_verificar_r14 = mysqli_num_rows($sql_verificar_r14);

//Verificar si ya se tiene permiso en ruta 15
$permiso_ruta_r15 = "15";
$sql_verificar_r15 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_universidad a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r15'");
...
$query_appsmoviles_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 13");
$data_appsmoviles_basico = mysqli_fetch_assoc($query_appsmoviles_basico);

//Estadisticas appsmoviles intermedio
$query_appsmoviles_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 14");
$data_appsmoviles_intermedio = mysqli_fetch_assoc($query_appsmoviles_intermedio);

//Estadisticas appsmoviles avanzado
$query_appsmoviles_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_universidad WHERE id_alumno = $id_user AND id_curso = 15");
...
<body>
    ...
    <div class="container-principal">
        <section class="seccion-perfil-usuario">
            ...
            <div class="perfil-usuario-body">
                <div class="perfil-usuario-bio">
                    ...
                    <?php
                    $data2 = mysqli_query($conexion, "SELECT * FROM alumnos_universidad WHERE id_alumno = '$id_user'");
        ...
        ";
                ...
                $query = "UPDATE alumnos_universidad SET image = '$newImageName' WHERE id_alumno = $id";
        ...
        if (isset($_POST['enviarnombre'])) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE alumnos_universidad SET nombre = '$nombre' WHERE id_alumno = '$idalumno'");
      ...
      Swal.fire({
        ...
        if (isset($_POST['enviarcontrasena'])) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE alumnos_universidad SET contrasena = '$contrasena' WHERE id_alumno = '$idalumno'");
