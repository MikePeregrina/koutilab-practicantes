...
<head>
	...
	<script type="text/javascript" src="../../js/wordfindgame4.js"></script>
...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>DIAGNÓSTICO DE PROBLEMAS</b></h2>
	</div>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 19 + "&id_curso=" + 7 + "&redireccion=" + '../contenido/juegos/cjib1-6.php'; //cancatenation
