...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct13apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Investiga las ventajas y desventajas de los teclados físicos versus los teclados virtuales en dispositivos táctiles, como tabletas y teléfonos inteligentes. Los estudiantes pueden investigar y presentar argumentos sobre la comodidad, la usabilidad, la portabilidad y otras consideraciones relevantes en relación con el uso de diferentes tipos de teclados.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (ol > 0 && ol > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd9.php?validar=' + 'correcto' + '&permiso=' + 9 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd9.php?validar=' + 'incorrecto' + '&permiso=' + 9 + '&id_curso=' + 7 + '&practico=' + 10;
