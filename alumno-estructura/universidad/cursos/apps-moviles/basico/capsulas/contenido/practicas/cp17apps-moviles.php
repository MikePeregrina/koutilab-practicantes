...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct19apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 17 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realizar una comparación detallada entre iOS y Android. Investiga y recopila información sobre las diferencias en términos de características, usabilidad, seguridad y ecosistema de aplicaciones. Presentar los hallazgos en un informe o presentación destacando las fortalezas y debilidades de cada sistema operativo.
                                    <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'correcto' + '&permiso=' + 40 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'incorrecto' + '&permiso=' + 40 + '&id_curso=' + 7 + '&practico=' + 10;
