...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 15 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realizar un proyecto de investigación sobre la evolución de los conectores a lo largo de la historia de la computación. Investigar y presentar cómo han cambiado los conectores desde los primeros equipos hasta la actualidad, identificando los avances tecnológicos y las razones detrás de esos cambios.
                                    <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'correcto' + '&permiso=' + 37 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'incorrecto' + '&permiso=' + 37 + '&id_curso=' + 7 + '&practico=' + 10;
