...
$id_user = $_SESSION['id_alumno_universidad'];
$permiso = "capsula17";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_universidad c INNER JOIN detalle_capsulas_universidad d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 13");
...
$permiso_intento = 18;
$sql_permisos = mysqli_query($conexion, "SELECT * FROM detalle_capsulas_universidad WHERE id_capsula = $permiso_intento AND id_alumno = '$id_user' AND id_curso = 13");
$result_sql_permisos = mysqli_num_rows($sql_permisos);
//Script para poder ver cuantos intentos lleva el alumno en la capsula y mostrar cuantos puntos gano dependiendo los intentos

//Contar total de intentos
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_universidad WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 13");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct15apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Realizar una presentación comparativa de los diferentes tipos de conectores USB. Los estudiantes pueden investigar y recopilar información sobre los conectores Tipo A, Tipo B, Mini-USB y Micro-USB. Pueden crear una presentación visual que muestre las características físicas de cada conector, los dispositivos con los que son compatibles y las ventajas y desventajas de cada tipo.
                                    <br> <br>
                                </p>
                            </td>
                ...
                if (frames > 0) {
                    ...
                    `,
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'correcto' + '&permiso=' + 18 + '&id_curso=' + 7 + '&practico=' + 10;
                            }
                        });
                    } else if (puntos == 6) {
                        Swal.fire({
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'incorrecto' + '&permiso=' + 18 + '&id_curso=' + 7 + '&practico=' + 10;
