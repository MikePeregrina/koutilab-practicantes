...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 14 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Diseña un folleto educativo sobre los periféricos mixtos y su importancia en el mundo digital. Crea un folleto informativo que explique qué son los periféricos mixtos, cómo funcionan y por qué son importantes en el contexto de la informática. Pueden incluir ejemplos prácticos y consejos para el uso adecuado de estos dispositivos.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (h1 > 0 && h2 > 0 && p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'correcto' + '&permiso=' + 34 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'incorrecto' + '&permiso=' + 34 + '&id_curso=' + 7 + '&practico=' + 10;
