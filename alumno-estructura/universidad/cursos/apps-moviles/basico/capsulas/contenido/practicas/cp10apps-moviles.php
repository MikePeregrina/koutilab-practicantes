...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/basico/capsulas/contenido/teoricas/ct6apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Realizar un proyecto de investigación sobre la evolución de los dispositivos de entrada a lo largo de la historia de la informática.Investigar y presenta los avances y cambios significativos en dispositivos como el teclado, el ratón, la tableta digitalizadora, etc. Incluyendo imágenes y ejemplos de cada generación de dispositivos.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (ul > 0 && a > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'correcto' + '&permiso=' + 24 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'incorrecto' + '&permiso=' + 24 + '&id_curso=' + 7 + '&practico=' + 10;
                    }
                });
            }
        }*/
