        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T9/217.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T9/218.gif');"></li>
                        <li style="background-image: url('../../img/2/T9/219.gif');"></li>
                        <li style="background-image: url('../../img/2/T9/220.gif');"></li>
                        <li style="background-image: url('../../img/2/T9/221.gif');"></li>
                        <li style="background-image: url('../../img/2/T9/222.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct26apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
