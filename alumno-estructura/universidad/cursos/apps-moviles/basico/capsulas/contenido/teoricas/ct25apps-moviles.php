        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T8/208.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T8/209.gif');"></li>
                        <li style="background-image: url('../../img/2/T8/210.gif');"></li>
                        <li style="background-image: url('../../img/2/T8/211.gif');"></li>
                        <li style="background-image: url('../../img/2/T8/212.gif');"></li>
                        <li style="background-image: url('../../img/2/T8/213.gif');"></li>
                        <li style="background-image: url('../../img/2/T8/214.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct25apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
