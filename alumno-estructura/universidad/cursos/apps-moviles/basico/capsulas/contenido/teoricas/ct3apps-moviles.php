        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/T3/27.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/T3/28.gif');"></li>
                        <li style="background-image: url('../../img/1/T3/29.gif');"></li>
                        <li style="background-image: url('../../img/1/T3/30.gif');"></li>
