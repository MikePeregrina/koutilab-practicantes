        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T10/233.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T10/234.gif');"></li>
                        <li style="background-image: url('../../img/2/T10/235.gif');"></li>
                        <li style="background-image: url('../../img/2/T10/236.gif');"></li>
                        <li style="background-image: url('../../img/2/T10/237.gif');"></li>
                        <li style="background-image: url('../../img/2/T10/238.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="67">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="7">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct28apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
