...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>ESTADISTICAS</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				...
				'<img src="../../img/img-juegos/s (4).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (5).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (6).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (7).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (8).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (9).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (10).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (11).png" width="50px" heigth="60px" >',
				'<img src="../../img/img-juegos/s (12).png" width="50px" heigth="60px" >'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 32 + "&id_curso=" + 9; //cancatenation
