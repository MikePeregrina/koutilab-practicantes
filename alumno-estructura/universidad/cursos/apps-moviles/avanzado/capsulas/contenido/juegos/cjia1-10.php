...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>CREACIÓN DE GRÁFICOS Y DIAGRAMAS</b></h2>
	</div>
	...
	<script>
		...
		var words = ['POWERPOINT', 'GRAFICOS', 'DATOS', 'DIAGRAMAS', 'CIRCULAR', 'DISEÑO', 'BARRAS', 'ELEMENTOS'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 22 + "&id_curso=" + 9; //cancatenation
