...
<body onload="iniciarTiempo();">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>TESTING Y DEPURACIÓN</b></h2>
	</div>
	...
	<script>
		...
		var words = ['LISTAS', 'COMPONENTE', 'ORGANIZAR', 'VERTICAL', 'HORIZONTAL', 'VERSATIL', 'ANDROID', 'SPINNERS'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 16 + "&id_curso=" + 12; //cancatenation
