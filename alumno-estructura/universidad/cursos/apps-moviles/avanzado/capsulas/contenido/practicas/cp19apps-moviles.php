...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct9css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 9 Excel</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crear una hoja de cálculo interactiva en Excel que incluya enlaces a páginas web relevantes. Pueden utilizar hipervínculos para dirigir a recursos adicionales en línea, como artículos, videos educativos o sitios web temáticos.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/avanzadoinf/prac19.PNG" style="height: auto; width: 70%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (divs > 4) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd49.php?validar=' + 'correcto' + '&permiso=' + 49 + '&id_curso=' + 9 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd49.php?validar=' + 'incorrecto' + '&permiso=' + 49 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }*/
