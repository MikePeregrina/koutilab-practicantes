...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula práctica 1 Excel</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Utiliza Excel para diseñar un horario semanal que te ayude a organizar tus actividades diarias. Crea una hoja de cálculo con columnas para los días de la semana y filas para las horas del día. Puedes asignar diferentes colores a las celdas según el tipo de actividad (clases, deporte, tiempo libre, etc.)
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/avanzadoinf/prac11.jpg" style="height: auto; width: 60%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (bolds > 0 && h1 > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'correcto' + '&permiso=' + 28 + '&id_curso=' + 9 + '&practico=' + 10;
                        }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd28.php?validar=' + 'incorrecto' + '&permiso=' + 28 + '&id_curso=' + 9 + '&practico=' + 10;
                    }
                });
            }
        }*/
