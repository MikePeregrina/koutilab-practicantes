...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct5css.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 5 Excel</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crea una lista de calificaciones de diferentes asignaturas y utiliza formulas para obtener el promedio, calificacion mas alta y calificacion mas baja.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">

                                <img src="../../../../../../img/avanzadoinf/prac15.PNG" style="height: auto; width: 50%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'correcto' + '&permiso=' + 40 + '&id_curso=' + 9 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd40.php?validar=' + 'incorrecto' + '&permiso=' + 40 + '&id_curso=' + 9 + '&practico=' + 10;
