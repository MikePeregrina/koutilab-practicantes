...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6 Apps Móviles</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T6/53.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/54.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/55.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T6/56.gif');"></li>
                            ...
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">
                                            Enviar y recibir mensajes a través de un servicio de red.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox3">
                                            Abrir archivos y documentos.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            No se menciona la función principal del correo electrónico.
                                        </label>
                                    </div>
