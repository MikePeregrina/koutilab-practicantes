        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T16/124.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T16/125.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T16/126.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T16/127.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T16/128.gif');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es la función principal de los "Controles de contenido" en Word al crear formularios interactivos?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Permitir a los usuarios introducir información y responder preguntas de manera estructurada
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Establecer márgenes y espaciado en el formulario
                                        </label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox4">
                                            Agregar formato de color al formulario
                                        </label>
                                    </div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct16apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
