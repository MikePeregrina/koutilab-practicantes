        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T10/65.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/66.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/67.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/68.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/69.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/70.gif');"></li>
                        <li>
                            <div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct10apps-moviles.php';
                    }
                });
