...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>INTEGRACIÓN DE SCRIPTS EN UNITY</b></h2>
    </div>
    ...
    <section>
        ...
        <div class="cont-st">
            ...
            <h4 class="titulo"><b>Copia el código del lado izquierdo al lado derecho</b></h4>
        </div>
    ...
    <script>
        ...
        public string nombre; </br></br>

        void Start() { </br>
            Debug.log("Hola, mi nombre es " + nombre); </br>
        }
        `;
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 43 + "&id_curso=" + 10; //cancatenation
        ...
        function alertExcelent() {
            ...
            if (text1 === text2) {
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 43 + "&id_curso=" + 10; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_pd43.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
