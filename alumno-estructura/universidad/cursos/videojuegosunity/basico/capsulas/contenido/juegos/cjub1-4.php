...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>LIMITES DE PANTALLA</b></h2>
    </div>
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("PANTALLA");
        palabras_array.push("ESCALER");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "PANTALLA": // Se debera hacer un case por cada palabra
                    pista = "Las aplicaciones y juegos modernos a veces necesitan soportar una variedad amplia de diferentes resoluciones de.";
                    break; // Es importante el break en cada case
                case "SCALER":
                    pista =
                        "Funciona. Por defecto, compara la anchura o la resolución actual con la anchura del Canvas .";
                    break;
