...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <script>
        ...
        function tiempoAgotado() {
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 15 + "&id_curso=" + 10; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_pd15.php", true);
        ...
        function alertExcelent() {
            var xmlhttp = new XMLHttpRequest();
            var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 15 + "&id_curso=" + 10; //cancatenation
            xmlhttp.open("POST", "../../acciones/insertar_pd15.php", true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send(param);
            Swal.fire({
