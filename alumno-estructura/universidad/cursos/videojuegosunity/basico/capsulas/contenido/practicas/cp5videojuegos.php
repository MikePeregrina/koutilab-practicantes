...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/basico/capsulas/contenido/teoricas/ct5videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Graba pantalla donde estés utilizando diferentes limites de pantalla, previamente ya pusiste un fondo para ver la diferencia del limite que vayas cambiando.
                                    <br>
                                </p>
                            </td>
