...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/videojuegosunity/basico/capsulas/contenido/teoricas/ct13videojuegos.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Agrega un audio en tu proyecto y graba la pantalla del proceso.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (style > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd31.1.php?validar=' + 'correcto' + '&permiso=' + 31 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd31.1.php?validar=' + 'incorrecto' + '&permiso=' + 31 + '&id_curso=' + 7 + '&practico=' + 10;
