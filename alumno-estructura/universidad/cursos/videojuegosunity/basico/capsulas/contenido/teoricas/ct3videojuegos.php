        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T3/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/8.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/9.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/10.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/11.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es la estructura de un proyecto en Unity?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Assets, Escena, Objeto y Componente</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Título y contenido</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Escenas e Imágenes</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">Componentes</label>
                                    </div>
                                    <input type="hidden" name="permiso" value="8">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="10">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct3videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
