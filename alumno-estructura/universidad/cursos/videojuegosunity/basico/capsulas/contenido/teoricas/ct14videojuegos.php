...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 3 Videojuegos</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T14/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T14/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T14/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T14/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T14/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T14/6.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué permite hacer un Prefabs tipo asset?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Mantener limpio el juego
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Almacenar un objeto Game Object
                                        </label>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox4">
                                            Almacenar los assets definidos
                                        </label>
                                    </div>
                                    <input type="hidden" name="permiso" value="33">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="10">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct14videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
