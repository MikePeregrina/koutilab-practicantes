        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T9/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T9/7.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para qué sirven las etiquetas?</h1>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox2">
                                            Para identificar objetos en un proyecto.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Para poner un subtitulo.
                                        </label>
                                    </div>
                                    <div>
