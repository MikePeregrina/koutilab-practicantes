...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 7 Videojuegos Unity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T19/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/8.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/9.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T19/10.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuál es el nombre de las opciones que se visualizan inicialmente?</h1>
                                    <div>
                                    ...
                                    <input type="hidden" name="permiso" value="45">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="10">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct19videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
