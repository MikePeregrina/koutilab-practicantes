...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T4/97.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4/98.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4/99.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T4/100.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4/101.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct15videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/u (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/u (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/u (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/u (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/u (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/u (6).png" height="60px" width="50px" >'
            ]
        }
