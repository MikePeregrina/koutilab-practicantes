        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T13/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T13/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T13/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T13/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T13/5.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Para qué sirve un mezclador o audio mixer?</h1>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox2">
                                            Para controlar el volumen aplicar efectos entre otras.
                                        </label>
                                    </div>
                                    <div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct13videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
