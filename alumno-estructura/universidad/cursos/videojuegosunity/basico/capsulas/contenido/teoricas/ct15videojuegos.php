        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T15/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T15/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T15/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T15/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T15/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T15/6.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué definen los Codillers?</h1>
                                    <div>
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            La forma de como esta estructurado.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            La forma de un objeto para los propósitos de colisiones físicas.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Tener el proposito ya definido.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            La forma de como esta un juego.
                                        </label>
                                    </div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct15videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
