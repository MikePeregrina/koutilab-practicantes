        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T6/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T6/5.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿De cuantas maneras se clasifican los Assets?</h1>
                                    <div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct6videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
