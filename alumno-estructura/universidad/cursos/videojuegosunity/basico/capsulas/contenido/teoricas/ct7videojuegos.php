        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T7/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/7.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/8.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T7/9.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuántas carpetas debemos crear dentro de los Assets para crear un fondo?</h1>
                                    <div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct7videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
