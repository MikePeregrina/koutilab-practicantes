...
$id_user = $_SESSION['id_alumno_universidad'];
$permiso = "capsula1";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_universidad c INNER JOIN detalle_capsulas_universidad d ON c.id_capsula = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 10");
...
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_universidad WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 10");
...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T1/7.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T1/8.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T1/9.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="computacion">Computacion</div>
                                        <div class="word-box" id="sistemas">Sistemas</div>
                                        <div class="word-box" id="maquinas">Maquinas</div>
                                        <div class="word-box" id="procesamiento">Procesamiento</div>
                                        <div class="word-box" id="componente">Componente</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="hardware" onclick="checkAnswer('hardware')">
                                            Hardware</div>
                                        <div class="word-box" id="logicas" onclick="checkAnswer('logicas')">
                                            Logicas</div>
                                        <div class="word-box" id="automatico" onclick="checkAnswer('automatico')">
                                            Automatico
                                        </div>
                                        <div class="word-box" id="automatizados" onclick="checkAnswer('automatizados')">
                                            Automatizados
                                        </div>
                                        <div class="word-box" id="videojuegosunity" onclick="checkAnswer('videojuegosunity')">
                                            videojuegosunity</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T1/10.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct1videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'videojuegosunity' &&
                palabraseleccionada.id !== 'automatizados' &&
                palabraseleccionada.id !== 'logicas' &&
                palabraseleccionada.id !== 'automatico' &&
                palabraseleccionada.id !== 'hardware'
            ) {
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'videojuegosunity' && idPalabraSeleccionada === 'computacion') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'automatizados' && idPalabraSeleccionada === 'sistemas') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === 'logicas' && idPalabraSeleccionada === 'maquinas'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'automatico' && idPalabraSeleccionada === 'procesamiento'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'hardware' && idPalabraSeleccionada === 'componente'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
