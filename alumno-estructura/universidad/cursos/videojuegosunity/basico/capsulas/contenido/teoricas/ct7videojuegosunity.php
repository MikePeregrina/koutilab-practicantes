...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T6/43.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T6/44.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T6/45.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T6/46.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct7videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/d (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/d (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/d (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/d (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/d (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/d (6).png" height="60px" width="50px" >'
            ]
        }
