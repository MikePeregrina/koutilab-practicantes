        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T11/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T11/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T11/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T11/4.jpg');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox1">
                                            Es el conjunto de instrucciones que vas a definir para ejecutar una acción en especifico.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Es un conjunto de instrucciones que nos ayudan a llevar acciones.
                                        </label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Permite crear juegos con varios niveles.
                                        </label>
                                    </div>
                                    <div>
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct11videojuegos.php">
                                </form>
                            </div>
                        </li>
                    </ul>
