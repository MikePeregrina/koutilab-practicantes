        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/61.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/62.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/63.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T8/64.gif');"></li>
                        <li>
                            <div>
