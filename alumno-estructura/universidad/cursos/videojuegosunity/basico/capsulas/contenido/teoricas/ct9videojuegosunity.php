...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 7.5 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T7.5/55.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T7.5/56.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T7.5/57.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="dispositivo">Dispositivo</div>
                                        <div class="word-box" id="recuperar">Recuperar</div>
                                        <div class="word-box" id="disco">Disco</div>
                                        <div class="word-box" id="memoria">Memoria</div>
                                        <div class="word-box" id="almacenar">Almacenar</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="almacenamiento" onclick="checkAnswer('almacenamiento')">
                                            Almacenamiento</div>
                                        <div class="word-box" id="ram" onclick="checkAnswer('ram')">
                                            RAM</div>
                                        <div class="word-box" id="rigido" onclick="checkAnswer('rigido')">
                                            Rigido
                                        </div>
                                        <div class="word-box" id="informacion" onclick="checkAnswer('informacion')">Informacion
                                        </div>
                                        <div class="word-box" id="almacenar" onclick="checkAnswer('almacenar')">
                                            Almacenar</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T7.5/58.gif');"></li>
                        <li>
                            <div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct9videojuegosunity.php';
                    }
                });
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'almacenamiento' &&
                palabraseleccionada.id !== 'informacion' &&
                palabraseleccionada.id !== 'rigido' &&
                palabraseleccionada.id !== 'ram' &&
                palabraseleccionada.id !== 'archivos'
            ) {
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'almacenamiento' && idPalabraSeleccionada === 'dispositivo') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'informacion' && idPalabraSeleccionada === 'recuperar') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === 'rigido' && idPalabraSeleccionada === 'disco'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'ram' && idPalabraSeleccionada === 'memoria'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'archivos' && idPalabraSeleccionada === 'almacenar'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
