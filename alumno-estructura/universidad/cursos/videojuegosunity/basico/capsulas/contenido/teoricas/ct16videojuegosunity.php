...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/104.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/105.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/106.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T4.5/107.gif');"></li>
                        <li>
                            <div>
    ...
    <script>
        ...
        var words = ['SISTEMA', 'OPERATIVO', 'SOFTWARE', 'RECURSOS'];
