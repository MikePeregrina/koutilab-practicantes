...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T4/31.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T4/32.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T4/33.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="gestionar">Gestionar</div>
                                        <div class="word-box" id="encender">Encender</div>
                                        <div class="word-box" id="windows">Windows</div>
                                        <div class="word-box" id="protocolo">Protocolo</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="microsoft" onclick="checkAnswer('microsoft')">
                                            Microsoft</div>
                                        <div class="word-box" id="operativos" onclick="checkAnswer('operativos')">
                                            Operativos</div>
                                        <div class="word-box" id="recursos" onclick="checkAnswer('recursos')">
                                            Recursos
                                        </div>
                                        <div class="word-box" id="dispositivos" onclick="checkAnswer('dispositivos')">Dispositivos
                                        </div>
                                        <div class="word-box" id="wifi" onclick="checkAnswer('wifi')">
                                            WI-FI</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T4/34.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct5videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'operativos' &&
                palabraseleccionada.id !== 'recursos' &&
                palabraseleccionada.id !== 'dispositivos' &&
                palabraseleccionada.id !== 'microsoft' &&
                palabraseleccionada.id !== 'wifi'
            ) {
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'operativos' && idPalabraSeleccionada === 'sistemas') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'recursos' && idPalabraSeleccionada === 'gestionar') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === 'dispositivos' && idPalabraSeleccionada === 'encender'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'microsoft' && idPalabraSeleccionada === 'windows'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'wifi' && idPalabraSeleccionada === 'protocolo'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
