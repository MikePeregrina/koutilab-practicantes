...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/2/T2/83.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T2/84.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T2/55.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="introducir">Introducir</div>
                                        <div class="word-box" id="funciones">Funciones</div>
                                        <div class="word-box" id="numerico">Numerico</div>
                                    ...
                                    <div class="right-column">
                                        <!-- Respuestas -->
                                        <div class="word-box" id="datos" onclick="checkAnswer('datos')">
                                            Datos</div>
                                        <div class="word-box" id="b3" onclick="checkAnswer('b3')">
                                            B3</div>
                                        <div class="word-box" id="f6" onclick="checkAnswer('f6')">
                                            F6
                                        </div>
                                        <div class="word-box" id="5" onclick="checkAnswer('5')">5
                                        </div>
                                        <div class="word-box" id="ctrl" onclick="checkAnswer('ctrl')">
                                            Ctrl</div>
                                    </div>
                                </div>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/2/T2/86.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/2/T2/87.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct13videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                ...
                palabraseleccionada.id !== 'f6' &&
                palabraseleccionada.id !== '5' &&
                palabraseleccionada.id !== 'b3' &&
                palabraseleccionada.id !== 'ctrl'
            ) {
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'datos' && idPalabraSeleccionada === 'introducir') {
                    ...
                    //sumamos al contador
                    respuestasCorrectas++;
                } else if (respuesta === 'f6' && idPalabraSeleccionada === 'funciones') {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    contexto.strokeStyle = "#84c42c";
                    ...
                    respuesta === '5' && idPalabraSeleccionada === 'numerico'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'b3' && idPalabraSeleccionada === 'alfanumerico'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
                    ...
                    respuesta === 'ctrl' && idPalabraSeleccionada === 'especiales'
                ) {
                    palabraseleccionada.classList.add('correcto');
                    contexto.beginPath();
                    contexto.lineWidth = 3;
