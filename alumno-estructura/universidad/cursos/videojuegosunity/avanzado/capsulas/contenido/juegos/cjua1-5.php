  ...
  <div class="contenido">
    ...
    <div class="container">
      <section>
        ...
        <h3>
          1- ¿Para que el Jugador pueda saltar, bastaría con aplicar una fuerza vertical a su
          Rigidbody 2D cuando se pulse una tecla?
          <select class="select" id="respuesta0">
            <!--Generando lista de opciones de respuesta de la pregunta 1-->
            <option value="----">...</option>
            <option value="incorrecto">AMBOS</option>
        ...
        <h3>
          2- Si ahora aplicas al Jugador una Potencia de Salto de unos 200 en su Inspector window
          y ejecutas el juego, verás que el Jugador ¿puede?
          <select class="select" id="respuesta1">
            <!--Generando lista de opciones de respuesta de la pregunta 2-->
            <option value="----">...</option>
            <option value="incorrecto">DORMIR</option>
            <option value="incorrecto">VOLAR</option>
            <option value="correcto">SALTAR</option>
          </select>
        </h3>
        <!--Generando pregunta 3-->
        <h3>
          3- Para que el jugador este en el suelo ocupamos ?
          <select class="select" id="respuesta2">
            <!--Generando lista de opciones de respuesta de la pregunta 3-->
            <option value="----">...</option>
            <option value="correcto">TILEMAP SUELO</option>
            <option value="incorrecto">SUELO</option>
            <option value="incorrecto">TILEMAP</option>
          </select>
        </h3>
        <!--Generando primer pregunta-->

        <h3>
          4- ¿Si ahora aplicas al Jugador una Potencia de Salto de unos 200 en su Inspector window y ejecutas el juego,
          verás que el Jugador salta, pero solo cuando está en el ?
          <select class="select" id="respuesta3">
            <!--Generando opciones de respuesta de la pregunta-->
            <option value="----">...</option>
            <option value="incorrecto">CIELO</option>
            <option value="incorrecto">FELIZ</option>
            <option value="correcto">SUELO</option>
          </select>
        </h3>
        <!--Generando primer pregunta-->
      </section>
  ...
  <script>
    ...
    function iniciarTiempo() {
      ...
      if (segundos == 0) {
        ...
        var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 22 + "&id_curso=" + 12; //cancatenation
    ...
    function alertExcelent() {
      var xmlhttp = new XMLHttpRequest();
      var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 22 + "&id_curso=" + 12; //cancatenation
      xmlhttp.open("POST", "../../acciones/insertar_pd22.php", true);
      xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
      xmlhttp.send(param);
      Swal.fire({
