    ...
    <script>
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "DESOVE": // Se debera hacer un case por cada palabra
                    pista = "Simplemente colocan objetos dentro o fuera de la piscina..";
                    break; // Es importante el break en cada case
                case "OBJETOS":
                    pista =
                        "¿Cuando se usan funciones de generación personalizadas, a veces es útil poder degenerar?.";
                    break;
