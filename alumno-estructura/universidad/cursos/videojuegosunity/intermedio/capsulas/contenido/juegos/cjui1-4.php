...
<body onload="iniciarTiempo()">
    ...
    <script>
        ...
        const adivinanzas = [{
                pregunta: "Una barra de vida es una característica común en los  J _ _ G _ S",
                respuesta: "juegos",
                respondida: false
            },
            {
                pregunta: "En donde puedes crear una barra de vida visualmente atractiva y funcional. Pista: U _ I _ Y",
                respuesta: "unity",
                respondida: false
            },
            {
                pregunta: "Utiliza métodos para aumentar o disminuir la vida según los  E _ _ _ T _ S",
                respuesta: "eventos", 
                respondida: false
            },
            {
                pregunta: "En los eventos o acciones del juego donde la vida cambie, utiliza los métodos 'TakeDamage' o H _ _ L ",
                respuesta: "heal",
                respondida: false
            },
            {
                pregunta: "Para indicar la cantidad de daño o curación en cada evento se utiliza. Pista: P _ _ A _ E _ _ O",
                respuesta: "parametro",
                respondida: false
            }
        ];
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 27 + "&id_curso=" + 14 + "&redireccion=" + '../contenido/juegos/cjcss3.php'; //cancatenation
