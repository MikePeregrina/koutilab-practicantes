...
<body onload="iniciarTiempo(), iniciar() ">
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("MECANICA");
        palabras_array.push("SHOOT");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "MECANICA": // Se debera hacer un case por cada palabra
                    pista = "¿El control de disparos es una?.";
                    break; // Es importante el break en cada case
                case "SHOOT":
                    pista =
                        "Utiliza métodos para controlar la lógica de disparo, ¡como el método?.";
                    break;
