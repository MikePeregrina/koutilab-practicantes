...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>EXPRESIONES GENERADORAS</b></h2>
    </div>
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="horizontal">
                                1.Es lo que las expresiones generadoras, generan uno a uno.
                                <br /><br />
                                2.Se utiliza para crear las expresiones generadoras
                                <br /><br />
                                <b style="margin-left: 66px" class="tituloV">Verticales:</b>
                                <div class="vertical">
                                1.Se crean utilizando paréntesis ( ) y no es en plural.
                                <br /><br />
                                2.La traduccion al ingles de perezoso
                                <br> <br>
                                3.Debemos colocar todos los elementos que queramos añadir a esa lista entre corchetes [ ] y separados por comas
                                </div>
                            </div>
                        </td>
                        <td></td>
            ...
            <div class="crucigrama">
                <div class="numero2" style="margin: -500px 0 0 155px;">1.</div>
                <div class="numero1-1" style="margin: -200px 0 0 350px;">3.</div>
                <div class="numero1" style="margin: -200px 0 0 -370px;">2.</div>
                <div class="numero2-2" style="margin: -420px 0 0 -440px;">1.</div>
                <div class="numero2-2" style="margin: 0px 0 0 -540px;">2.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
    ...
    <script>
        ...
        var palabra2_letra8 = document.getElementById("fila8C7");
        var palabra2_letra9 = document.getElementById("fila9C7");
        ...
        var palabra3_letra9 = document.getElementById("fila5C9");
        var palabra3_letra10 = document.getElementById("fila5C10");

        //Palabra lazy
        var palabra4_letra1 = document.getElementById("fila4C2");
        var palabra4_letra2 = document.getElementById("fila5C2");
        var palabra4_letra3 = document.getElementById("fila6C2");
        var palabra4_letra4 = document.getElementById("fila7C2");

         //Palabra listas
        var palabra5_letra1 = document.getElementById("fila4C9");
        var palabra5_letra2 = document.getElementById("fila5C9");
        var palabra5_letra3 = document.getElementById("fila6C9");
        var palabra5_letra4 = document.getElementById("fila7C9");
        var palabra5_letra5 = document.getElementById("fila8C9");
        var palabra5_letra6 = document.getElementById("fila9C9");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "valores" &&
                palabra2.toLowerCase() == "expresion" &&
                palabra3.toLowerCase() == "parentesis" &&
                palabra4.toLowerCase() == "lazy" &&
                palabra5.toLowerCase() == "listas"
            ) {
                ...
                if (palabra1.toLowerCase() != "valores") {
                    palabra1_letra1.value = "";
                    palabra1_letra2.value = "";
                    palabra1_letra3.value = "";
                    palabra1_letra4.value = "";
                ...
                if (palabra2.toLowerCase() != "expresion") {
                    palabra2_letra1.value = "";
                    palabra2_letra2.value = "";
                    palabra2_letra3.value = "";
                    palabra2_letra4.value = "";
                ...
                if (palabra3.toLowerCase() != "parentesis") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra5.toLowerCase() != "listas") {
                    palabra5_letra1.value = "";
                    palabra5_letra2.value = "";
                    palabra5_letra3.value = "";
                    palabra5_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "valores") {
                    palabra1_letra6.value = "e";
                }

                if (palabra2.toLowerCase() == "expresion") {
                    palabra2_letra5.value = "e";
                    palabra2_letra1.value = "e";
                }

                if (palabra3.toLowerCase() == "parentesis") {
                    palabra3_letra2.value = "a";
                    palabra3_letra7.value = "e";
                    palabra3_letra9.value = "i";
                }
