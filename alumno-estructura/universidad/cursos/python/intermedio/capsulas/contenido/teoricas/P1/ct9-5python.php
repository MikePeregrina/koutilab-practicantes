...
if (empty($existe)) {
    header("Location: ../../../../capsulas/contenido/alertas/paquete_premium3.php");
}
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/1/T9.5/94.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/1/T9.5/95.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T9.5/96.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T9.5/97.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T9.5/98.gif');"></li>
                        <li style="background-image: url('../../../../img/1/T9.5/99.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_ct6-5py.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Una colección ordenada y mutable de valores.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Una variable que almacena un único valor.</label>
                                    </div>
                                    <div class="container-question">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox4">Un operador utilizado para realizar operaciones matemáticas.</label>
                                    </div>
