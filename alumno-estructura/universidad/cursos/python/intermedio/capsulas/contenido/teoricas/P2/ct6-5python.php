...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6.5 Python</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../../img/2/T6.5/167.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../../img/2/T6.5/168.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T6.5/169.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T6.5/170.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T6.5/171.gif');"></li>
                        <li style="background-image: url('../../../../img/2/T6.5/172.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_P2ct6-5py.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué son las excepciones personalizadas?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">Son clases que se crean en Python para manejar situaciones específicas de error o excepción en un programa.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Son funciones especiales utilizadas para realizar operaciones matemáticas complejas.</label>
                                    </div>
                                    <div class="container-question">
