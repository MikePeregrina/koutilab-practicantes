...
// $sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_universidad c INNER JOIN detalle_capsulas_pago_universidad d ON c.id_capsula_pago = d.id_capsula WHERE d.id_alumno = $id_user AND c.nombre = '$permiso' AND d.id_curso = 5;");
...
<body onload="alert1()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>USO DE LA BIBLIOTECA DATETIME</b></h2>
	</div>
	...
	<section>
		...
		<div class="slide-contenedor">
			<div id="puzzle_container" style="width: 412px; height: 412px;">
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-0-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-1-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-2-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-3-0.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-0-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-1-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-2-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-3-1.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-0-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-1-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-2-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-3-2.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-0-3.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-1-3.png" class="contenedor-img" alt=""></div>
				<div class="puzzle_block" style="width: 103px; height: 103px;"><img src="img/lvl2/IMG2-2-3.png" class="contenedor-img" alt=""></div>
			</div>
		</div>
