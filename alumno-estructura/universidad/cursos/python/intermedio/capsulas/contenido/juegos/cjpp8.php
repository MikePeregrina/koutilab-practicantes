...
<body onload="iniciarTiempo();">
    ...
    <div class="titulo-gen">
        <h4 class="titulo"><b>RESOLUCIÓN DE PROBLEMAS CON CÓDIGO</b></h4>
    </div>
    ...
    <section>
        ...
        <div class="mjuego">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="horizontal">
                                1. Es lo que escribimos cuando queremos programar
                                <br /><br />
                                2. Es lo que diseñamos cuando ya identificamos el problema para poder programarlo
                                <br /><br />
            ...
            <div class="crucigrama" style="scale: 85%;">
                <div class="numero1" style="margin: -175px 0 0 -550px;">1.</div>
                <div class="numero2" style="margin: -500px 0 0 480px;">2.</div>
                <div class="numero1-1" style="margin: -500px 0 0 -350px;">1.</div>
                <div class="numero2-2" style="margin: 60px 0 0 -550px;">2.</div>
                <table id="crucigrama">
                    <tr>
                        <td>
    ...
    <script>
        ...
        var palabra1_letra4 = document.getElementById("fila4C9");
        var palabra1_letra5 = document.getElementById("fila5C9");
        var palabra1_letra6 = document.getElementById("fila6C9");
        ...
        //Palabra problema
        var palabra3_letra1 = document.getElementById("fila1C2");
        var palabra3_letra2 = document.getElementById("fila2C2");
        var palabra3_letra3 = document.getElementById("fila3C2");
        var palabra3_letra4 = document.getElementById("fila4C2");
        var palabra3_letra5 = document.getElementById("fila5C2");
        var palabra3_letra6 = document.getElementById("fila6C2");
        var palabra3_letra7 = document.getElementById("fila7C2");
        var palabra3_letra8 = document.getElementById("fila8C2");
        ...
        var palabra4_letra9 = document.getElementById("fila5C9");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "python" &&
                palabra2.toLowerCase() == "codigo" &&
                palabra3.toLowerCase() == "problema" &&
                palabra4.toLowerCase() == "algoritmo"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra1.toLowerCase() != "python") {
                    palabra1_letra1.value = "";
                    palabra1_letra2.value = "";
                    palabra1_letra3.value = "";
                    palabra1_letra4.value = "";
                ...
                if (palabra2.toLowerCase() != "codigo") {
                    palabra2_letra1.value = "";
                    palabra2_letra2.value = "";
                    palabra2_letra3.value = "";
                    palabra2_letra4.value = "";
                ...
                if (palabra3.toLowerCase() != "problema") {
                    palabra3_letra1.value = "";
                    palabra3_letra2.value = "";
                    palabra3_letra3.value = "";
                    palabra3_letra4.value = "";
                ...
                if (palabra4.toLowerCase() != "algoritmo") {
                    palabra4_letra1.value = "";
                    palabra4_letra2.value = "";
                    palabra4_letra3.value = "";
                    palabra4_letra4.value = "";
                ...
                if (palabra1.toLowerCase() == "python") {
                    palabra4_letra9.value = "o";
                }

                if (palabra2.toLowerCase() == "codigo") {
                    palabra3_letra3.value = "o";
                }

                if (palabra3.toLowerCase() == "problema") {
                    palabra2_letra2.value = "o";
                    palabra4_letra2.value = "l";
                }

                if (palabra4.toLowerCase() == "algoritmo") {
                    palabra1_letra5.value = "o";
                    palabra3_letra5.value = "l";
                }
            }
        }
    </script>
