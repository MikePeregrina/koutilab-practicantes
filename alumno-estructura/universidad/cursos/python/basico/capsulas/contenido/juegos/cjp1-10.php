...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>MANEJO DE ERRORES BASICOS CON TRY Y EXCEPT</b></h2>
    </div>
    ...
    <section>
        ...
        <div class="cont-st">
            ...
            <h4 class="titulo"><b>Copia el fragmento de código del lado izquierdo al lado derecho para ganar el juego</b></h4>
        </div>
    ...
    <script src="../../js/copiar-codigo2.js"></script>
</body>
