    ...
    <div class="body">
        <div class="container">
            ...
            <section id="container-slider">
                ...
                <ul id="slider">
                    <li style="background-image: url('../../img/bienvenidaintermedio/1.gif'); z-index:0; opacity: 1;"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/2.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/3.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/4.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/5.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/6.gif');"></li>
