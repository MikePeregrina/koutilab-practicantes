        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T3/174.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T3/175.gif');"></li>
                        <li style="background-image: url('../../img/3/T3/176.gif');"></li>
                        <li style="background-image: url('../../img/3/T3/177.gif');"></li>
                        <li style="background-image: url('../../img/3/T3/178.gif');"></li>
                        <li style="background-image: url('../../img/3/T3/179.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_ct3js.php">
                                    ...
                                    <input type="hidden" name="permiso" value="54">
