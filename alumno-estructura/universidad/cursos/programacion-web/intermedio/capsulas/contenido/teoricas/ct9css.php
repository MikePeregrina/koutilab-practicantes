        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T6.5/139.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T6.5/140.gif');"></li>
                        <li style="background-image: url('../../img/2/T6.5/141.gif');"></li>
                        <li style="background-image: url('../../img/2/T6.5/142.gif');"></li>
                        <li style="background-image: url('../../img/2/T6.5/143.gif');"></li>
                        <li>
                            <div>
