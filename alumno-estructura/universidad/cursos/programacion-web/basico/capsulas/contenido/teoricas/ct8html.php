        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T8/51.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T8/52.gif');"></li>
                        <li style="background-image: url('../../img/html/T8/53.gif');"></li>
                        <li>
                            <!-- Acoplado -->
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/html/T8/54.gif');"></li>
                        <li>
                            <div>
