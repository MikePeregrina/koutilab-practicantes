        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T7/179.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T7/180.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/181.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/182.gif');"></li>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="<?php echo $permiso_intento ?>">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="1">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct7css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
