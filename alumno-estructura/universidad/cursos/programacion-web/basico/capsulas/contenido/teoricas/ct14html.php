        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/1/T11/98.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/1/T11/99.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/100.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/101.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/102.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/103.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/104.gif');"></li>
                        <li style="background-image: url('../../img/1/T11/105.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct14html.php">
                                </form>
                            </div>
                        </li>
                    </ul>
