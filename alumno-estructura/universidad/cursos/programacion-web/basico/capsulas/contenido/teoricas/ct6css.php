        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T6/93.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T6/94.gif');"></li>
                        <li style="background-image: url('../../img/css/T6/95.gif');"></li>
                        <li>
                            <!-- Acoplado -->
                            <!-- Copiar de aqui -->
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="left-column">
                                        ...
                                        <div class="word-box" id="css">Selector de clase</div>
                                        <div class="word-box" id="sql">Selector de etiqueta</div>
                                        <div class="word-box" id="html">Atributo para dar estilo</div>
                                        <div class="word-box" id="javascript">Selector de id</div>
                                        <div class="word-box" id="php">&lt;style&gt;</div>
                                    </div>
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="estilos" onclick="checkAnswer('estilos')">.clase1 { }
                                        </div>
                        ...
                        <li style="background-image: url('../../img/css/T6/96.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct6css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
