...
<body>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 30 + "&id_curso=" + 9 + "&redireccion=" + '../contenido/juegos/cjia2-1.php'; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		function displayVictoryMess(moves) {
			...
			var xmlhttp = new XMLHttpRequest();
			var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 30 + "&id_curso=" + 9 + "&redireccion=" + '../contenido/juegos/cjia2-1.php'; //cancatenation
			xmlhttp.open("POST", "../../acciones/insertar_pd29.php", true);
			xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			xmlhttp.send(param);
			Swal.fire({
