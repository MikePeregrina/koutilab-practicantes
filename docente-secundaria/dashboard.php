...
$sql_cont = "UPDATE `docentes_secundaria` SET `conexiones`= '$cont'  WHERE id_alumno = '$id_user'";
...
<body>
    ...
    <dialog close id="modalC">
        <div class="container1">
            ...
            if (isset($_POST['enviar'])) {
                ...
                $sql = "UPDATE docentes_secundaria SET contrasena='" . $contrasena . "'";
    ...
    if (isset($_FILES["image"]["name"])) {
      ...
      Swal.fire({
        ...
        ";
            ...
            $query = "UPDATE docentes_secundaria SET image = '$newImageName' WHERE id_docente = $id";
    ...
    if (isset($_POST['enviarcontrasena'])) {
        ...
        $sql_update = mysqli_query($conexion, "UPDATE docentes_secundaria SET contrasena = '$contrasena' WHERE id_docente = '$iddocente'");
