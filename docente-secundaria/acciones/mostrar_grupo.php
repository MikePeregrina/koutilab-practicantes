...
//Estadisticas
$idgrupo = $_REQUEST['id'];
$query1 = mysqli_query($conexion, "SELECT * FROM grupos_secundaria WHERE id_grupo = $idgrupo");
    ...
    <section>
        <div class="board p-2" style="width: 95%;">
            <table id="alumnos" width="100%" class="table border-top">
                ...
                JOIN alumnos_secundaria a ON e.id_alumno = a.id_alumno
                JOIN detalle_grupos_secundaria dg ON dg.id_alumno = a.id_alumno
