...
if (!empty($_POST)) {
    ...
    if (empty($_POST['calificacion'])) {
        ...
        //INSERTA EN DETALLE_CAPSULAS_secundaria
        $query1 = "INSERT INTO detalle_capsulas_secundaria (id_capsula, id_curso, id_alumno) VALUES ($id_capsula, $id_curso, $id_alumno)";
