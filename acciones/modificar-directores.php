...
<body>
    <div id="sidemenu" class="menu-collapsed">
        ...
        <div id="menu-items">
            <div class="item separator"></div>
            <div class="item">
              <a href="../director/dashboard.php" class="">
                <div class="icon">
            ...
            <div class="item separator"></div>
            <div class="item">
              <a href="../director/correo.php" class="">
                <div class="icon">
            ...
            <div class="item separator"></div>
            <div class="item">
              <a href="../director/nueva-escuela.php" class="">
                <div class="icon">
            ...
            <div class="item separator"></div>
            <div class="item">
              <a href="../director/perfil.php" class="">
                <div class="icon">
    ...
    <div class="values"><h3 class="i-name"> Modificar Escuelas</h3></div>
		<div class="container">
			<form  method="POST" action="update-escuela.php" autocomplete="off">
			    <div class="user-details">
                  ...
                  <div class="input-box" >
					...
					<a href="../director/nueva-escuela.php"><button class="btn-grid">Cancelar</button></a></center>
			</form>
		</div>
<script>
