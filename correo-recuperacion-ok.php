...
<!-- Pantalla cuando recuperas el correo correctamente -->
...
<body onload="recuperarDatos()">
    <div class="container">
        ...
        <div class="form-box">
            ...
            <p class="preg">Tu nueva contraseña temporal está activa</p>
            <p class="parrafo">Te enviamos un correo electrónico con una nueva contraseña temporal</p>
            <div class="opt-user">
                <a href="./login.php">
