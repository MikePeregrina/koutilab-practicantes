    ...
    if (isset($_POST['registrar_usuario']) && !empty($_POST['clave_registrar'])) {
      ...
      Swal.fire({
        ...
        ";
            ...
            $query_insert_alumno = mysqli_query($conexion, "INSERT INTO alumnos_personal(nombre, apellidop, apellidom, usuario, contrasena, email, image, fondo) values ('$nombre_registrar', '$apellidop_registrar', '$apellidom_registrar', '$usuario_registrar', '$contrasena_registrar', '$email_registrar', 'Mascota-Aerobot-01.png', 'portada-1.png')");
            if ($query_insert_alumno) {
