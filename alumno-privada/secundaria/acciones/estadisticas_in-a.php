...
$consultaEstadistica = mysqli_query($conexion, "SELECT trofeos, SUM(trofeos) AS total_trofeos, progreso, SUM(progreso) AS total_progreso, puntos, SUM(puntos) AS total_puntos, practico, SUM(practico) AS total_practico, teorico, SUM(teorico) AS total_teorico FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 9"); // Modificando consulta por cada curso
...
$datos_por_capsula = array(
    ...
    "8" => array(
        "area" => "Teórica",
        "tema" => "Uso de reglas, cuadrículas y guías",
        "tipoPuntos" => "Conocimientos"
    ),
    "9" => array(
        "area" => "Práctica",
    ...
    "14" => array(
        "area" => "Teórica",
        "tema" => "Elaborar diapositivas con powerpoint",
        "tipoPuntos" => "Conocimientos"
    ),
    "15" => array(
        "area" => "Práctica",
    ...
    "17" => array(
        "area" => "Teórica",
        "tema" => "Retoques finales powerpoint",
        "tipoPuntos" => "Conocimientos"
    ),
    "18" => array(
        "area" => "Práctica",
    ...
    "28" => array(
        "area" => "Teórica",
        "tema" => "Conceptos básicos: Celda, Hoja, Libro",
        "tipoPuntos" => "Conocimientos"
    ),
    "29" => array(
        "area" => "Práctica",
    ...
    "34" => array(
        "area" => "Teórica",
        "tema" => "Series y formato de texto",
        "tipoPuntos" => "Conocimientos"
    ),
    "35" => array(
        "area" => "Práctica",
    ...
    "43" => array(
        "area" => "Teórica",
        "tema" => "Elementos gráficos de excel",
        "tipoPuntos" => "Conocimientos"
    ),
    "44" => array(
        "area" => "Práctica",
    ...
    "46" => array(
        "area" => "Teórica",
        "tema" => "Trabajar con hojas y libros",
        "tipoPuntos" => "Conocimientos"
    ),
    "47" => array(
        "area" => "Práctica",
...
<body>
    ...
    <div class="containers">
        <a href="../rutas/ruta-in-a.php"><button class="btn-b"><i class="fas fa-reply fa-lg"></i></button></a>
        <h1>CURSO DE INFORMÁTICA AVANZADO DE KOUTILAB</h1>
    </div>
            ...
            <div class="board p-2">
                <table id="alumnos" width="100%" class="table border-top" style="z-index: 1;">
                    ...
                    <tbody>
                        ...
                        $query_alumnos = mysqli_query($conexion, "SELECT *FROM detalle_estadisticas_secundaria
                    WHERE id_curso = 9");
