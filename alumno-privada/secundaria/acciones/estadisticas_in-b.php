...
$consultaEstadistica = mysqli_query($conexion, "SELECT trofeos, SUM(trofeos) AS total_trofeos, progreso, SUM(progreso) AS total_progreso, puntos, SUM(puntos) AS total_puntos, practico, SUM(practico) AS total_practico, teorico, SUM(teorico) AS total_teorico FROM estadisticas_secundaria WHERE id_alumno = $id_user AND id_curso = 7"); // Modificando consulta por cada curso
...
$datos_por_capsula = array(
    ...
    "8" => array(
        "area" => "Teórica",
        "tema" => "Aspectos generales de la informática",
        "tipoPuntos" => "Conocimientos"
    ),
    "9" => array(
        "area" => "Práctica",
    ...
    "11" => array(
        "area" => "Teórica",
        "tema" => "Conocimiento de dispositivos",
        "tipoPuntos" => "Conocimientos"
    ),
    "12" => array(
        "area" => "Práctica",
...
<body>
    ...
    <div class="containers">
        <a href="../rutas/ruta-in-b.php"><button class="btn-b"><i class="fas fa-reply fa-lg"></i></button></a>
        <h1>CURSO DE INFORMÁTICA BÁSICO DE KOUTILAB</h1>
    </div>
