...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct13apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 3 Word</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Crear una tabla para organizar información, selecciona un tema específico y utilizar una tabla de Word para organizar datos relevantes. Por ejemplo, crear una tabla para clasificar información sobre diferentes especies de animales, países y sus capitales, eventos históricos, etc.
                                    <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/intermedioinf/prac13.png" style="height: auto; width: 60%;">
                            </td>
        ...
        function miFunc() {
            ...
            if (style > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'correcto' + '&permiso=' + 34 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd34.php?validar=' + 'incorrecto' + '&permiso=' + 34 + '&id_curso=' + 8 + '&practico=' + 10;
