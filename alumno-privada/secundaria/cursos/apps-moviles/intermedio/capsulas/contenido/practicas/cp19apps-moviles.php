...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct19apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 9 Word</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Practica la creación de un currículum utilizando una plantilla predefinida. Explora las diferentes categorías de plantillas disponibles en Word y seleccionar una que se ajuste a sus necesidades. Luego, pueden personalizarla con su información y darle formato según sus preferencias.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/intermedioinf/prac4.5.jpg" style="height:auto; width: 60%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (divs > 4) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'correcto' + '&permiso=' + 46 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd46.php?validar=' + 'incorrecto' + '&permiso=' + 46 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            }
        }*/
