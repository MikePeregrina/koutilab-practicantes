...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct14apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 4 Word</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crear una lista con viñetas en Word y seleccionar un tema específico para los símbolos o viñetas. Por ejemplo, puedes crear una lista con viñetas para mostrar los pasos de un proceso, utilizando símbolos relacionados con el tema.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/intermedioinf/prac14.png" style="height: auto; width: 60%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (h1 > 0 && h2 > 0 && p > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'correcto' + '&permiso=' + 37 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd37.php?validar=' + 'incorrecto' + '&permiso=' + 37 + '&id_curso=' + 8 + '&practico=' + 10;
