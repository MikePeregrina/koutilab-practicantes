...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/apps-moviles/intermedio/capsulas/contenido/teoricas/ct9apps-moviles.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 9 Apps Móviles</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Crear un tutorial detallado que explique cada paso para configurar una cuenta de correo electrónico. Puedes utilizar capturas de pantalla y descripciones claras para guiar a los usuarios a través del proceso.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (divs > 0 && h3 > 0 && ps > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'correcto' + '&permiso=' + 24 + '&id_curso=' + 8 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd24.php?validar=' + 'incorrecto' + '&permiso=' + 24 + '&id_curso=' + 8 + '&practico=' + 10;
                    }
                });
            }
        }*/
