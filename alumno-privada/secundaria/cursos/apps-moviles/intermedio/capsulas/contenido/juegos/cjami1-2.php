    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- Para instalar Android Studio es necesario verificar los componentes de nuestro equipo de computo para saber si es compatible
                ...
                <h3>2- ¿Cómo abro la ventana de ejecutar?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">Windows + K</option>
                        <option value="incorrecto">Windows + C</option>
                        <option value="correcto">Windows + R</option>
                    </select>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- ¿Qué comando se coloca para saber la información de mi computadora?
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="correcto">msinfo32</option>
                        <option value="incorrecto">msconfig</option>
                        <option value="incorrecto">prefetch</option>
                    </select>
                </h3><!--Generando primer pregunta-->

                <h3>4- ¿Cómo abro el Administrador de dispositivo?
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">Windows + K</option>
                        <option value="incorrecto">Windows + C</option>
                        <option value="correcto">Windows + X</option>
                    </select>
                </h3><!--Generando primer pregunta-->
            </section>
        </div>
