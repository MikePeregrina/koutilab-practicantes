...
<body onload="iniciarTiempo()">
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>IMAGEVIEW DINAMICO EN KOTLIN</b></h2>
	</div>
	...
	<script>
		...
		var preguntas = [
			{
				num: 1,
				pregunta:
					"Crear un ImageView dinámico en Kotlin implica, ¿crear y configurar un objeto?",
				opA: "Falso",
				opB: "Cierto",
				opC: "Ninguna",
				correcta: "B",
			...
			},
			{
				num: 2,
				pregunta:
					"Uno de los  elementos que nunca podemos agregar en una lista en Android son los imageviews.",
				opA: "Falso",
				opB: "Cierto",
				opC: "Ninguna",
				correcta: "A",
			...
			},
			{
				num: 3,
				pregunta:
					"¿En general, los ImageView en Android hacen referencia a un contenedor o recuadro en el que podemos ubicar una imagen.?",
				opA: "Ninguna",
				opB: "Falso",
				opC: "Cierto",
				correcta: "C",
			...
			},
			{
				num: 4,
				pregunta:
					"En general, los ImageView en Android hacen referencia a un contenedor o recuadro en el que podemos ubicar una imagen. En pocas palabras ¿para que sirven?",
				opA: "Editar",
				opB: "Renderizar",
				opC: "Eliminar",
				correcta: "B",
			...
			},
			{
				num: 5,
				pregunta:
					"¿Puedes personalizar aún más el ImageView y su disposición en el LinearLayout según tus necesidades específicas.?",
				opA: "Ninguna",
				opB: "Si, si se puede",
				opC: "No, no se puede",
				correcta: "B",
		...
		function evaluarRespuesta() {
			if (this.seleccion == this.preguntas[random].correcta) {
				...
				if (this.puntos == 5) {
					//Cuando haya acertado las 5 preguntas
					alertExcelent();
				} else {
