        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T11/133.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T11/134.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T11/135.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T11/136.gif');"></li>
                        <li>
                            <div>
