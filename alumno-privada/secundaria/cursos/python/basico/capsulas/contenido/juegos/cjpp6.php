...
<body onload="iniciarTiempo();">
                        ...
                        <td>
                            <div class="horizontal">
                                ...
                                <div class="vertical">
                                    ...
                                    <br /><br />
                                    2. Es el ciclo que no sabemos cuantas veces se va a repetir hasta que se cumpla la condición
                                    <br> <br>
                                    3. Es el ciclo que si sabemos cuantas veces se va a repetir durante su ejecución
                                </div>
                            </div>
                        </td>
    ...
    <script>
        ...
        //Palabra ciclo
        var palabra2_letra1 = document.getElementById("fila3C4");
        var palabra2_letra2 = document.getElementById("fila3C5");
        var palabra2_letra3 = document.getElementById("fila3C6");
        var palabra2_letra4 = document.getElementById("fila3C7");
        var palabra2_letra5 = document.getElementById("fila3C8");

        //Palabra input
        var palabra3_letra1 = document.getElementById("fila2C2");
        var palabra3_letra2 = document.getElementById("fila3C2");
        var palabra3_letra3 = document.getElementById("fila4C2");
        var palabra3_letra4 = document.getElementById("fila5C2");
        var palabra3_letra5 = document.getElementById("fila6C2");
        ...
        //Palabra for
        var palabra5_letra1 = document.getElementById("fila2C8");
        var palabra5_letra2 = document.getElementById("fila3C8");
        var palabra5_letra3 = document.getElementById("fila4C8");
        ...
        function verificar() {
            ...
            if (
                palabra1.toLowerCase() == "bucle" &&
                palabra2.toLowerCase() == "ciclo" &&
                palabra3.toLowerCase() == "input" &&
                palabra4.toLowerCase() == "while" &&
                palabra5.toLowerCase() == "for"
            ) {
                var xmlhttp = new XMLHttpRequest();
                ...
                if (palabra1.toLowerCase() == "bucle") {
                    palabra3_letra4.value = "u";
                    palabra4_letra5.value = "e";
                }
