...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 4 Python Básico</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P2/T4/152.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P2/T4/153.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/154.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/155.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/156.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T4/157.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../../acciones/insertar_teorica.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Comparar dos valores o expresiones segun verdadero o falso.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Realizar operaciones aritméticas.</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Definir variables y constantes.</label>
                                    </div>
                                    <div class="container-question">
