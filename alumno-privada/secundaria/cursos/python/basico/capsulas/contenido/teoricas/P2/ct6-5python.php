        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../../img/P2/T6.5/173.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../../img/P2/T6.5/174.gif');"></li>
                        <li style="background-image: url('../../../img/P2/T6.5/175.gif');"></li>
