        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T8/186.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T8/187.gif');"></li>
                        <li style="background-image: url('../../img/css/T8/188.gif');"></li>
                        <li style="background-image: url('../../img/css/T8/189.gif');"></li>
                        <li style="background-image: url('../../img/css/T8/190.gif');"></li>
                        <li style="background-image: url('../../img/css/T8/191.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <label for="checkbox1">Establece el estilo de línea</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">Es una línea con estilo</label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">Es una línea</label>
                                    </div>
                                    <div class="container-question">
