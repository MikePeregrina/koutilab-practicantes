        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/html/T4/29.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/html/T4/30.gif');"></li>
                        <li style="background-image: url('../../img/html/T4/31.gif');"></li>
                        <li style="background-image: url('../../img/html/T4/32.gif');"></li>
                        <li style="background-image: url('../../img/html/T4/33.gif');"></li>
                        <li style="background-image: url('../../img/html/T4/34.gif');"></li>
                        <li>
                            <div>
