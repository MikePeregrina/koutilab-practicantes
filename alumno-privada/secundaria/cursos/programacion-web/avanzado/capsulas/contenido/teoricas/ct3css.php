        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/css/T2/77.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/css/T2/78.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/79.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/82.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/81.gif');"></li>
                        <li style="background-image: url('../../img/css/T2/82.gif');"></li>
                        <li>
                            <div>
