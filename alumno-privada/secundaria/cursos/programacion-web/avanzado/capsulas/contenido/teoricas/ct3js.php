        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/js/T3/132.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/js/T3/133.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/134.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/135.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/136.gif');"></li>
                        <li style="background-image: url('../../img/js/T3/137.gif');"></li>
                        <li>
                            <div>
