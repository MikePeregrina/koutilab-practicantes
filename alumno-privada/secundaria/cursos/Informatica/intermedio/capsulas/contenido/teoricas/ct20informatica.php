        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/10/156.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/10/157.gif');"></li>
                        <li style="background-image: url('../../img/2/10/158.gif');"></li>
                        <li style="background-image: url('../../img/2/10/159.gif');"></li>
