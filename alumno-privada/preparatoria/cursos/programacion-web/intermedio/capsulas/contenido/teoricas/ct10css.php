        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/2/T7/145.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/2/T7/146.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/147.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/148.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/149.gif');"></li>
                        <li style="background-image: url('../../img/2/T7/150.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct10css.php">
                                </form>
                            </div>
                        </li>
                    </ul>
