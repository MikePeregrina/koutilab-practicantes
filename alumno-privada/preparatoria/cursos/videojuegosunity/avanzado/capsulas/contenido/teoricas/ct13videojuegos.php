        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunitya/T13/1.jpg'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/2.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/3.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/4.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/5.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/6.jpg');"></li>
                        <li style="background-image: url('../../img/videojuegosunitya/T13/7.jpg');"></li>

                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>Spawn/on ¿Qué define?</h1>
