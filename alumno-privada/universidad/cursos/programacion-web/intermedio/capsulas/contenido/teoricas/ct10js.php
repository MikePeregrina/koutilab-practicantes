        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/3/T7/223.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/3/T7/224.gif');"></li>
                        <li style="background-image: url('../../img/3/T7/225.gif');"></li>
                        <li style="background-image: url('../../img/3/T7/226.gif');"></li>
                        <li style="background-image: url('../../img/3/T7/227.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="permiso" value="66">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="2">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct10js.php">
                                </form>
                            </div>
                        </li>
                    </ul>
