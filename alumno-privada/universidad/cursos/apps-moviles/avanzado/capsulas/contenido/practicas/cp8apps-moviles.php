...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/avanzado/capsulas/contenido/teoricas/ct8html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
            <div class="new-g" style="text-align: center;">Cápsula práctica 8 Powerpoint</div><br>
            <div class="board">
                <table width="100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Utiliza PowerPoint para crear una presentación multimedia sobre un tema específico, como los animales de la selva o los inventos del siglo XX. Incorpora videos de la web que muestren ejemplos de animales o inventos. Esto te permitirá utilizar diferentes recursos y hacer una presentación más dinámica y entretenida.
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
                                <img src="../../../../../../img/avanzadoinf/prac10.png" style="height: auto; width: 60%;">
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        function miFunc() {
            ...
            if (h1 > 0 && buttons > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'correcto' + '&permiso=' + 18 + '&id_curso=' + 9 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd18.php?validar=' + 'incorrecto' + '&permiso=' + 18 + '&id_curso=' + 9 + '&practico=' + 10;
