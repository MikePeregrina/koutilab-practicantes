        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T19/143.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/142.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/144.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/145.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/146.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/147.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/148.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T19/149.gif');"></li>
                        <li>
                            <div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('evaluar').submit();
                        window.location.href = '../teoricas/ct19apps-moviles.php';
                    }
                });
