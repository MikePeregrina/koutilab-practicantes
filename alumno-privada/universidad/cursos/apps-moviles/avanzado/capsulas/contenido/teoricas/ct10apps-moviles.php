        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/T10/77.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/78.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/79.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/80.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/81.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/T10/82.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <div class="container-question">
                                        ...
                                        <div class="container-question">
                                            ...
                                            <input type="hidden" name="redireccion" value="../contenido/teoricas/ct10apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
