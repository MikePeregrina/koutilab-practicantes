...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>PROTECCION DE DATOS PERSONALES</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i>DATOS</i>', //icono de internet
				'<i>PROTEJER</i>', //icono del wifi
				'<i>RELACION</i>', //computadoras
				'<i>ACCESSO</i>', //chrome
				'<i>AUTORIZAR</i>', //explorer
				'<i>USO</i>', //buscador
				'<i>INDEBIDO</i>', //icono del link
				'<i>NOMBRE</i>', //icono de la laptop
				'<i>NUMERO</i>', //icono de un celular
				'<i>DERECHO</i>', //icono de torre de señal
				'<i>CONTROL</i>',
				'<i>REGULAN</i>'
			]
		}
