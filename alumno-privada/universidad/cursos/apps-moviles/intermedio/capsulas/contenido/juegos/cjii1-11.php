...
<body onload="iniciarTiempo()">
    ...
    <div class="titulo-gen">
        <h2 class="titulo"><b>COMERCIO ELECTRONICO</b></h2>
    </div>
    ...
    <div class="contenido">
        ...
        <div class="container">
            <section><!--GENERANDO SECCION PARA PREGUNTAS Y RESPUESTAS-->
                ...
                <h3>1- El comercio electrónico, también conocido ¿ como ?
                    <select class="select" id="respuesta0"><!--Generando lista de opciones de respuesta de la pregunta 1-->
                        <option value="----">...</option>
                        <option value="incorrecto">ONLINE</option>
                        <option value="incorrecto">AMAZON</option>
                        <option value="correcto">E-COMMERCE</option>
                    </select>
                </h3>
                <!--Generando pregunta 2-->
                <h3>2- ¿A traves de que medio se relizar las transacciones?
                    <select class="select" id="respuesta1"><!--Generando lista de opciones de respuesta de la pregunta 2-->
                        <option value="----">...</option>
                        <option value="incorrecto">DATOS</option>
                        <option value="correcto">INTERNET</option>
                        <option value="incorrecto">RED</option>
                    </select><br><br><br>
                </h3>
                <!--Generando pregunta 3-->
                <h3>3- Es el comercio electrónico empresarial a consumidor
                    <select class="select" id="respuesta2"><!--Generando lista de opciones de respuesta de la pregunta 3-->
                        <option value="----">...</option>
                        <option value="correcto">B2C</option>
                        <option value="incorrecto">B2B</option>
                ...
                <h3>4- Es el comercio electrónico empresarial a empresarial 
                    <select class="select" id="respuesta3"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">C2C</option>
                        <option value="incorrecto">B2C</option>
                        <option value="correcto">B2B</option>
                    </select><br></br><br></br>
                </h3>
                <!--Generando pregunta 5-->
                <h3>5- Es el comercio electrónico de consumidor a consumidor
                    <select class="select" id="respuesta4"><!--Generando opciones de respuesta de la pregunta-->
                        <option value="----">...</option>
                        <option value="incorrecto">B2C</option>
                        <option value="incorrecto">B2B</option>
                        <option value="correcto">C2C</option>
                    </select><br><br><br>
                </h3>
            </section>
        </div>
