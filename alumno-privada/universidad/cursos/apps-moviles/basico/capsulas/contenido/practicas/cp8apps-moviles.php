...
<body>
    <div class="body">
        <div class="container">
            ...
            <a href="../../../../../../cursos/programacion-web/basico/capsulas/contenido/teoricas/ct4html.php"><button style="float: right; width: 100px; height: 40px;" class="btn-b"><b>Volver a teoría</b></button></a>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>
                                    Crear un manual sobre el uso de un dispositivo periférico específico. Puedes seleccionar un dispositivo periférico común, como una impresora o un escáner, y crear un manual que explique cómo utilizarlo correctamente.
                                    <br> <br>
                                </p>
                            </td>
        ...
        function miFunc() {
            ...
            if (h1 > 0 && buttons > 0) {
                ...
                if (puntos == 0) {
                    ...
                    `,
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'correcto' + '&permiso=' + 21 + '&id_curso=' + 7 + '&practico=' + 10;
                        }
                    });
                } else if (puntos == 6) {
                    Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd21.php?validar=' + 'incorrecto' + '&permiso=' + 21 + '&id_curso=' + 7 + '&practico=' + 10;
