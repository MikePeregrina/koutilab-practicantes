...
<body>
	...
	<div class="titulo-gen">
		<h2 class="titulo"><b>LOCALIZACIÓN DE LOS BOTONES DE ENCENDIDO</b></h2>
	</div>
	...
	<script>
		...
		function cargarIconos() {
			iconos = [
				'<i><img src="../::/../../img/img_juegos/btnE1.png" width= "50px"></i>',
				'<i ><img src="../::/../../img/img_juegos/btnE2.png" width= "50px"></i>',
				'<i><img src="../::/../../img/img_juegos/btnE3.png" width= "50px" ></i>',
				'<i><img src="../::/../../img/img_juegos/btnE4.png" width= "50px" ></i></i>',
				'<i><img src="../::/../../img/img_juegos/btnE5.png" width= "50px" ></i>',
				'<i ><img src="../::/../../img/img_juegos/btnE6.png" width= "50px"  ></i>',
				'<i><img src="../::/../../img/img_juegos/btnE7.png" width= "50px" ></i>',
				'<i ><img src="../::/../../img/img_juegos/btnE8.png" width= "50px"  ></i>',
				'<i><img src="../::/../../img/img_juegos/btnE9.png" width= "50px"  ></i>',
				'<i><img src="../::/../../img/img_juegos/btnE10.png" width= "50px"></i>',
				'<i><img src="../::/../../img/img_juegos/btnE11.png" width= "50px"></i>',
				'<i><img src="../::/../../img/img_juegos/btnE12.png" width= "50px"></i>'
			]
		}
		...
		function deseleccionar(selecciones) {
			setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 30 + "&id_curso=" + 7 + "&redireccion=" + '../contenido/juegos/cjib2-1.php'; //cancatenation
