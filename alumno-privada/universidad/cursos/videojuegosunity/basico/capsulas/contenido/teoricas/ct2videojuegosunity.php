        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T2/20.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/21.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/22.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/23.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/24.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/25.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/26.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/27.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T2/28.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct2videojuegosunity.php">
                                </form>
                            </div>
                        </li>
                    </ul>
