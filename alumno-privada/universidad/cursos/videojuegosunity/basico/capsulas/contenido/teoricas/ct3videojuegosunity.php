        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T3/30.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/31.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/32.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/33.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/34.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T3/35.gif');"></li>
                        <li>
                            <div>
