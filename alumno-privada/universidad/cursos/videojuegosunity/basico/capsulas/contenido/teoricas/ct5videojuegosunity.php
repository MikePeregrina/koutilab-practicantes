        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T5/44.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T5/45.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T5/46.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T5/47.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T5/48.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/T5/49.gif');"></li>
                        <li>
                            <div>
