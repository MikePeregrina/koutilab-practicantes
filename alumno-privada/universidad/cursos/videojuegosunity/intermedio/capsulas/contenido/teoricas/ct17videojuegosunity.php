        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/T17/130.gif'); z-index:0; opacity: 1;"></li>
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/T17/134.gif');"></li>
