...
$permiso_ruta_r13 = "13";
$sql_verificar_r13 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_primaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r13'");
$existe_verificar_r13 = mysqli_num_rows($sql_verificar_r13);

//Verificar si ya se tiene permiso en ruta 14
$permiso_ruta_r14 = "14";
$sql_verificar_r14 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_primaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r14'");
$existe_verificar_r14 = mysqli_num_rows($sql_verificar_r14);

//Verificar si ya se tiene permiso en ruta 15
$permiso_ruta_r15 = "15";
$sql_verificar_r15 = mysqli_query($conexion, "SELECT a.* FROM acceso_cursos_primaria a WHERE a.id_alumno = $id_user AND a.id_curso = '$permiso_ruta_r15'");
...
$query_appsmoviles_basico = mysqli_query($conexion, "SELECT * FROM estadisticas_primaria WHERE id_alumno = $id_user AND id_curso = 13");
$data_appsmoviles_basico = mysqli_fetch_assoc($query_appsmoviles_basico);

//Estadisticas appsmoviles intermedio
$query_appsmoviles_intermedio = mysqli_query($conexion, "SELECT * FROM estadisticas_primaria WHERE id_alumno = $id_user AND id_curso = 14");
$data_appsmoviles_intermedio = mysqli_fetch_assoc($query_appsmoviles_intermedio);

//Estadisticas appsmoviles avanzado
$query_appsmoviles_avanzado = mysqli_query($conexion, "SELECT * FROM estadisticas_primaria WHERE id_alumno = $id_user AND id_curso = 15");
...
<body>
    ...
    <div class="container-principal">
        ...
        if (isset($_POST['enviarnombre'])) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE alumnos_primaria SET nombre = '$nombre' WHERE id_alumno = '$idalumno'");
