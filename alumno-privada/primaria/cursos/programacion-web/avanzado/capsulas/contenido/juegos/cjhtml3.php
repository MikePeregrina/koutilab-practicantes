...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 10 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjhtml3.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("SLIDER");
        palabras_array.push("CARRUSEL");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "SLIDER": // Se debera hacer un case por cada palabra
                    pista = "Se trata de un panel giratorio el cual no contiene flechas y solo se usa para captar la atención del usuario. Pista: S___ER";
                    break; // Es importante el break en cada case
                case "CARRUSEL": // Se debera hacer un case por cada palabra
                    pista = "Se trata de un pase de diapositivas con flechas que puede o no puede ser automático. Pista: CA____E_";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 10 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjhtml3.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
