...
<body onload="iniciarTiempo();">
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 46 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjphp1.php'; //cancatenation
    ...
    <script>
        ...
        /* Palabras */
        palabras_array.push("VARIABLES");
        palabras_array.push("OPERADORES");
        ...
        function pistaFunction(palabra) {
            ...
            switch (
                ...
                case "VARIABLES": // Se debera hacer un case por cada palabra
                    pista = "Se trata de un tipo de cajas donde se puede guardar información, a este elemento se le llama...";
                    break; // Es importante el break en cada case
                case "OPERADORES": // Se debera hacer un case por cada palabra
                    pista = "Con este tipo de elementos podemos realizar operaciones matemáticas, a este elemento se le llama...";
                    break; // Es importante el break en cada case
        ...
        function gameOver(errores) {
            ...
            if (errores < 4) {
                ...
                var xmlhttp = new XMLHttpRequest();
                var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 46 + "&id_curso=" + 15 + "&redireccion=" + '../contenido/juegos/cjphp1.php'; //cancatenation
                xmlhttp.open("POST", "../../acciones/insertar_juego.php", true);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send(param);
                Swal.fire({
