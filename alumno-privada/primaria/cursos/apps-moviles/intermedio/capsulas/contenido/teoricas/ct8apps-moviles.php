        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/1/T7/46.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7/47.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7/48.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="mjuego">
                        ...
                        <li style="background-image: url('../../img/apps-moviles/1/T7/49.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7/50.gif');"></li>
                        <li>
                            <div>
