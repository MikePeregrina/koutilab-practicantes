        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/1/T7/51.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7/52.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7/53.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/apps-moviles/1/T7/54.gif');"></li>
                        <li>
                            <div>
