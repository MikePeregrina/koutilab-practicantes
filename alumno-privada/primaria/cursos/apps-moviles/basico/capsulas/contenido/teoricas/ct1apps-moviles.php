...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 1 Apps Móviles</div><br>
                            ...
                            <div class="columnas">
                                <div class="container-all">
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div class="word-box" id="apps-moviles" onclick="checkAnswer('apps-moviles')">
                                            Apps Móviles</div>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_teorica.php">
                                    ...
                                    <input type="hidden" name="redireccion" value="../contenido/teoricas/ct1apps-moviles.php">
                                </form>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        function selectWord() {
            ...
            if (
                palabraseleccionada.id !== 'apps-moviles' &&
        ...
        function checkAnswer(respuesta) {
            ...
            if (palabraseleccionada) {
                ...
                if (respuesta === 'apps-moviles' && idPalabraSeleccionada === 'computacion') {
