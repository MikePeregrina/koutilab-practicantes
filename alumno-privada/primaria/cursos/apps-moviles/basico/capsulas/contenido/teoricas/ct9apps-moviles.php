...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 7.5 Apps Móviles</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/apps-moviles/1/T7.5/55.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7.5/56.gif');"></li>
                        <li style="background-image: url('../../img/apps-moviles/1/T7.5/57.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                        ...
                        <li style="background-image: url('../../img/apps-moviles/1/T7.5/58.gif');"></li>
                        <li>
                            <div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct9apps-moviles.php';
                    }
                });
