...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6.5 videojuegosunity</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/videojuegosunity/1/T6.5/41.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T6.5/42.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T6.5/43.gif');"></li>
                        <li>
                            <!-- Copiar de aqui -->
                            <div class="memorama">
                        ...
                        <li style="background-image: url('../../img/videojuegosunity/1/T6.5/44.gif');"></li>
                        <li style="background-image: url('../../img/videojuegosunity/1/T6.5/45.gif');"></li>
                        <li>
                            <div>
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd14.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué se debe hacer en la pantalla de inicio para configurar una cuenta de correo electrónico según el texto?</h1>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox1" class="check-box" style="scale: 90%;">
                                        <label for="checkbox1">
                                            Navegar hasta Aplicaciones > Configuración > Cuentas > Correo electrónico.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox2" class="check-box" style="scale: 90%;">
                                        <label for="checkbox2">
                                            Navegar hasta Aplicaciones > Configuración > Cuentas.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox3" class="check-box" style="scale: 90%;">
                                        <label for="checkbox3">
                                            Navegar hasta Aplicaciones > Configuración > Correo electrónico.
                                        </label>
                                    </div>
                                    <div class="container-question">
                                        <input type="checkbox" id="checkbox4" class="check-box" style="scale: 90%;">
                                        <label for="checkbox4">
                                            No se menciona qué hacer en la pantalla de inicio.
                                        </label>
                                    </div>
        ...
        function comprueba() {
            if (checkbox2.checked) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../teoricas/ct7videojuegosunity.php';
                    }
                });
    ...
    <script>
        ...
        function cargarIconos() {
            iconos = [
                '<img src="img/img-minijuegos/g (1).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/g (2).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/g (3).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/g (4).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/g (5).png" height="60px" width="50px" >',
                '<img src="img/img-minijuegos/g (6).png" height="60px" width="50px" >'
            ]
        }
