...
<body>
  ...
  <section>
    ...
    <div class="container-info">
      <?php
      $data2 = mysqli_query($conexion, "SELECT * FROM directores_secundaria d INNER JOIN escuelas e WHERE d.id_escuela = e.id_escuela AND id_director = '$id_user'");
  ...
  if (isset($_FILES["image"]["name"])) { /*Si el archivo existe */
    ...
    if (!in_array($imageExtension, $validImageExtension)) {
      ...
      $query = "UPDATE directores_secundaria SET image = '$newImageName' WHERE id_director = $id"; //Actualizando imagen en BD
  ...
  if (isset($_POST['enviarcontrasena'])) {
    $iddirector = $_SESSION['id_director_secundaria'];
    $contrasena = md5($_POST['contrasena']);

    $sql_update = mysqli_query($conexion, "UPDATE directores_secundaria SET contrasena = '$contrasena' WHERE id_director = '$iddirector'");
