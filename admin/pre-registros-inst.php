...
<body>
    ...
    <div class="containers">
        <h1>PRE-REGISTROS INSTITUCIONAL</h1>
    </div>
    ...
    $(document).ready(function() {
      var table = $('#preregistros').DataTable({
        responsive: true,
        lengthMenu: [10, 25, 50, 100], // Opciones para mostrar diferentes cantidades de registros por página
        ...
        dom: 'Blfrtip', // Mostrar solo botones específicos en la parte superior derecha de la tabla
        buttons: [
          {
            extend: 'pdfHtml5',
            split:['excelHtml5', 'print'],
            ...
            customize: function(doc) {
              // Personalizar el estilo del PDF aquí usando la librería pdfmake
