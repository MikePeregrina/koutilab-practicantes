...
<body>
    ...
    <div class="button-box2">
        <div id="elegir2"></div>
        <button type="button" class="toggle-btn" onclick="Ingresar()" style="color: white;">Entrada</button>
        <button type="button" class="toggle-btn" onclick="Registrarse()" style="color: white;">Salida</button>
    </div>
    ...
    <script>
        ...
        var z = document.getElementById("elegir2");
